...
What are Planesmasters?
	...
	Usually I would want to add the planesmaster as an invisible image in the client's screen.

What can I do with Planesmasters?
	I can: Make certain players not see an entire plane,
...
How do planes work?
	A plane can be any integer from -100 to 100. (If I want more, bug lummox.)
...
How do I add a plane?
	Think of where I want the plane to appear, look through the pre-existing planes and find where it is above and where it is below
