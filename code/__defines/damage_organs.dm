...
// Way to waste perfectly good damage-type names (BRUTE) on this... If I were really worried about case sensitivity, I could have just used lowertext(damagetype) in the proc.
#define BRUTE       "brute"
#define BURN        "fire"
#define TOX         "tox"
#define OXY         "oxy"
...
#define GERM_LEVEL_AMBIENT  275 // Maximum germ level I can reach by standing still.
#define GERM_LEVEL_MOVE_CAP 300 // Maximum germ level I can reach by running around.
