...
#define BODYTEMP_COOLING_MAX           -30  // The maximum number of degrees that my body can cool down in 1 tick, when in a cold area.
#define BODYTEMP_HEATING_MAX            30  // The maximum number of degrees that my body can heat up in 1 tick,   when in a hot  area.
...
#define FIRE_MAX_FIRESUIT_STACKS  20 // If the number of stacks goes above this firesuits won't protect me anymore. If not, I can walk around while on fire like a badass.
...
/*
	...
	3 - normal items
	4 - large items - the largest things I can fit in a backpack
