...
#define LIGHTING_HEIGHT 1 // height off the ground of light sources on the pseudo-z-axis, I should probably leave this alone
...
// If I were I I'd leave this alone.
