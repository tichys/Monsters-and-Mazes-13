...
/* 
	...
	for(var/obj/O in list)
		//Call start_worker(), passing it first the object, then a string of the name of the proc I want called, then 
		// any and all arguments I want passed to the proc. 
...
//Resets the counter if I want to utilize the same datum multiple times
// Optional: pass the number of checks I want for the failsafe
...
//Set failsafe check count in case I need more time for the workers to return
