...
/*
    ...
    Alternately, I could hardcode every mob's variation in a flat ClickOn() proc; however,
...
/mob/proc/ClickOn(var/atom/A, var/params)
    ...
    face_atom(A) // change direction to face what I clicked on
    ...
    //Atoms on my person
    // A is my location but is not a turf; or is on I (backpack); or is on something on I (box in backpack); sdepth is needed here because contents depth does not equate inventory storage depth.
    ...
    if(!isturf(loc)) // This is going to stop me from telekinesing from inside a closet, but I don't shed many tears for that
        return

    //Atoms on turfs (not on my person)
...
/mob/living/UnarmedAttack(var/atom/A, var/proximity_flag)
    ...
    if(!ticker)
        to_chat(src, "I cannot attack people before the game has started.")
        return 0
...
/*
    ...
    laser eyes and telekinesis.  I could easily add exceptions
...
/*
    ...
    Used when I am handcuffed and click things.
...
/*
    ...
    face_atom: turns the mob towards what I clicked on
*/
...
/mob/living/carbon/human/LaserEyes()
    if(nutrition>0)
        ...
        to_chat(src, "<span class='warning'>I'm out of energy!  I need food!</span>")

// Simple helper to face what I clicked on, in case it should be needed in more than one place
