...
/mob/living/silicon/robot/ClickOn(var/atom/A, var/params)
	...
	if(silicon_camera.in_camera_mode)
		...
		if(is_component_functioning("camera"))
			...
			to_chat(src, "<span class='userdanger'>My camera isn't functional.</span>")
		return
...
/*
	...
	If I would like to add advanced features to robot
	clicks, I can do so here, but I will have to
