/*
  ...
  procs:
   ...
   return_frequency(var/frequency as num)
	  returns:
	   Reference to frequency object. Use it if I need to send and do not need to listen.
  ...
  obj/proc/receive_signal(datum/signal/signal, var/receive_method as num, var/receive_param)
	...
	Avoid of sending signals directly from this proc, use spawn(-1). DO NOT use sleep() here or call procs that sleep please. If I must, use spawn()
	  parameters:
