...
datum/controller/game_controller/proc/setup()
	...
	to_world("<span class='boldannounce'>Initializations Complete.</span>")  // if this wasn't here, players may get the feeling of being trapped in the lobby
...
/proc/report_progress(var/progress_message)  // changed to be silent to players, admins can get these logs with a verb
	log_world(progress_message)
	global.initializationlog += "<p>[progress_message]</p> <br>"