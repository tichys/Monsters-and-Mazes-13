/datum/controller/subsystem
	// Metadata; I should define these.
	...
	var/flags = 0                        //see MC.dm in __DEFINES Most flags must be set on world start to take full effect. (I can also restart the mc to force them to process again)
