...
//If I see this proc high on the profile, what I am really seeing is the garbage collection/soft delete overhead in byond.
...
/datum/proc/find_references(skip_alert)
	...
	if(usr && usr.client)
		...
		if(!skip_alert)
			if(alert("Running this will lock everything up for about 5 minutes.  Would I like to begin the search?", "Find References", "Yes", "No") == "No")
				running_find_references = null
				return
