...
Generally, the only thing I want to play with (meaning, redefine) is the process() proc.
It must contain all the things I want done.
...
Control vars:
	...
	Of course, I can also check the variables inside process() proc to prevent runtime errors.
