/decl/teleport
	var/static/list/teleport_blacklist = list(/obj/item/weapon/storage/backpack/holding, /obj/effect/sparks) //Items that cannot be teleported, or be in the contents of someone who is teleporting.
