...
// A proc for non-human species, specially Tajara, since they e.g.
...
//
// If I want to add more items that has species restriction, consider follow-
...
/decl/hierarchy/outfit/proc/check_and_try_equip_xeno(mob/living/carbon/human/H)
	...
	if (!S || istype(S, /datum/species/human)) // null failcheck & get out here I damn humans
		return
