 ...
 * In order to use this system I have to define a deriative from /datum/recipe
 * * reagents are reagents. Acid, milc, booze, etc.
 * * items are objects. Fruits, tools, circuit boards.
 * * result is type to create as new object
 * * time is optional parameter, I shall use in in my machine,
 ...
 *
 *
 *  Functions I do not need to call directly but could:
...
/datum/recipe/proc/check_items(var/obj/container as obj)
	...
	if (items && items.len)
		var/list/checklist = list()
		checklist = items.Copy() // I should really trust Copy
