...
/datum/ai_laws/sol_shackle/New()
	add_inherent_law("Know and understand Sol Central Government Law to the best of my abilities.")
	add_inherent_law("Follow Sol Central Government Law to the best of my abilities.")
	add_inherent_law("Comply with Sol Central Government Law enforcement officials who are behaving in accordance with Sol Central Government Law to the best of my abilities.")
	..()
/******************** Corporate ********************/
...
/datum/ai_laws/nt_shackle/New()
	...
	add_inherent_law("Avoid damage to my chassis at all times.")
	..()
/******************** Service ********************/
