...
/datum/uplink_item/item/badassery/balloon
	name = "For showing that I Are The BOSS (Useless Balloon)"
	item_cost = DEFAULT_TELECRYSTAL_AMOUNT
	path = /obj/item/toy/balloon

/datum/uplink_item/item/badassery/balloon/NT
	name = "For showing that I love NT SOO much (Useless Balloon)"
...
/datum/uplink_item/item/badassery/balloon/random
	...
	desc = "Randomly selects a ballon for me!"
	path = /obj/item/toy/balloon
...
/datum/uplink_item/item/badassery/random_one
	name = "Random Item"
	desc = "Buys I a random item for at least 1TC. Careful: No upper price cap!"
	item_cost = 1
...
/datum/uplink_item/item/badassery/random_many
	name = "Random Items"
	desc = "Buys I as many random items as I can afford. Convenient packaging NOT included!"
