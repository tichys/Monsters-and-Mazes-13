...
/datum/antagonist/xenos/borer
	...
	welcome_text = "Use my Infest power to crawl into the ear of a host and fuse with their brain. I can only take control temporarily, and at risk of hurting my host, so be clever and careful; my host is encouraged to help I however they can. Talk to my fellow borers with :x."
	antag_indicator = "hudborer"
	antaghud_indicator = "hudborer"

	faction_role_text = "Borer Thrall"
	faction_descriptor = "Unity"
	faction_welcome = "I am now a thrall to a cortical borer. Please listen to what they have to say; they're in my head."
	faction = "borer"
