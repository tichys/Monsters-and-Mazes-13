...
/datum/antagonist/xenos
	...
	welcome_text = "Hiss! I am a larval alien. Hide and bide my time until I am ready to evolve."
	antaghud_indicator = "hudalien"
	antag_indicator = "hudalien"
	faction_role_text = "Xenophage Thrall"
	faction_descriptor = "Hive"
	faction_welcome = "My will is ripped away as my humanity merges with the xenomorph overmind. I am now \
