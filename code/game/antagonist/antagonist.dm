/datum/antagonist
	...
	var/faction = "neutral"					// Actual faction name. Used primarily in stuff like simple_animals seeing if I am a threat or not.
	...
	var/list/valid_species =       list(SPECIES_HUMAN,SPECIES_VOX)
	...
	/* VV  GAY   VV
	var/antag_text = "I am an antagonist! Within the rules, \
		try to act as an opposing force to the crew. Further RP and try to make sure \
		other players have <i>fun</i>! If I am confused or at a loss, always adminhelp, \
		and before taking extreme actions, please try to also contact the administration! \
		Think through my actions and make the roleplay immersive! <b>Please remember all \
		rules aside from those without explicit exceptions apply to antagonists.</b>"
	*/
	var/antag_text = "I am an antagonist. Make sure the surviving crew don't make it."
