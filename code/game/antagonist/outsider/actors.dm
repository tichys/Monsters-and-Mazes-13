...
/datum/antagonist/actor
	...
	welcome_text = "I have been hired to entertain people through the power of television!"
...
/datum/antagonist/actor/greet(var/datum/mind/player)
	...
	player.current.show_message("I work for [GLOB.using_map.company_name], tasked with the production and broadcasting of entertainment to all of its assets.")
...
/client/verb/join_as_actor()
	...
	var/choice = alert("Are I sure you'd like to join as an actor?", "Confirmation","Yes", "No")
	if(choice != "Yes")
		return
	...
	to_chat(usr, "I must be observing or be a new player to spawn as an actor.")
