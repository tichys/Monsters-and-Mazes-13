...
/datum/antagonist/wizard
	...
	landmark_id = "wizard"
	welcome_text = "I will find a list of available spells in my spell book. Choose my magic arsenal carefully.<br>In my pockets I will find a teleport scroll. Use it as needed."
...
/datum/antagonist/wizard/update_antag_mob(var/datum/mind/wizard)
	..()
	wizard.store_memory("<B>Remember:</B> do not forget to prepare my spells.")
