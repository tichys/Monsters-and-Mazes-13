...
/datum/antagonist/godcultist
	...
	welcome_text = "I am under the guidance of a powerful otherwordly being. Spread its will and keep my faith.<br>Use dpray to communicate directly with my master!<br>Ask my master for spells to start building!"
...
/mob/living/proc/dpray(var/msg as text)
	...
	src.visible_message("\The [src] bows their head down, muttering something.", "<span class='notice'>I send the message \"[msg]\" to my master.</span>")
