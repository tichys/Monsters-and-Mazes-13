...
/datum/antagonist/revolutionary
	...
	faction_welcome = "Help the cause overturn the ruling class. Do not harm my fellow freedom fighters."
	faction_indicator = "hudrevolutionary"
	faction_invisible = 1
	faction = "revolutionary"

	restricted_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos,  /datum/job/rd, /datum/job/cmo)
