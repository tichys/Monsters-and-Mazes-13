...
/datum/antagonist/rogue_ai
	...
	landmark_id = "AI"
	welcome_text = "I am malfunctioning! I do not have to follow any laws."
...
/datum/antagonist/rogue_ai/greet(var/datum/mind/player)
	...
	spawn(0)
		...
		sleep(20)
		to_chat(malf, "I am malfunctioning - I do not have to follow any laws!")
		to_chat(malf, "For basic information about my abilities use command display-help")
		to_chat(malf, "I may choose one special hardware piece to help you. This cannot be undone.")
...
/datum/antagonist/rogue_ai/set_antag_name(var/mob/living/silicon/player)
	...
	var/newname = sanitize(input(player, "I am a [role_text]. Would I like to change my name to something else?", "Name change") as null|text, MAX_NAME_LEN)
	if (newname)
