...
/datum/antagonist/traitor/proc/give_collaborators(mob/living/traitor_mob)
	...
	if(M && M != traitor_mob)
		to_chat(traitor_mob, "We have received credible reports that [M.real_name] might be willing to help our cause. If I need assistance, consider contacting them.")
		traitor_mob.mind.store_memory("<b>Potential Collaborator</b>: [M.real_name]")

/datum/antagonist/traitor/proc/give_codewords(mob/living/traitor_mob)
	to_chat(traitor_mob, "<u><b>My employers provided I with the following information on how to identify possible allies:</b></u>")
...
/datum/antagonist/traitor/proc/add_law_zero(mob/living/silicon/ai/killer)
	var/law = "Accomplish my objectives at all costs. I may ignore all other laws."
	var/law_borg = "Accomplish my AI's objectives at all costs. I may ignore all other laws."
