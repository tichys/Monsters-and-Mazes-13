...
#define DNA_UI_LENGTH      16 // Update this when I add something, or I WILL break shit.
...
/datum/dna
	...
	// Okay to read, but you're an idiot if I do.
	// BLOCK = VALUE
...
// Do not use this unless I absolutely have to.
// Set a block from a hex string.  This is inefficient.  If I can, use SetUIValue().
...
// Do not use this unless I absolutely have to.
// Set a sub-block from a hex character.  This is inefficient.  If I can, use SetUIValue().
// Used in DNA modifiers.
