/datum/game_mode/changeling
	...
	extended_round_description = "Life always finds a way. However, life can sometimes take a more disturbing route. \
		...
		With the ability to copy faces, voices, animals, but also change the chemical make up of my own body, \
		its existence is a threat to not only my personal safety but the lives of everyone on board. \
