...
/mob/proc/changeling_transform()
	...
	if(!do_after(src, changeTime))
		to_chat(src, "<span class='notice'>I fail to change shape.</span>")
		return
...
//Fake our own death and fully heal. I will appear to be dead but regenerate fully after a short delay.
/mob/proc/changeling_fakedeath()
	...
	spawn(rand(800,2000))
		if(changeling_power(20,1,100,DEAD))
			...
			to_chat(C, "<span class='notice'><font size='5'>We are ready to rise.  Use the <b>Revive</b> verb when I am ready.</font></span>")
...
//Prevents AIs tracking I but makes I easily detectable to the human-eye.
...
//Starts healing I every second for 10 seconds. Can be used whilst unconscious.
...
/mob/proc/changeling_hiveupload()
	...
	set desc = "Allows I to channel DNA in the airwaves to allow other changelings to absorb it."
...
/mob/proc/changeling_hivedownload()
	...
	set desc = "Allows I to absorb DNA that is being channeled in the airwaves."
...
/mob/proc/changeling_blind_sting()
	...
	if(!T)	return 0
	to_chat(T, "<span class='danger'>My eyes burn horrificly!</span>")
...
/mob/proc/changeling_deaf_sting()
	...
	if(!T)	return 0
	to_chat(T, "<span class='danger'>My ears pop and begin ringing loudly!</span>")
...
/mob/proc/changeling_DEATHsting()
	...
	if(!T)	return 0
	to_chat(T, "<span class='danger'>I feel a small prick and my chest becomes tight.</span>")
	T.make_jittery(400)
