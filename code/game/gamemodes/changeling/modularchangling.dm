...
/datum/power/changeling/hive_upload
	...
	helptext = "Allows other changelings to absorb the DNA I channel from the airwaves. Will not help them towards their absorb objectives."
	genomecost = 0
...
/datum/power/changeling/hive_download
	...
	helptext = "Allows I to absorb a single DNA and use it. Does not count towards my absorb objective."
	genomecost = 0
...
/datum/power/changeling/mimicvoice
	...
	helptext = "Will turn my voice into the name that I enter. We must constantly expend chemicals to maintain our form like this"
	genomecost = 1
...
/datum/power/changeling/extractdna
	...
	helptext = "Will give me the DNA of my target, allowing me to transform into them. Does not count towards absorb objectives."
	genomecost = 2
	allowduringlesserform = 1
...
/datum/power/changeling/DeathSting
	...
	helptext = "It will be clear to any surrounding witnesses if I use this power."
	genomecost = 10
