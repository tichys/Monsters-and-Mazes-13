...
/obj/item/weapon/melee/cultblade/attack(mob/living/M, mob/living/user, var/target_zone)
	...
	if(affecting)
		to_chat(user, "<span class='danger'>An unexplicable force rips through my [affecting.name], tearing the sword from my grasp!</span>")
	else
		to_chat(user, "<span class='danger'>An unexplicable force rips through you, tearing the sword from my grasp!</span>")
...
/obj/item/weapon/melee/cultblade/pickup(mob/living/user as mob)
	if(!iscultist(user))
		to_chat(user, "<span class='warning'>An overwhelming feeling of dread comes over I as I pick up the cultist's sword. It would be wise to be rid of this blade quickly.</span>")
		user.make_dizzy(120)
