...
/turf/unsimulated/wall/supermatter/attack_hand(mob/user as mob)
	user.visible_message("<span class=\"warning\">\The [user] reaches out and touches \the [src]... And then blinks out of existance.</span>",\
		"<span class=\"danger\">I reach out and touch \the [src]. Everything immediately goes quiet. My last thought is \"That was not a wise decision.\"</span>",\
		"<span class=\"warning\">I hear an unearthly noise.</span>")
...
/turf/unsimulated/wall/supermatter/Bumped(var/atom/movable/AM)
	...
	if(istype(AM, /mob/living))
		...
		"<span class=\"warning\">I hear an unearthly noise as a wave of heat washes over you.</span>")
	else
