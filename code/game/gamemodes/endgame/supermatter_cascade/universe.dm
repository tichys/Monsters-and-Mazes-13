...
/datum/universal_state/supermatter_cascade/OnShuttleCall(var/mob/user)
	if(user)
		to_chat(user, "<span class='sinister'>All I hear on the frequency is static and panicked screaming. There will be no shuttle call today.</span>")
	return 0
...
/datum/universal_state/supermatter_cascade/OnEnter()
	set background = 1
	to_world("<span class='sinister' style='font-size:22pt'>I am blinded by a brilliant flash of energy.</span>")
...
[station_name()], the largest source of disturbances has been pinpointed directly to me. We estimate I have five minutes until a bluespace rift opens within my facilities.

There is no known way to stop the formation of the rift, nor any way to escape it. I am entirely alone.
