...
/datum/game_mode
	var/name = "invalid"
	var/round_description = "How did I even vote this in?"
...
/datum/game_mode/Topic(href, href_list[])
	...
	if(href_list["toggle"])
		...
		var/choice = input("Which type do I wish to add?") as null|anything in GLOB.all_antag_types_
		if(!choice)
			return
...
/proc/show_objectives(var/datum/mind/player)
	...
	var/obj_count = 1
	to_chat(player.current, "<span class='notice'>My current objectives:</span>")
