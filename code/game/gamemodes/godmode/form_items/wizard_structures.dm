...
/obj/structure/deity/wizard_recharger/attack_hand(var/mob/living/hitter)
	if(!hitter.mind || !hitter.mind.learned_spells || !hitter.mind.learned_spells.len)
		to_chat(hitter, "<span class='warning'>I don't feel as if this will do anything for you.</span>")
		return
	...
	if(do_after(hitter,600,src,needhand=0))
		...
		to_chat(hitter, "<span class='notice'>I feel refreshed!</span>")
		return
	to_chat(hitter,"<span class='warning'>I need to keep in contact with \the [src]!</span>")
