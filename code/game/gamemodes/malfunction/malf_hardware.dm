...
/datum/malf_hardware/apu_gen
	name = "APU Generator"
	desc = "Auxiliary Power Unit that will keep I operational even without external power. Has to be manually activated. When APU is operational most abilities will be unavailable, and ability research will temporarily stop."
...
/datum/malf_hardware/dual_ram
	...
	desc = "Expanded memory cells which allow I to store double amount of CPU time."
...
/datum/malf_hardware/core_bomb
	...
	desc = "High yield explosives are attached to my physical mainframe. This hardware comes with special driver that allows activation of these explosives. Timer is set to 15 seconds after manual activation. This is a doomsday device that will destroy both I and any intruders in my core."
...
/datum/malf_hardware/instant_research
	...
	desc = "A highly advanced self-learning supercomputer that is capable of rapidly performing predefined research tasks. Once activated advances my research in all trees by one tier, but burns out in the process."
