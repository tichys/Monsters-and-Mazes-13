...
/obj/machinery/optable/attack_hand(var/mob/user)
	...
	if(user != victim && !suppressing) // Skip checks if you're doing it to myself or turning it off, this is an anti-griefing mechanic more than anything.
...
/obj/machinery/optable/proc/take_victim(mob/living/carbon/C, mob/living/carbon/user as mob)
	if (C == user)
		user.visible_message("[user] climbs on \the [src].","I climb on \the [src].")
	else
