...
/obj/machinery/autolathe/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(!filltype)
		...
		to_chat(user, "I fill \the [src] to capacity with \the [eating].")
	else
		to_chat(user, "I fill \the [src] with \the [eating].")
...
/obj/machinery/autolathe/OnTopic(user, href_list, state)
	...
	if(href_list["change_category"])
		var/choice = input("Which category do I wish to display?") as null|anything in autolathe_categories+"All"
