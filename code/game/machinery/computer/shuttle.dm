/obj/machinery/computer/shuttle
	...
	attackby(var/obj/item/weapon/card/W as obj, var/mob/user as mob)
		...
		if (istype(W, /obj/item/weapon/card/id)||istype(W, /obj/item/modular_computer))
			...
			var/choice = alert(user, text("Would I like to (un)authorize a shortened launch time? [] authorization\s are still needed. Use abort to cancel all authorizations.", src.auth_need - src.authorized.len), "Shuttle Launch", "Authorize", "Repeal", "Abort")
			...
			var/choice = alert(user, "Would I like to launch the shuttle?","Shuttle control", "Launch", "Cancel")
