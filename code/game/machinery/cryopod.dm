...
/obj/machinery/cryopod
	...
	var/on_enter_occupant_message = "I feel cool air surround you. I go numb as my senses turn inward."
...
/obj/machinery/cryopod/robot
	...
	on_enter_occupant_message = "The storage unit broadcasts a sleep signal to me. My systems start to shut down, and I enter low-power mode."
...
// This function can not be undone; do not call this unless I am sure
	...
	for(var/obj/item/W in occupant)
		...
		if(W.contents.len) //Make sure we catch anything not handled by qdel() on the items.
			for(var/obj/item/O in W.contents)
				if(istype(O,/obj/item/weapon/storage/internal)) //Stop eating pockets, I fuck!
					continue
				O.forceMove(src)
	...
	for(var/datum/objective/O in all_objectives)
		...
		if(O.target == occupant.mind)
			if(O.owner && O.owner.current)
				to_chat(O.owner.current, "<span class='warning'>I get the feeling my target is no longer within my reach...</span>")
			qdel(O)
...
/obj/machinery/cryopod/attackby(var/obj/item/weapon/G as obj, var/mob/user as mob)
	...
	if(istype(G, /obj/item/grab))
		...
		if(M.client)
			if(alert(M,"Would I like to enter long-term storage?",,"Yes","No") == "Yes")
...
/obj/machinery/cryopod/proc/set_occupant(var/mob/living/carbon/occupant)
	...
	if(occupant.client)
		...
		to_chat(occupant, "<span class='notice'><b>If I ghost, log out or close my client now, my character will shortly be permanently removed from the round.</b></span>")
