/obj/machinery/door/window
	...
	maxhealth = 150 //If I change this, consiter changing ../door/window/brigdoor/ health at the bottom of this .dm file
	health = 150
	visible = 0.0
	use_power = 0
...
/obj/machinery/door/window/attackby(obj/item/weapon/I as obj, mob/user as mob)
	...
	//Emags and ninja swords? I may pass.
	...
	if (src.operating == -1 && isCrowbar(I))
		...
		user.visible_message("[user] removes the electronics from the windoor.", "I start to remove electronics from the windoor.")
