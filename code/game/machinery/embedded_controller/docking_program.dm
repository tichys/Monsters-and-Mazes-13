...
/*
	...
	*** Docking Signals ***
	...
	Server sends confirm_dock to say that yes, we will serve my request
	...
	*** Override, what is it? ***
	...
	Maybe the shuttle is full of plamsa/phoron for some reason, and I don't want the door to automatically open, or the airlock to cycle.
