...
/obj/item/weapon/reagent_containers/food/snacks/variable
	...
	desc = "If I can see this description then something is wrong. Please report the bug on the tracker."
	nutriment_amt = 5
	bitesize = 2
...
/obj/item/weapon/reagent_containers/food/snacks/variable/pocket
	name = "hot pocket"
	desc = "I wanna put a bangin- oh, nevermind."
	icon_state = "donk"
...
/obj/item/weapon/reagent_containers/food/snacks/variable/jelly
	name = "jelly"
	desc = "All my friends will be jelly."
