...
/obj/machinery/navbeacon/attackby(var/obj/item/I, var/mob/user)
	...
	if(isScrewdriver(I))
		...
		user.visible_message("\The [user] [open ? "opens" : "closes"] cover of \the [src].", "I [open ? "open" : "close"] cover of \the [src].")
...
/obj/machinery/navbeacon/genesis/bridge2
	location = "bridge2"
	codes = list("patrol" = 1, "next_patrol" = "rdoffice")

/obj/machinery/navbeacon/genesis/vault2
	location = "vault2"
	codes = list("patrol" = 1, "next_patrol" = "medical")

/obj/machinery/navbeacon/genesis/vault1
	location = "vault1"
	codes = list("patrol" = 1, "next_patrol" = "xooffice")

/obj/machinery/navbeacon/genesis/medical
	location = "medical"
...
/obj/machinery/navbeacon/genesis/rdoffice
	location = "rdoffice"
	codes = list("patrol" = 1, "next_patrol" = "vault2")

// genesis delivery types

/obj/machinery/navbeacon/genesis/QM3
	location = "QM #3"
