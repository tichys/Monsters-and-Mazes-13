...
/obj/machinery/requests_console
	...
	var/department = "Unknown" //The list of all departments on the station (Determined from this variable on each unit) Set this to the same thing if I want several consoles in one department
...
//	var/hackState = 0
	...
	var/announceAuth = 0 //Will be set to 1 when I authenticate myself for announcements
...
/obj/machinery/requests_console/Topic(href, href_list)
	...
	if(reject_bad_text(href_list["write"]))
		...
		var/new_message = sanitize(input("Write my message:", "Awaiting Input", ""))
		if(new_message)
			message = new_message
			screen = RCS_MESSAUTH
