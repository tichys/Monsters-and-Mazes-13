...
/*
	Hello, friends, this is Doohl from sexylands. I may be wondering what this
	monstrous code file is. Sit down, boys and girls, while I tell I the tale.
...
/obj/machinery/telecomms
	...
	var/long_range_link = 0	// Can I link it across Z levels or on the otherside of the map? (Relay & Hub)
