...
/obj/machinery/turretid/emag_act(var/remaining_charges, var/mob/user)
	if(!emagged)
		to_chat(user, "<span class='danger'>I short out the turret controls' access analysis module.</span>")
		emagged = 1
		locked = 0
		ailock = 0
		return 1
...
/obj/machinery/turretid/malf_upgrade(var/mob/living/silicon/ai/user)
	...
	locked = 1
	ailock = 0
	to_chat(user, "\The [src] has been upgraded. It has been locked and can not be tampered with by anyone but I and my cyborgs.")
	master_ai = user
	return 1