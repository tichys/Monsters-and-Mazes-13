...
They should be used for undeterminate mob effects, like for instance a toggle-able forcefield, or indestructability as long as I don't move.
They should also be used for when I want to effect the ENTIRE mob, like having an armor buff or showering candy everytime I walk.
*/
