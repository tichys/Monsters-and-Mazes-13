...
/obj/aura/regenerating/human
	...
	var/organ_mult = 2
	var/regen_message = "<span class='warning'>My body throbs as I feel my ORGAN regenerate.</span>"
	var/grow_chance = 0
...
/obj/aura/regenerating/human/diona
	...
	organ_mult = 2
	regen_message = "<span class='warning'>I sense my nymphs shifting internally to regenerate my ORGAN..</span>"
	grow_chance = 5
	grow_threshold = 100
...
/obj/aura/regenerating/human/diona/external_regeneration_effect(var/obj/item/organ/external/O, var/mob/living/carbon/human/H)
	to_chat(H, "<span class='warning'>Some of my nymphs split and hurry to reform my [O.name].</span>")
	H.nutrition -= 60