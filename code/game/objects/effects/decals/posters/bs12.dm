...
/decl/poster/bay_13
	...
	desc = "This particular one depicts a wizard, casting a spell. I can't really make out if it's an actual photograph or a computer-generated image."
...
/decl/poster/bay_18
	...
	desc = "Here to protect and serve... my donuts! A generously proportioned man, he teaches I the value of hiding my snacks."
...
/decl/poster/bay_22
	...
	desc = "A recruitment poster starring a dark haired woman with glasses and a purple shirt that has \"Got Brains? Got Talent? Not afraid of electric flying monsters that want to suck the soul out of you? Then Xenobiology could use someone like me!\" written on the bottom."
...
/decl/poster/bay_24
	...
	desc = "A poster with a nervous looking geneticist on it states; \"Friends Tell Friends They're Clones. It can cause severe and irreparable emotional trauma if a person is not properly informed of their recent demise. Always follow my contractual obligation and inform them of their recent rejuvenation.\""
...
/decl/poster/bay_29
	...
	desc = "On the poster is a frighteningly large wolf, he warns: \"Only I can keep humanity from freezing during planetary occultation!\""

/decl/poster/bay_30
	icon_state="bsposter30"
	name = "Ambrosia Vulgaris"
	desc = "Just looking at this poster makes I feel a little bit dizzy."
...
/decl/poster/bay_32
	...
	name = "Eat!"
	desc = "A poster depicting a hamburger. The poster orders I to consume the hamburger."

/decl/poster/bay_33
	icon_state="bsposter33"
	name = "Tools, tools, tools"
	desc = "I can never have enough tools, thats for sure!"
...
/decl/poster/bay_41
	...
	desc = "A safety poster featuring a green haired woman in a shimmering blue dress. \"As an Internal Affairs Agent, my job is to create a fair and agreeable work environment for the crewmembers, as discreetly and professionally as possible.\""

/decl/poster/bay_42
	icon_state="bsposter42"
	name = "Engineering pinup"
	desc = "This is pin-up poster. A half-naked girl with white hair, toned muscles and stunning blue eyes looks back at I from the poster. Her welding helmet, tattoos and grey jumpsuit hanging around her waist gives a bit of a rugged feel."
...
/decl/poster/bay_46
	...
	desc = "An inspirational poster depicting a  lawyer. He seems to be shouting something, while pointing fiercely to the right."
...
/decl/poster/bay_52
	...
	desc = "This is a poster reminding I of what I should do if I am on fire, or if I am at a dance party."

/decl/poster/bay_53
	icon_state="bsposter53"
	name = "fire extinguisher poster"
	desc = "This is a poster reminding I of what I should use to put out a fire."

/decl/poster/bay_54
	icon_state="bsposter54"
	name = "firefighter poster"
	desc = "This is a poster of a particularly stern looking firefighter. The caption reads, \"Only I can prevent space fires.\""
