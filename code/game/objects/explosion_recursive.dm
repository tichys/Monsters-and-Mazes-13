...
proc/explosion_rec(turf/epicenter, power, shaped)
	...
	for(var/spot in explosion_turfs)
		...
		//Wow severity looks confusing to calculate... Fret not, I didn't leave I with any additional instructions or help. (just kidding, see the line under the calculation)
