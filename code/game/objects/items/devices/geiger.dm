...
/obj/item/device/geiger
	...
	description_info = "By using this item, I may toggle its scanning mode on and off. Examine it while it's on to check for ambient radiation."
	description_fluff = "For centuries geiger counters have been saving the lives of unsuspecting laborers and technicians. I can never be too careful around radiation."
...
/obj/item/device/geiger/attack_self(var/mob/user)
	...
	if(scanning)
		...
		STOP_PROCESSING(SSobj, src)
	update_icon()
	to_chat(user, "<span class='notice'>\icon[src] I switch [scanning ? "on" : "off"] [src].</span>")
