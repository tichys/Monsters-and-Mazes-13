...
/obj/item/device/multitool
	...
	description_antag = "This handy little tool can get I through doors, turn off power, and anything else I might need."
...
/obj/item/device/multitool/proc/get_buffer(var/typepath)
	...
	// Means I cannot be sure the source hasn't been destroyed until the very moment it's needed.
