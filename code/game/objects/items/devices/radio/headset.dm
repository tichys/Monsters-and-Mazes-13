...
/obj/item/device/radio/headset/headset_sec
	...
	desc = "This is used by my elite security force."
...
/obj/item/device/radio/headset/ia
	...
	desc = "The headset of my worst enemy."
	icon_state = "com_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/heads/hos
...
/obj/item/device/radio/headset/entertainment
	...
	desc = "specially made to make I sound less cheesy."
	icon_state = "com_headset"
	item_state = "headset"
...
//	..()
	...
	if(isScrewdriver(W))
		if(encryption_keys.len)
			...
			recalculateChannels(1)
			to_chat(user, "I pop out the encryption keys in the headset!")
	...
	if(istype(W, /obj/item/device/encryptionkey/))
		...
		if(user.unEquip(W, target = src))
			to_chat(user, "<span class='notice'>I put \the [W] into \the [src].</span>")
			encryption_keys += W
			recalculateChannels(1)
