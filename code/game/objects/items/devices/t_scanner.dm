...
/obj/item/device/t_scanner
	...
	description_fluff = "The T-ray scanner is a modern spectroscopy solution and labor-saving device. Why work myself to the bone removing floor panels when I can simply look through them with submillimeter radiation?"
	icon_state = "t-ray0"
