/obj/item/device/transfer_valve
	...
	description_info = "This machine is used to merge the contents of two different gas tanks. Plug the tanks into the transfer, then open the valve to mix them together. I can also attach various assembly devices to trigger this process."
	description_antag = "With a tank of hot phoron and cold oxygen, this benign little atmospheric device becomes an incredibly deadly bomb. I don't want to be anywhere near it when it goes off."
...
/obj/item/device/transfer_valve/attackby(obj/item/item, mob/user)
	...
	if(istype(item, /obj/item/weapon/tank))
		...
		src.w_class = max(initial(src.w_class),T1_weight,T2_weight) //gets w_class of biggest object, because I shouldn't be able to just shove tanks in and have them be tiny.
