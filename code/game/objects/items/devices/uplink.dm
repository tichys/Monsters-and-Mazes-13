...
/* How to create an uplink in 3 easy steps!
 ...
 3. If I want the menu to stay until the users locks his uplink, add an active_uplink_check(mob/user as mob) in my interact/attack_hand proc.
...
// If true, it accesses trigger() and returns 1. If it fails, it returns false. Use this to see if I need to close the
// current item's menu.
...
// I place this in my uplinkable item to check if an uplink is active or not.
