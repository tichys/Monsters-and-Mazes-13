...
/obj/item/stack/material/animalhide/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(	istype(W, /obj/item/weapon/material/knife) || \
		...
		usr.visible_message("<span class='notice'>\The [usr] starts cutting hair off \the [src]</span>", "<span class='notice'>I start cutting the hair off \the [src]</span>", "I hear the sound of a knife rubbing against flesh")
		if(do_after(user,50))
			to_chat(usr, "<span class='notice'>I cut the hair from this [src.singular_name]</span>")
