...
/obj/item/weapon/flamethrower/afterattack(atom/target, mob/user, proximity)
	...
	if(user && user.get_active_hand() == src)
		if(user.a_intent == I_HELP) //don't shoot if we're on help intent
			to_chat(user, "<span class='warning'>I refrain from firing \the [src] as my intent is set to help.</span>")
			return
...
/obj/item/weapon/flamethrower/proc/ignite_turf(turf/target)
	...
	//air_transfer.toxins = air_transfer.toxins * 5 // This is me not comprehending the air system. I realize this is retarded and I could probably make it work without fucking it up like this, but there I have it. -- TLE
