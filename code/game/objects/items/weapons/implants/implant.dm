...
//Called in surgery when incision is retracted open / ribs are opened - basically before I can take implant out
...
/obj/item/weapon/implant/proc/meltdown()	//breaks it down, making implant unrecongizible
	to_chat(imp_in, "<span class='warning'>I feel something melting inside [part ? "My [part.name]" : "you"]!</span>")
	if (part)
