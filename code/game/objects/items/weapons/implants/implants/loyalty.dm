...
/obj/item/weapon/implant/loyalty/implanted(mob/M)
	...
	if(antag_data && (antag_data.flags & ANTAG_IMPLANT_IMMUNE))
		H.visible_message("[H] seems to resist the implant!", "I feel the corporate tendrils of [GLOB.using_map.company_name] try to invade my mind!")
		return FALSE
	else
		clear_antag_roles(H.mind, 1)
		to_chat(H, "<span class='notice'>I feel a surge of loyalty towards [GLOB.using_map.company_name].</span>")
	return TRUE
