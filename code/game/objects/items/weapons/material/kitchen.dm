...
/obj/item/weapon/material/kitchen/utensil/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob)
	...
	if (reagents.total_volume > 0)
		...
		to_chat(user, "<span class='warning'>I don't have anything on \the [src].</span>")//if we have help intent and no food scooped up DON'T STAB OURSELVES WITH THE FORK
		return
...
/obj/item/weapon/material/kitchen/utensil/spoon
	name = "spoon"
	desc = "It's a spoon. I can see my own upside-down face in it."
	icon_state = "spoon"
...
/obj/item/weapon/material/kitchen/utensil/knife/survival
	name = "survival knife"
	desc = "A small, knife, meant to help stranded crew survive."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "survival"
	item_state = "knife"
	unbreakable = 1
...
/obj/item/weapon/material/kitchen/utensil/knife/attack(target as mob, mob/living/user as mob)
	if ((CLUMSY in user.mutations) && prob(50))
		to_chat(user, "<span class='warning'>I accidentally cut myself with \the [src].</span>")
