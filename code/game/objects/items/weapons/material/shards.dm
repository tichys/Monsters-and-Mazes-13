...
/obj/item/weapon/material/shard/set_material(var/new_material)
	...
	if(material.shard_type)
		...
		desc = "A small piece of [material.display_name]. It looks sharp, I wouldn't want to step on it barefoot. Could probably be used as ... a throwing weapon?"
...
/obj/item/weapon/material/shard/Crossed(AM as mob|obj)
	...
	if(isliving(AM))
		...
		if(ishuman(M))
			...
			to_chat(M, "<span class='danger'>I step on \the [src]!</span>")
