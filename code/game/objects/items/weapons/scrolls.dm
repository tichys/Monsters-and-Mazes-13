...
/obj/item/weapon/teleportation_scroll/attack_self(mob/user as mob)
	if((user.mind && !GLOB.wizards.is_antagonist(user.mind)))
		to_chat(usr, "<span class='warning'>I stare at the scroll but cannot make sense of the markings!</span>")
		return
	...
	dat += "Kind regards,<br>Wizards Federation<br><br>P.S. Don't forget to bring my gear, you'll need it to cast most spells.<HR>"
