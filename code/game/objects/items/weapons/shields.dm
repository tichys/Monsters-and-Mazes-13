...
//bad_arc is the ABSOLUTE arc of directions from which we cannot block. If I want to fix it to e.g. the user's facing I will need to rotate the dirs myself.
...
/obj/item/weapon/shield/buckler
	name = "buckler"
	desc = "A wooden buckler used to block sharp things from entering my body back in the day.."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "buckler"
	slot_flags = SLOT_BACK
	force = 8
...
/obj/item/weapon/shield/energy/attack_self(mob/living/user as mob)
	if ((CLUMSY in user.mutations) && prob(50))
		to_chat(user, "<span class='warning'>I beat myself in the head with [src].</span>")
