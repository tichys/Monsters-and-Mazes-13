...
/obj/item/weapon/storage/backpack
	name = "backpack"
	desc = "I wear this on my back and put items into it."
	item_icons = list(
...
/obj/item/weapon/storage/backpack/check_inaccessible(mob/user as mob)
	if(src == user.back)  // I have to hold backpacks, sorry my guys
		to_chat(user, "my arms aren't long enough to reach in the [src] while it's on my back!")
		return TRUE
	. = ..()
...
/obj/item/weapon/storage/backpack/cultpack
	name = "trophy rack"
	desc = "It's useful for both carrying extra gear and proudly declaring my insanity."
	icon_state = "cultpack"
