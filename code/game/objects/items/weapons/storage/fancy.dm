...
// New exciting ways to kill my lungs! - Earthcrusher //

/obj/item/weapon/storage/fancy/cigarettes/luckystars
	name = "pack of Lucky Stars"
	desc = "A mellow blend made from synthetic, pod-grown tobacco. The commercial jingle is guaranteed to get stuck in my head."
	icon_state = "LSpacket"
...
/obj/item/weapon/storage/fancy/cigarettes/jerichos
	...
	desc = "Typically seen dangling from the lips of Martian soldiers and border world hustlers. Tastes like hickory smoke, feels like warm liquid death down my lungs."
	icon_state = "Jpacket"
	item_state = "Dpacket"
...
/obj/item/weapon/storage/fancy/cigar
	name = "cigar case"
	desc = "A case for holding my cigars when I am not smoking them."
