...
/obj/item/weapon/storage/lockbox
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		if (istype(W, /obj/item/weapon/card/id))
			...
			if(emag_act(INFINITY, user, W, "The locker has been sliced open by [user] with an energy blade!", "I hear metal being sliced and sparks flying."))
...
/obj/item/weapon/storage/lockbox/emag_act(var/remaining_charges, var/mob/user, var/emag_source, var/visual_feedback = "", var/audible_feedback = "")
	if(!broken)
		...
		if(audible_feedback)
			...
			audible_feedback = "<span class='warning'>I hear a faint electrical spark.</span>"
