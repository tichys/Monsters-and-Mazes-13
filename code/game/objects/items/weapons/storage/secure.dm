...
/obj/item/weapon/storage/secure
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		if(locked)
			if (istype(W, /obj/item/weapon/melee/energy/blade) && emag_act(INFINITY, user, "I slice through the lock of \the [src]"))
			...
			if(isMultitool(W) && (src.open == 1)&& (!src.l_hacking))
				...
				return
			//At this point I have exhausted all the special things to do when locked
...
/obj/item/weapon/storage/secure/emag_act(var/remaining_charges, var/mob/user, var/feedback)
	if(!emagged)
		...
		locked = 0
		to_chat(user, (feedback ? feedback : "I short out the lock of \the [src]."))
		return 1
