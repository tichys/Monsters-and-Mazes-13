...
/obj/item/weapon/storage/box/syndie_kit/chameleon
	name = "chameleon kit"
	desc = "Comes with all the clothes I need to impersonate most people.  Acting lessons sold seperately."
	startswith = list(
...
/obj/item/weapon/storage/backpack/satchel/syndie_kit/clerical
	name = "clerical kit"
	desc = "Comes with all I need to fake paperwork. Assumes I have passed basic writing lessons."
	startswith = list(
...
/obj/item/weapon/storage/box/syndie_kit/spy
	name = "spy kit"
	desc = "For when I want to conduct voyeurism from afar."
	startswith = list(
...
/obj/item/weapon/storage/backpack/satchel/syndie_kit/armor
	name = "armor satchel"
	desc = "A satchel for when I don't want to try a diplomatic approach."
	startswith = list(
