...
/obj/item/weapon/tank/jetpack/examine(mob/living/user)
	...
	if(air_contents.total_moles < 5)
		to_chat(user, "<span class='danger'>The meter on \the [src] indicates I am almost out of gas!</span>")

/obj/item/weapon/tank/jetpack/verb/toggle_rockets()
	set name = "Toggle Jetpack Stabilization"
	set category = "Object"
	src.stabilization_on = !( src.stabilization_on )
	to_chat(usr, "I toggle the stabilization [stabilization_on? "on":"off"].")
...
/obj/item/weapon/tank/jetpack/verb/toggle()
	...
	to_chat(usr, "I toggle the thrusters [on? "on":"off"].")
...
/obj/item/weapon/tank/jetpack/rig/examine()
	. = ..()
	to_chat(usr, "It's a jetpack. If I can see this, report it on the bug tracker.")
	return 0
