...
/obj/item/weapon/tray/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob)
	...
	if((CLUMSY in user.mutations) && prob(50))              //What if he's a clown?
		to_chat(M, "<span class='warning'>I accidentally slam myself with the [src]!</span>")
		M.Weaken(1)
	...
	if(protected)
		to_chat(M, "<span class='warning'>I get slammed in the face with the tray, against my mask!</span>")
		if(prob(33))
			src.add_blood(H)
			if (H.wear_mask)
