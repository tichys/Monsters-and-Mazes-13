/obj/structure/displaycase
	...
	icon_state = "glassbox"
	desc = "A display case for prized possessions. It taunts I to kick it."
	density = 1
	anchored = 1
...
/obj/structure/displaycase/examine(var/user)
	..()
	if(contents.len)
		to_chat(user, "Inside I see [english_list(contents)].")
...
/obj/structure/displaycase/attack_hand(mob/user as mob)
	...
	if(!destroyed)
		to_chat(usr, text("<span class='warning'>I kick the display case.</span>"))
