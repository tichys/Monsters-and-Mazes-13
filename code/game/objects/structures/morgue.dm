...
/obj/structure/morgue/attackby(P as obj, mob/user as mob)
	if (istype(P, /obj/item/weapon/pen))
		var/t = input(user, "What would I like the label to be?", text("[]", src.name), null)  as text
...
/obj/structure/morgue/Entered(mob/living/carbon/human/H)
	. = ..()
	H.update_buried(1)

/obj/structure/morgue/Exited(mob/living/carbon/human/H)
	. = ..()
	H.update_buried(0)
...
/obj/structure/crematorium/proc/cremate(atom/A, mob/user as mob)
	if(cremating)
		return //don't let I cremate something twice or w/e

	if(contents.len <= 0)
		src.audible_message("<span class='warning'>I hear a hollow crackle.</span>", 1)
		return

	else
		src.audible_message("<span class='warning'>I hear a roar as the [src] activates.</span>", 1)
