...
/obj/structure/sign/attackby(obj/item/tool as obj, mob/user as mob)	//deconstruction
	if(isScrewdriver(tool) && !istype(src, /obj/structure/sign/double) && !istype(src, /obj/structure/sign/triple)) // this line
		to_chat(user, "I unfasten the sign with my [tool.name].")
...
/obj/structure/sign/monkey_painting
	...
	desc = "Under the painting a plaque reads: 'While the meat grinder may not have spared you, fear not. Not one part of I has gone to waste... I were delicious.'"
...
/obj/structure/sign/redcross
	name = "medbay"
	desc = "The Intergalactic symbol of Medical institutions. I'll probably get help here."
	icon_state = "redcross"
...
/obj/structure/sign/floorplaque
	...
	desc = "A list of dead explorers who gave their lives in search of the next great discovery. Hope I don't join them."
...
/obj/structure/sign/triple/penitentiary
	name = "Penitentiary"
	desc = "The stone is worn, but readable."

/obj/structure/sign/triple/penitentiary/left
	icon_state = "pen-1"

/obj/structure/sign/triple/penitentiary/middle
	icon_state = "pen-2"

/obj/structure/sign/triple/penitentiary/right
	icon_state = "pen-3"

/obj/item/sign/medipolma
	name = "medical diploma"
	desc = "A fancy print laminated paper that certifies that its bearer is indeed a Doctor of Medicine, graduated from a medical school in one of fringe systems. I don't recognize the name though, and half of latin words they used do not actually exist."
	icon = 'icons/obj/decals.dmi'
	icon_state = "goldenplaque"
...
/obj/item/sign/medipolma/attack_self(mob/user)
	if(!claimant)
		to_chat(user, "<span class='notice'>I fill in my name in the blanks with a permanent marker.</span>")
