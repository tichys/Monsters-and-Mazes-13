...
world/IsBanned(key,address,computer_id)
	...
	if(config.usewhitelist && !is_whitelisted(key))
		to_world_log("[key] not whitelisted")
		log_access("Failed login: [key] - Not whitelisted")
		message_admins("<span class='notice'>Failed login: [key] - Not whitelisted</span>")
