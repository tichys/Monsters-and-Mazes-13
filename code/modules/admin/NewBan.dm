...
/proc/CheckBan(var/ckey, var/id, var/address)
	...
	if(config && config.banappeals)
		appeal = "\nFor more information on my ban, or to appeal, head to <a href='[config.banappeals]'>[config.banappeals]</a>"
	Banlist.cd = "/base"
...
/mob/proc/autoban(message, time = 1440)
	AddBan(ckey, computer_id, message, "Autoban", "1", time, lastKnownIP)
	if(client)
		to_chat(src, "<span class=\"danger\">You have been banned for [time] minutes. <br> Reason: [message].</span>")
		qdel(client)
