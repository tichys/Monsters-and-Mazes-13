...
/datum/admins/proc/show_player_panel(var/mob/M in SSmobs.mob_list)
	...
	if (!istype(src,/datum/admins))
		to_chat(usr, "Error: I am not an admin!")
		return
	...
	feedback_add_details("admin_verb","SPP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/access_news_network() //MARKER
	...
	set desc = "Allows I to view, add and edit news feeds."
	...
	switch(admincaster_screen)
		if(0)
			dat += {"Welcome to the admin newscaster.<BR> Here I can add, edit and censor every newspiece on the network.
			...
			dat+={"<HR><B>Feed Security functions:</B><BR>
				...
				<BR><HR><A href='?src=\ref[src];ac_set_signature=1'>The newscaster recognises I as:<BR> <FONT COLOR='green'>[src.admincaster_signature]</FONT></A>
			"}
		if(1)
		...
		if(11)
			dat+={"
				...
				stories it might contain at the time. I can lift a D-Notice if I have the required access at any time.</FONT><HR>
			"}
			if(isemptylist(news_network.network_channels))
				dat+="<I>No feed channels found active...</I><BR>"
			else
		...
		if(13)
			dat+={"
				<B>[src.admincaster_feed_channel.channel_name]: </B><FONT SIZE=1>\[ created by: <FONT COLOR='maroon'>[src.admincaster_feed_channel.author]</FONT> \]</FONT><BR>
				Channel messages listed below. If I deem them dangerous to the [station_name()], I can <A href='?src=\ref[src];ac_toggle_d_notice=\ref[src.admincaster_feed_channel]'>Bestow a D-Notice upon the channel</A>.<HR>
			"}
			if(src.admincaster_feed_channel.censored)
				dat+={"
					<FONT COLOR='red'><B>ATTENTION: </B></FONT>This channel has been deemed as threatening to the welfare of the [station_name()], and marked with a [GLOB.using_map.company_name] D-Notice.<BR>
		...
		if(14)
			...
			if(news_network.wanted_issue)
				...
				end_param = 2
			if(wanted_already)
				dat+="<FONT SIZE=2><BR><I>A wanted issue is already in Feed Circulation. I can edit or cancel it below.</FONT></I>"
			dat+={"
				<HR>
		...
		if(19)
			...
			dat+="I'm sorry to break my immersion. This shit's bugged. Report this bug to Agouri, polyxenitopalidou@gmail.com"
...
/datum/admins/proc/Secrets(var/datum/admin_secret_category/active_category = null)
	...
	var/dat = "<B>The first rule of adminbuse is: I don't talk about the adminbuse.</B><HR>"
...
/datum/admins/proc/restart()
	...
	if(confirm == "Yes")
		...
		feedback_add_details("admin_verb","R") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/announce()
	...
	feedback_add_details("admin_verb","A") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleooc()
	...
	feedback_add_details("admin_verb","TOOC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleaooc()
	...
	feedback_add_details("admin_verb","TAOOC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/togglelooc()
	...
	feedback_add_details("admin_verb","TLOOC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggledsay()
	...
	feedback_add_details("admin_verb","TDSAY") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc
...
/datum/admins/proc/toggleoocdead()
	...
	feedback_add_details("admin_verb","TDOOC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/togglehubvisibility()
	...
	feedback_add_details("admin_verb","THUB") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc
...
/datum/admins/proc/toggletraitorscaling()
	...
	feedback_add_details("admin_verb","TTS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/startnow()
	...
	if(ticker.current_state == GAME_STATE_PREGAME && !(initialization_stage & INITIALIZATION_NOW))
		...
		feedback_add_details("admin_verb","SN") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleenter()
	...
	world.update_status()
	feedback_add_details("admin_verb","TE") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleAI()
	...
	world.update_status()
	feedback_add_details("admin_verb","TAI") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleaban()
	...
	world.update_status()
	feedback_add_details("admin_verb","TR") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggle_aliens()
	...
	feedback_add_details("admin_verb","TA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggle_alien_eggs()
	...
	feedback_add_details("admin_verb","AEA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggle_space_ninja()
	...
	feedback_add_details("admin_verb","TSN") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/delay()
	...
	feedback_add_details("admin_verb","DELAY") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/adjump()
	...
	feedback_add_details("admin_verb","TJ") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/adspawn()
	...
	feedback_add_details("admin_verb","TAS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/adrev()
	...
	feedback_add_details("admin_verb","TAR") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/immreboot()
	...
	feedback_add_details("admin_verb","IR") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/unprison(var/mob/M in SSmobs.mob_list)
	...
	feedback_add_details("admin_verb","UP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/spawn_atom(var/object as text)
	...
	feedback_add_details("admin_verb","SA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/show_traitor_panel(var/mob/M in SSmobs.mob_list)
	...
	M.mind.edit_memory()
	feedback_add_details("admin_verb","STP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggletintedweldhelmets()
	...
	feedback_add_details("admin_verb","TTWH") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleguests()
	...
	feedback_add_details("admin_verb","TGU") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/output_ai_laws()
	...
	if(!ai_number)
		to_chat(usr, "<b>No AIs located</b>")//Just so I know the thing is actually working and not just ignoring you.
...
/datum/admins/proc/show_skills(mob/M)
	...
	if(is_admin(usr))
		NM = /datum/nano_module/skill_ui/admin //They get the fancy version that lets I change skills and debug stuff.
...
/datum/admins/proc/cmd_ghost_drag(var/mob/observer/ghost/frommob, var/mob/living/tomob)
	...
	question += "Are I sure I want to place [frommob.name]([frommob.key]) in control of [tomob.name]?"
...
/datum/admins/proc/faxCallback(var/obj/item/weapon/paper/admin/P, var/obj/machinery/photocopier/faxmachine/destination)
	...
	if(!P.sender) // admin initiated
		switch(alert("Would I like the fax stamped?",, "Yes", "No"))
			if("No")
				shouldStamp = 0
