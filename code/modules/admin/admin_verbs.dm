//admin verb groups - They can overlap if I so wish. Only one of each verb will exist in the verbs list regardless
...
var/list/admin_verbs_debug = list(
	...
	/client/proc/view_initialization_log
	)
...
/client/proc/hide_most_verbs()//Allows I to keep some functionality while hiding some verbs
	...
	feedback_add_details("admin_verb","HMV") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/hide_verbs()
	...
	feedback_add_details("admin_verb","TAVVH") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/show_verbs()
	...
	feedback_add_details("admin_verb","TAVVS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/admin_ghost()
	...
	if(isghost(mob))
		...
		feedback_add_details("admin_verb","P") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		...
		feedback_add_details("admin_verb","O") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/invisimin()
	...
	if(holder && mob)
		if(mob.invisibility == INVISIBILITY_OBSERVER)
			...
			to_chat(mob, "<span class='notice'>Invisimin on. I am now as invisible as a ghost.</span>")
...
/client/proc/player_panel()
	...
	feedback_add_details("admin_verb","PP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/player_panel_new()
	...
	feedback_add_details("admin_verb","PPN") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/check_antagonists()
	...
	feedback_add_details("admin_verb","CHA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/jobbans()
	...
	if(holder)
		if(config.ban_legacy_system)
			...
			holder.DB_ban_panel()
	feedback_add_details("admin_verb","VJB") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/unban_panel()
	...
	if(holder)
		if(config.ban_legacy_system)
			...
			holder.DB_ban_panel()
	feedback_add_details("admin_verb","UBP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/game_panel()
	...
	if(holder)
		holder.Game()
	feedback_add_details("admin_verb","GP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/secrets()
	...
	if (holder)
		holder.Secrets()
	feedback_add_details("admin_verb","S") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/colorooc()
	...
	if(response == "Pick new color")
		prefs.ooccolor = input(src, "Please select my OOC colour.", "OOC colour") as color
	else if(response == "Reset to default")
		prefs.ooccolor = initial(prefs.ooccolor)
	prefs.save_preferences()

	feedback_add_details("admin_verb","OC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/warn(warned_ckey)
	...
	if(warned_ckey in admin_datums)
		to_chat(usr, "<font color='red'>Error: warn(): I can't warn admins.</font>")
		return
	...
	if(++D.warns >= MAX_WARNS)					//uh ohhhh...you'reee iiiiin trouuuubble O:)
		...
		if(C)
			...
			to_chat(C, "<font color='red'><BIG><B>I have been autobanned due to a warning by [ckey].</B></BIG><br>This is a temporary ban, it will be removed in [AUTOBANTIME] minutes.</font>")
			qdel(C)
		else
		...
		if(C)
			to_chat(C, "<font color='red'><BIG><B>I have been formally warned by an administrator.</B></BIG><br>Further warnings will result in an autoban.</font>")
			message_admins("[key_name_admin(src)] has warned [key_name_admin(C)]. They have [MAX_WARNS-D.warns] strikes remaining.")
		else
			message_admins("[key_name_admin(src)] has warned [warned_ckey] (DC). They have [MAX_WARNS-D.warns] strikes remaining.")

	feedback_add_details("admin_verb","WARN") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/drop_bomb() // Some admin dickery that can probably be done better -- TLE
	...
	var/choice = input("What size explosion would I like to produce?") in choices
	switch(choice)
		if(null)
			return 0
		if("Small Bomb")
	...
	feedback_add_details("admin_verb","DB") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/give_disease2(mob/T as mob in SSmobs.mob_list) // -- Giacom
	...
	feedback_add_details("admin_verb","GD2") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/togglebuildmodeself()
	...
	feedback_add_details("admin_verb","TBMS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/object_talk(var/msg as text) // -- TLE
	...
	feedback_add_details("admin_verb","OT") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/kill_air() // -- TLE
	...
	feedback_add_details("admin_verb","KA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/readmin_self()
	...
	if(deadmin_holder)
		...
		to_chat(src, "<span class='interface'>I now have the keys to control the planet, or atleast a small space station</span>")
...
/client/proc/deadmin_self()
	...
	if(holder)
		if(alert("Confirm self-deadmin for the round? I can re-admin myself at any time.",,"Yes","No") == "Yes")
			log_admin("[src] deadmined themself.")
			message_admins("[src] deadmined themself.", 1)
			deadmin()
			to_chat(src, "<span class='interface'>I am now a normal player.</span>")
			verbs |= /client/proc/readmin_self
	feedback_add_details("admin_verb","DAS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/rename_silicon()
	...
	feedback_add_details("admin_verb","RAI") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/manage_silicon_laws()
	...
	feedback_add_details("admin_verb","MSL") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!

/client/proc/change_human_appearance_admin()
	set name = "Change Mob Appearance - Admin"
	set desc = "Allows I to change the mob appearance"
	set category = "Admin"
	...
	feedback_add_details("admin_verb","CHAA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/change_human_appearance_self()
	...
	feedback_add_details("admin_verb","CMAS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/*	if(holder)
		holder.mod_panel()*/
//	feedback_add_details("admin_verb","MP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/editappear()
	...
	if(!istype(M, /mob/living/carbon/human))
		...
		return
	switch(alert("Are I sure I wish to edit this mob's appearance?","Yes","No"))
		if("No")
			return
	...
	var/new_skin = input("Please select body color. This is for Tajaran only!", "Character Generation") as color
	if(new_skin)
...
/client/proc/give_spell(mob/T as mob in SSmobs.mob_list) // -- Urist
	...
	if(!S) return
	T.add_spell(new S)
	feedback_add_details("admin_verb","GS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
