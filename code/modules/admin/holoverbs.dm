...
/datum/admins/proc/ai_hologram_set(mob/appear as mob in world)
	...
	set desc = "Set an AI's hologram to a mob. Use this verb on the mob I want the hologram to look like."
	set category = "Fun"
	...
	var/mob/living/silicon/ai/AI = input("Which AI do I want to apply [appear] to as a hologram?") as null|anything in AIs
	if(!AI) return
	...
	to_chat(AI, "My hologram icon has been set to [appear].")
