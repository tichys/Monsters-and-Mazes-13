...
/datum/admin_secret_item/final_solution/summon_narsie/execute(var/mob/user)
	...
	if(!.)
		return
	var/choice = input(user, "I sure I want to end the round and summon Nar-Sie at my location? Misuse of this could result in removal of flags or hilarity.") in list("PRAISE SATAN", "Cancel")
