...
/datum/admin_secret_item/final_solution/supermatter_cascade/execute(var/mob/user)
	...
	if(!.)
		return
	var/choice = input(user, "I sure I want to destroy the universe and create a large explosion at my location? Misuse of this could result in removal of flags or hilarity.") in list("NO TIME TO EXPLAIN", "Cancel")
