...
/datum/ticket/proc/close(var/datum/client_lite/closed_by)
	...
	if(status == TICKET_ASSIGNED && !((closed_by.ckey in assigned_admin_ckeys()) || owner.ckey == closed_by.ckey) && alert(client_by_ckey(closed_by.ckey), "I am not assigned to this ticket. Are I sure I want to close it?",  "Close ticket?" , "Yes" , "No") != "Yes")
		return
	...
	to_chat(client_by_ckey(src.owner.ckey), "<span class='notice'><b>My ticket has been closed by [closed_by.ckey].</b></span>")
...
/datum/ticket/proc/take(var/datum/client_lite/assigned_admin)
	...
	if(status == TICKET_ASSIGNED && ((assigned_admin.ckey in assigned_admin_ckeys()) || alert(client_by_ckey(assigned_admin.ckey), "This ticket is already assigned. Do I want to add myself to the ticket?",  "Join ticket?" , "Yes" , "No") != "Yes"))
		return
	...
	to_chat(client_by_ckey(src.owner.ckey), "<span class='notice'><b>[assigned_admin.ckey] has added themself to my ticket and should respond shortly. Thanks for my patience!</b></span>")
