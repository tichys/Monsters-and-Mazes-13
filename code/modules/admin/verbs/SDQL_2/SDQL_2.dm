...
/*
	...
	--I can use operators other than ==, such as >, <=, != and etc..
...
/client/proc/SDQL2_query(var/query_text as message)
	...
	try
		...
		to_chat(usr, "<span class='danger'>An exception has occured during the execution of my query and my query has been aborted.</span>")
...
/proc/SDQL2_tokenize(query_text)
	...
	for(var/i = 1, i <= len, i++)
		...
		if(char in whitespace)
			...
			if(word != "")
				to_chat(usr, "<span class='warning'>SDQL2: I have an error in my SDQL syntax, unexpected ' in query: \"<font color=gray>[query_text]</font>\" following \"<font color=gray>[word]</font>\". Please check my syntax, and try again.</span>")
				return null
			...
			if(i > len)
				to_chat(usr, "<span class='warning'>SDQL2: I have an error in my SDQL syntax, unmatched ' in query: \"<font color=gray>[query_text]</font>\". Please check my syntax, and try again.</span>")
				return null
