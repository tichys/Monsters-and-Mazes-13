...
/client/verb/adminhelp(msg as text)
	...
	if(prefs.muted & MUTE_ADMINHELP)
		to_chat(src, "<font color='red'>Error: Admin-PM: I cannot send adminhelps (Muted).</font>")
		return
	...
	feedback_add_details("admin_verb","AH") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
