...
/client/proc/Jump(var/selected_area in area_repository.get_areas_by_z_level())
	...
	feedback_add_details("admin_verb","JA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/jumptoturf(var/turf/T)
	...
	mob.jumpTo(T)
	feedback_add_details("admin_verb","JT") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/jumptomob(var/mob/M in SSmobs.mob_list)
	...
	if(config.allow_admin_jump)
		...
		if(mob)
			...
			if(T && isturf(T))
				feedback_add_details("admin_verb","JM") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
				mob.jumpTo(T)
			else
...
/client/proc/jumptocoord(tx as num, ty as num, tz as num)
	...
	feedback_add_details("admin_verb","JC") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/jumptokey(client/C in sorted_client_keys())
	...
	if(config.allow_admin_jump)
		...
		feedback_add_details("admin_verb","JK") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	else
		alert("Admin jumping disabled")
...
/client/proc/Getmob(var/mob/M in SSmobs.mob_list)
	...
	if(config.allow_admin_jump)
		...
		feedback_add_details("admin_verb","GM") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	else
		alert("Admin jumping disabled")
...
/client/proc/Getkey()
	...
	if(config.allow_admin_jump)
		...
		if(M)
			M.jumpTo(get_turf(mob))
			feedback_add_details("admin_verb","GK") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	else
		alert("Admin jumping disabled")
...
/client/proc/sendmob(var/mob/M in sortmobs())
	...
	if(A)
		...
		feedback_add_details("admin_verb","SMOB") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
