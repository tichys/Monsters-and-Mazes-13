/client/proc/cmd_admin_say(msg as text)
	...
	set name = "Asay" //Gave this shit a shorter name so I only have to time out "asay" rather than "admin say" to use it --NeoFite
	set hidden = 1
	...
	feedback_add_details("admin_verb","M") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_mod_say(msg as text)
	...
	feedback_add_details("admin_verb","MS") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
