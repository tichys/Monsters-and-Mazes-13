/client/proc/atmosscan()
	...
	if(!src.holder)
		...
		return
	feedback_add_details("admin_verb","CP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!

	if(alert("WARNING: This command should not be run on a live server. Do I want to continue?", "Check Piping", "No", "Yes") == "No")
		return
...
/client/proc/powerdebug()
	...
	if(!src.holder)
		to_chat(src, "Only administrators may use this command.")
		return
	feedback_add_details("admin_verb","CPOW") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
