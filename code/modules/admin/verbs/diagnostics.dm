...
/client/proc/fix_next_move()
	...
	feedback_add_details("admin_verb","UFE") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/radio_report()
	...
	feedback_add_details("admin_verb","RR") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/reload_admins()
	...
	load_admins()
	feedback_add_details("admin_verb","RLDA") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
