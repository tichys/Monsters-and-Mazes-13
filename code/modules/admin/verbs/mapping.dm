...
/client/proc/camera_view()
	...
	feedback_add_details("admin_verb","mCRD") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
<B>The following annomalities have been detected. The ones in red need immediate attention: Some of those in black may be intentional.</B><BR><ul>"}
	...
	feedback_add_details("admin_verb","mCRP") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		...
		for(var/obj/item/device/radio/intercom/I in world)
			for(var/turf/T in orange(7,I))
				...
				if (!(F in view(7,I.loc)))
					qdel(F)
	feedback_add_details("admin_verb","mIRD") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/enable_debug_verbs()
	...
	feedback_add_details("admin_verb","mDV") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/hide_debug_verbs()
	...
	feedback_add_details("admin_verb","hDV") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/testZAScolors()
	...
	if(!usedZAScolors)
		...
		to_chat(src, "Green = Zone I am standing in")
		to_chat(src, "Blue = Connected zone to the zone I am standing in")
		to_chat(src, "Yellow = A zone that is connected but not one adjacent to my connected zone")
...
/client/proc/count_objects_on_z_level()
	...
	feedback_add_details("admin_verb","mOBJZ") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/count_objects_all()
	...
	feedback_add_details("admin_verb","mOBJ") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
