...
/client/proc/ticklag()
	...
	set desc = "Sets a new tick lag. Recommend I don't mess with this too much! Stable, time-tested ticklag value is 0.9"
	...
	if(newtick && newtick <= 2 && newtick > 0)
		...
		feedback_add_details("admin_verb","TICKLAG") //If I am copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	else
