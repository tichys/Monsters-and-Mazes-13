...
/client/proc/view_var_Topic(href, href_list, hsrc)
	...
	//~CARN: for renaming mobs (updates their name, real_name, mind.name, their ID/PDA and datacore records).
		...
		var/new_name = sanitize(input(usr,"What would I like to name this mob?","Input a name",M.real_name) as text|null, MAX_NAME_LEN)
		...
		if(alert("Are I really sure I want to delete all objects of type [O.type]?",,"Yes","No") != "Yes")
			return
		...
		to_chat(H, "My NanoUI Resource files have been refreshed")
