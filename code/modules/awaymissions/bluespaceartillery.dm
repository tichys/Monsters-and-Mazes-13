...
/obj/machinery/artillerycontrol/attack_hand(mob/user as mob)
	...
	dat += "Deployment of weapon authorized by <br>[GLOB.using_map.company_name] Naval Command<br><br>Remember, friendly fire is grounds for termination of my contract and life.<HR>"
