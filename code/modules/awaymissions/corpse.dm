...
/obj/effect/landmark/corpse
	...
	var/skin_colors_per_species   = list() // Custom skin colors, per species -type-, if any. For example if I want dead Tajaran to always have brown fur, or similar
	...
	var/hair_styles_per_species   = list() // Custom hair styles, per species -type-, if any. For example if I want a punk gang with handlebars.
