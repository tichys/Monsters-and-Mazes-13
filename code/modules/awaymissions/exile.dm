//////Exile implants will allow I to use the station gate, but not return home. This will allow security to exile badguys/for badguys to exile their kill targets////////
...
/obj/item/weapon/implant/exile
	name = "exile"
	desc = "Prevents I from returning from away missions."
