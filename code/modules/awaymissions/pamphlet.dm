/obj/item/weapon/paper/pamphlet
	...
	info = "<b>Welcome to the Gateway project...</b><br>\
			Congratulations! If you're reading this, I and my superiors have decided that you're \
			ready to commit to a life spent colonising the rolling hills of far away worlds. I \
			...
			<br>Because we care about you, we feel it is only fair to make sure I know the risks \
			before I commit to joining the Gateway project. All away destinations have \
			...
			the Project's operational area and start my new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All approved Gateways operate on the same basic principals. They operate off \
			area equipment power as I would expect, but they also require a backup wire with at least \
			...
			interface will give me an estimate accurate to the minute. Power loss will not interrupt the \
			...
			Once I have traversed the Gateway, I may experience some disorientation. Do not panic. \
			This is a normal side effect of travelling vast distances in a short period of time. I should \
			survey the immediate area, and attempt to locate my complimentary case of space beer. Our \
			...
			Do not panic if I cannot locate the return Gateway. Begin colonisation of the destination. \
			<br><br><b>A New World</b><br>\
			As a participant in the Gateway Project, I will be on the frontiers of space. \
