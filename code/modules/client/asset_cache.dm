...
Make a datum at the bottom of this file with my assets for my thing.
The simple subsystem will most like be of use for most cases.
Then call get_asset_datum() with the type of the datum I created and store the return
Then call .send(client) on that stored return value.

I can set verify to TRUE if I want send() to sleep until the client has the assets.
*/
...
//This proc "registers" an asset, it adds it to the cache for further use, I cannot touch it from this point on or you'll fuck things up.
...
//If I don't need anything complicated.
/datum/asset/simple
	var/assets = list()
	var/verify = FALSE
