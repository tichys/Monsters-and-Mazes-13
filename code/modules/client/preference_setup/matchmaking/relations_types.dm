/datum/relation/friend
	name = "Friend"
	desc = "I have known the fellow for a while now, and I get along pretty well."
...
/datum/relation/kid_friend
	...
	desc = "I have known them since I were both young."
...
/datum/relation/enemy
	name = "Enemy"
	desc = "I have known the fellow for a while now, and I really can't stand each other."
...
/datum/relation/had_crossed
	name = "Crossed"
	desc = "I have slighted them in the past, and they most likely hold a grudge against you."
...
/datum/relation/was_crossed
	name = "Was Crossed"
	desc = "I have been slighted by them in the past, and I remember it."
...
/datum/relation/rival
	name = "Rival"
	desc = "I am engaged in a constant struggle to show who's number one."
...
/datum/relation/ex
	name = "Ex"
	desc = "I used to be romantically involved, but not anymore."
...
/datum/relation/spessnam
	...
	desc = "I have crossed paths while in active military service."
