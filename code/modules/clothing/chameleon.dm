...
/obj/item/clothing/head/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
...
/obj/item/clothing/suit/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
	update_icon()
...
/obj/item/clothing/shoes/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
...
/obj/item/weapon/storage/backpack/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
	item_state = initial(item_state)
...
/obj/item/clothing/gloves/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
	item_state = initial(item_state)
...
/obj/item/clothing/mask/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
	item_state = initial(item_state)
...
/obj/item/clothing/glasses/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case my cover's blown.
	SetName(initial(name))
	desc = initial(desc)
	icon_state = initial(icon_state)
	item_state = initial(item_state)
