...
/obj/item/clothing/attackby(var/obj/item/I, var/mob/user)
	if(istype(I, /obj/item/clothing/accessory))
		...
		if(!valid_accessory_slots || !valid_accessory_slots.len)
			to_chat(usr, "<span class='warning'>I cannot attach accessories of any kind to \the [src].</span>")
			return
		...
		if(can_attach_accessory(A))
			...
			to_chat(user, "<span class='warning'>I cannot attach more accessories of this type to [src].</span>")
		return
