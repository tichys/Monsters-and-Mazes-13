...
/obj/item/clothing/head/caphat/hop
	...
	desc = "A stylish hat that both protects I from enraged former-crewmembers and gives I a false sense of authority."
	icon_state = "hopcap"

//Chaplain
/obj/item/clothing/head/chaplain_hood
	name = "chaplain's hood"
	desc = "It's hood that covers the head. It keeps I warm during the space winters."
