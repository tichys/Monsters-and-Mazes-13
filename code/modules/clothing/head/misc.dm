...
/obj/item/clothing/head/cueball
	name = "cueball helmet"
	desc = "A large, featureless white orb mean to be worn on my head. How do I even see out of this thing?"
	icon_state = "cueball"
	item_state = "cueball"
	flags_inv = BLOCKHAIR
	body_parts_covered = HEAD|FACE|EYES
...
/obj/item/clothing/head/rabbitears
	name = "rabbit ears"
	desc = "Wearing these makes I looks useless, and only good for my sex appeal."
	icon_state = "bunny"
	body_parts_covered = 0
...
/obj/item/clothing/head/fez
	name = "fez"
	icon_state = "fez"
	desc = "I should wear a fez. Fezzes are cool."
...
/obj/item/clothing/head/philosopher_wig
	...
	desc = "A stylish monstrosity unearthed from Earth's Renaissance period. With this most distinguish'd wig, you'll be ready for my next soiree!"
...
/obj/item/clothing/head/cowboy_hat
	name = "cowboy hat"
	desc = "A wide-brimmed hat, in the prevalent style of America's frontier period. By SolGov law, I am required to wear this hat while watching True Grit."
