/obj/item/voice_changer
	name = "voice changer"
	desc = "A voice scrambling module. If I can see this, report it as a bug on the tracker."
...
/obj/item/clothing/mask/chameleon/voice/verb/Toggle_Voice_Changer()
	...
	to_chat(usr, "<span class='notice'>I [changer.active ? "enable" : "disable"] the voice-changing module in \the [src].</span>")
...
/obj/item/clothing/mask/chameleon/voice/verb/Set_Voice(name as text)
	...
	changer.voice = voice
	to_chat(usr, "<span class='notice'>I am now mimicking <B>[changer.voice]</B>.</span>")
