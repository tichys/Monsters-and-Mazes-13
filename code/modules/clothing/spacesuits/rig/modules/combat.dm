...
/obj/item/rig_module/device/flash
	...
	interface_desc = "Disorientates my target by blinding them with a bright light."
...
/obj/item/rig_module/grenade_launcher/accepts_item(var/obj/item/input_device, var/mob/living/user)
	...
	to_chat(user, "<font color='blue'><b>I slot \the [input_device] into the suit module.</b></font>")
	qdel(input_device)
...
/obj/item/rig_module/grenade_launcher/engage(atom/target)
	...
	if(!charge_selected)
		to_chat(H, "<span class='danger'>I have not selected a grenade type.</span>")
		return 0
...
/obj/item/rig_module/mounted/energy_blade/activate()
	...
	if(M.l_hand && M.r_hand)
		to_chat(M, "<span class='danger'>My hands are full.</span>")
		deactivate()
		return
...
/obj/item/rig_module/fabricator/engage(atom/target)
	...
	if(target)
		...
		if(H.l_hand && H.r_hand)
			to_chat(H, "<span class='danger'>My hands are full.</span>")
		else
			var/obj/item/new_weapon = new fabrication_type()
			new_weapon.forceMove(H)
			to_chat(H, "<font color='blue'><b>I quickly fabricate \a [new_weapon].</b></font>")
