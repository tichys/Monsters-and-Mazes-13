...
/obj/item/rig_module/vision/engage()
	...
	if(starting_up)
		to_chat(holder.wearer, "<font color='blue'>I activate my visual sensors.</font>")
		return 1
	...
	if(vision_modes.len > 1)
		...
		to_chat(holder.wearer, "<font color='blue'>I cycle my sensors to <b>[vision.mode]</b> mode.</font>")
	else
		to_chat(holder.wearer, "<font color='blue'>My sensors only have one mode.</font>")
	return 1
