...
/obj/item/weapon/rig/verb/toggle_vision()
	...
	set desc = "Turns my rig visor off or on."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/proc/toggle_helmet()
	...
	set desc = "Deploys or retracts my helmet."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/proc/toggle_chest()
	...
	set desc = "Deploys or retracts my chestpiece."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/proc/toggle_gauntlets()
	...
	set desc = "Deploys or retracts my gauntlets."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/proc/toggle_boots()
	...
	set desc = "Deploys or retracts my boots."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/verb/toggle_seals_verb()
	...
	set desc = "Activates or deactivates my rig."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/verb/alter_voice()
	...
	set desc = "Toggles or configures my voice synthesizer."
	set category = "Hardsuit"
	set src = usr.contents
...
/obj/item/weapon/rig/verb/select_module()
	...
	set desc = "Selects a module as my primary system."
	set category = "Hardsuit"
	set src = usr.contents
	...
	var/obj/item/rig_module/module = input("Which module do I wish to select?") as null|anything in selectable
...
/obj/item/weapon/rig/verb/toggle_module()
	...
	var/obj/item/rig_module/module = input("Which module do I wish to toggle?") as null|anything in selectable

	if(!istype(module))
		return

	if(module.active)
		to_chat(usr, "<font color='blue'><b>I attempt to deactivate \the [module.interface_name].</b></font>")
		module.deactivate()
	else
		to_chat(usr, "<font color='blue'><b>I attempt to activate \the [module.interface_name].</b></font>")
		module.activate()
...
/obj/item/weapon/rig/verb/engage_module()
	...
	var/obj/item/rig_module/module = input("Which module do I wish to engage?") as null|anything in selectable

	if(!istype(module))
		return

	to_chat(usr, "<font color='blue'><b>I attempt to engage the [module.interface_name].</b></font>")
	module.engage()