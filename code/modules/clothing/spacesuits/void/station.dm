...
/obj/item/clothing/suit/space/void/exploration
	...
	armor = list(melee = 20, bullet = 10, laser = 15,energy = 45, bomb = 30, bio = 100, rad = 90)
	allowed = list(/obj/item/device/flashlight,/obj/item/weapon/tank,/obj/item/device/suit_cooling_unit,/obj/item/device/healthanalyzer,/obj/item/weapon/material/hatchet/machete,/obj/item/weapon/shovel)
