...
/obj/item/clothing/suit/imperium_monk
	name = "Imperium monk"
	desc = "Have I killed a xenos today?"
...
/obj/item/clothing/suit/ianshirt
	name = "worn shirt"
	desc = "A worn out, curiously comfortable t-shirt with a picture of Ian. I wouldn't go so far as to say it feels like being hugged when I wear it, but it's pretty close. Good for sleeping in."
	icon_state = "ianshirt"
	item_state = "ianshirt"
	body_parts_covered = UPPER_TORSO|ARMS
