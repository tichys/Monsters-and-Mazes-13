...
/obj/item/clothing/accessory/sweater
	...
	desc = "A stylish sweater to keep I warm on those cold days."
	icon_state = "sweater"
...
/obj/item/clothing/accessory/toggleable/proc/do_toggle(user)
	if(icon_state == icon_closed)
		...
		to_chat(usr, "I unbutton [src].")
	else
		icon_state = icon_closed
		to_chat(usr, "I button up [src].")
...
/obj/item/clothing/accessory/toggleable/hawaii
	...
	desc = "I probably need some welder googles to look at this."
	icon_state = "hawaii"
...
/obj/item/clothing/accessory/toggleable/flannel/verb/roll_up_sleeves()
	...
	if(H.rolled == 0)
		H.rolled = 1
		to_chat(usr, "I roll up the sleeves of my [H].")
	else
		H.rolled = 0
		to_chat(usr, "I roll down the sleeves of my [H].")
	H.update_icon()
...
/obj/item/clothing/accessory/toggleable/flannel/verb/tuck()
	...
	if(H.tucked == 0)
		H.tucked = 1
		to_chat(usr, "I tuck in my [H].")
	else
		H.tucked = 0
		to_chat(usr, "I untuck my [H].")
	H.update_icon()
	update_clothing_icon()
