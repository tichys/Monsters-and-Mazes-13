/obj/item/clothing/accessory/storage
	...
	desc = "Used to hold things when I don't have enough hands."
	icon_state = "webbing"
...
/obj/item/clothing/accessory/storage/black_vest
	...
	desc = "Robust black synthcotton vest with lots of pockets to hold whatever I need, but cannot hold in hands."
...
/obj/item/clothing/accessory/storage/drop_pouches/black
	...
	desc = "Robust black synthcotton bags to hold whatever I need, but cannot hold in hands."
	icon_state = "thigh_black"

/obj/item/clothing/accessory/storage/drop_pouches/brown
	name = "brown drop pouches"
	desc = "Worn brownish synthcotton bags to hold whatever I need, but cannot hold in hands."
	icon_state = "thigh_brown"

/obj/item/clothing/accessory/storage/drop_pouches/white
	name = "white drop pouches"
	desc = "Durable white synthcotton bags to hold whatever I need, but cannot hold in hands."
...
/obj/item/clothing/accessory/storage/knifeharness/Initialize()
	...
	new /obj/item/weapon/material/kitchen/utensil/knife/survival(hold)
	new /obj/item/weapon/material/kitchen/utensil/knife/survival(hold)
