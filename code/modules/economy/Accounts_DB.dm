...
/obj/machinery/computer/account_database/Topic(href, href_list)
	...
	if(href_list["choice"])
		switch(href_list["choice"])
			...
			if("add_funds")
				var/amount = input("Enter the amount I wish to add", "Silently add funds") as num
				if(detailed_account_view)
					detailed_account_view.money = min(detailed_account_view.money + amount, fund_cap)

			if("remove_funds")
				var/amount = input("Enter the amount I wish to remove", "Silently remove funds") as num
				if(detailed_account_view)
