...
/datum/event/mundane_news/announce()
	...
	if(!body)
		...
		switch(event_type)
			...
			if(BARGAINS)
				body += "BARGAINS! BARGAINS! BARGAINS! Commerce Control on [affected_dest.name] wants I to know that everything must go! Across all retail centres, \
...
/datum/event/trivial_news/announce()
	...
	"[pick("Spacer")] gets tattoo of Nyx on chest '[pick("[GLOB.using_map.boss_short]","star","starship","asteroid")] tickles most'.",\
	"Peasant marries computer; wedding attended by 100 modems.",\
	...
	"Imperial Scientist Discovers Abacus Can Be Used To Dry Towels",\
	...
	"From The Desk Of Wise Guy Sammy: I Don't Have To Fool All The People, Just The Right Ones",\
	"From The Desk Of Wise Guy Sammy: If I Made The Mess, I Clean It Up",\
	"From The Desk Of Wise Guy Sammy: It Is Easier To Get Forgiveness Than Permission",\
	"From The Desk Of Wise Guy Sammy: Check My Facts Before Making A Fool Of Myself",\
	"From The Desk Of Wise Guy Sammy: I Can't Outwait A Bureaucracy",\
	...
	"Tommy B. Saif Sez: If I Break It, I Buy It",\
