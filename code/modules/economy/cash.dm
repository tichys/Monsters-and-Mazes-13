...
/obj/item/weapon/spacecash/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/spacecash))
		...
		to_chat(user, "<span class='notice'>I add [src.worth] Thalers worth of money to the bundles.<br>It holds [bundle.worth] Thalers now.</span>")
		qdel(src)
...
/obj/item/weapon/spacecash/bundle/attack_self()
	var/amount = input(usr, "How many Thalers do I want to take? (0 to [src.worth])", "Take Money", 20) as num
