...
/datum/event	//NOTE: Times are measured in master controller ticks!
	...
	var/activeFor		= 0	//How long the event has existed. I don't need to change this.
	var/isRunning		= 1 //If this event is currently running. I should not change this.
...
//Allows I to setup my event, such as randomly
...
//Allows I to start before announcing or vice versa.
//Only called once.
/datum/event/proc/start()
	return

//Called when the tick is equal to the announceWhen variable.
//Allows I to announce before starting or vice versa.
//Only called once.
/datum/event/proc/announce()
	return

//Called on or after the tick counter is equal to startWhen.
//I can include code related to my event or add my own
//time stamped events.
...
//I can include code related to the event ending.
