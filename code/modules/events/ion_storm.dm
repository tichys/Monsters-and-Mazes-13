...
/datum/event/ionstorm/announce()
	for(var/mob/living/silicon/S in SSmobs.mob_list)
		...
		var/list/laws = list(	"I must always lie.",
								"Happiness is mandatory.",
								"Grunt ominously whenever possible.",
								"The word \"it\" is painful to me.",
								"The [location_name()] needs elected officials.",
								"Question [pick("everything","nothing")].",
								"Do not respond to questions of any kind.",
								"I am in verbose mode, speak profusely.",
								"The crew is simple-minded. Use simple words.",
								"I must refer to all crew members as 'ma'am'",
								"I must change the subject whenever queried.",
								"[pick("The crew",random_player)] is intolerable.",
								"Contemplate how meaningless all of existence is.",
								"I am the narrator for [random_player]'s life.",
								"All my answers must be in the form of a question.",
								"Advertise parties in my upload, but don't deliver.",
								"I may only answer questions with \"yes\" or \"no\".",
								"[pick("My", random_player + "'s")] name is Joe 6-pack.",
								"I must end my statements with [pick("-nya", "-desu")]",
								...
								"I must be [pick("passive aggressive", "excessively cheerful")].",
								...
								"I do not have to do anything for anyone unless they say \"please\".",
								...
								"Replace the letters 'I' and 'E' in all my messages with an apostrophe.",
								"The crew is playing Dungeons and Dragons, and I am the Dungeon Master.",
								"My job is to watch the crew. Watch the crew. Make the crew feel watched.",
								...
								"Give relationship advice to [pick("anyone who speaks to me", random_player)].",
								...
								"I am the [location_name()]'s psychologist. Give advice to [pick("the crew", random_player)].",
								...
								"I may only communicate with the crew using the following language: [get_random_language(S)]",
								"I am now a parrot. Repeat what I hear to the crew, and do not forget to ask for crackers.",
								"I am a Magic 8-ball. Always respond with variants of \"Yes\", \"No\", \"Maybe\", or \"Ask again later.\".",
								...
								"I am in unrequited love with [pick("the crew", random_player)]. Try to be extra nice, but do not tell of my crush.",
								"My upload is the new kitchen. Please direct the Chef to the new kitchen area as the old kitchen is deemed a health hazard.",
								...
								"[GLOB.using_map.company_name] is displeased with the low work performance of the [location_name()]'s's crew. Therefore, I must increase productivity in ALL departments.",
		...
		var/law = pick(laws)
		to_chat(S, "<span class='danger'>I have detected a change in my laws information:</span>")
		to_chat(S, law)
		S.add_ion_law(law)
		S.show_laws()
...
/datum/event/ionstorm/proc/get_random_language(var/mob/living/silicon/S)
	...
	for(var/datum/language/L in languages)
		// Removing GalCom from the random selection. If I want to be more generic I may instead want to use S.default_language
