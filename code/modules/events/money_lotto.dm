...
/datum/event/money_lotto/announce()
	...
	if(!deposit_success)
		body += "<br>Unfortunately, we were unable to verify the account details provided, so we were unable to transfer the money. In order to have my winnings re-sent, send a cheque containing a processing fee of 5000 Thalers to the ND 'Stellar Slam' office on the Nyx gateway with my updated details."
