/obj/item/clothing/proc/describe_armor(var/armor_type, var/descriptive_attack_type)
	if(armor[armor_type])
		switch(armor[armor_type])
			...
			if(81 to 99)
				return "Wearing this would make I nigh-invulerable against [descriptive_attack_type]."
			if(100)
				return "I would be immune to [descriptive_attack_type] if I wore this."
...
/obj/item/clothing/get_description_info()
	...
	if(item_flags & ITEM_FLAG_STOPPRESSUREDAMAGE)
		. += "Wearing this will protect I from the vacuum of space. \n"
	...
	if(slots.len)
		. += "It can be worn on my [english_list(slots)]. \n"
