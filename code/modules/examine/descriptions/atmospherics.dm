...
/obj/machinery/atmospherics/pipe/simple/visible/scrubbers
	description_info = "This is a special 'scrubber' pipe, which does not connect to 'normal' pipes.  If I want to connect it, use \
	a Universal Adapter pipe."

/obj/machinery/atmospherics/pipe/simple/visible/supply
	description_info = "This is a special 'supply' pipe, which does not connect to 'normal' pipes.  If I want to connect it, use \
	a Universal Adapter pipe."
...
/obj/machinery/atmospherics/pipe/simple/visible/universal
	description_info = "This allows me to connect 'normal' pipes, red 'scrubber' pipes, and blue 'supply' pipes."
...
/obj/machinery/portable_atmospherics/canister
	description_info = "The canister can be connected to a connector port with a wrench.  Tanks of gas (the kind I can hold in my hand) \
	...
	*DO NOT* remove the tank until the valve is closed.  A gas analyzer can be used to check the contents of the canister."
	...
	description_antag = "Canisters can be damaged, spilling their contents into the air, or I can just leave the release valve open."
...
/obj/machinery/pipedispenser
	description_info = "This can be moved by using a wrench.  I will need to wrench it again when I want to use it.  I can put \
