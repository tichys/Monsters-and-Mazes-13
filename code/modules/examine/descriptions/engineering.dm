/obj/machinery/power/supermatter
	...
	<br>\
	Supermatter cores are extremely dangerous to be close to, and requires protection to handle properly.  The protection I will need is:<br>\
	Optical meson scanners on my eyes, to prevent hallucinations when looking at the supermatter.<br>\
	Radiation helmet and suit, as the supermatter is radioactive.<br>\
	<br>\
	Touching the supermatter will result in *instant death*, with no corpse left behind!  I can drag the supermatter, but anything else will kill you. \
	...
	Wearing radiation equipment will protect I from most of the delamination effects sans explosion."
...
/obj/item/inflatable
	description_info = "Inflate by using it in my hand.  The inflatable barrier will inflate on my tile.  To deflate it, use the 'deflate' verb."
