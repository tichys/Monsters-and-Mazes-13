/obj/machinery/bodyscanner
	...
	This is useful if I am about to perform surgery.<br>\
	<br>\
	Click my target with Grab intent, then click on the scanner to place them in it. Click the red terminal to operate. \
	Right-click the scanner and click 'Eject Occupant' to remove them.  I can enter the scanner myself in a similar way, using the 'Enter Body Scanner' \
	verb."
...
/obj/machinery/atmospherics/unary/cryo_cell
	...
	<br>\
	Click my target with Grab intent, then click on the tube, with an empty hand, to place them in it. Click the tube again to open the menu. \
...
/obj/machinery/optable
	description_info = "Click my target with Grab intent, then click on the table with an empty hand, to place them on it."
...
/obj/machinery/sleeper
	description_info = "The sleeper allows me to clean the blood by means of dialysis, and to administer medication in a controlled environment.<br>\
	<br>\
	Click my target with Grab intent, then click on the sleeper to place them in it. Click the green console, with an empty hand, to open the menu. \
	...
	<br>\
	I can also inject common medicines directly into their bloodstream.\
	<br>\
	Right-click the cell and click 'Eject Occupant' to remove them.  I can enter the cell myself by right clicking and selecting 'Enter Sleeper'. \
	Note that I cannot control the sleeper while inside of it."
...
/obj/item/bodybag/cryobag
	...
	the bag will protect the occupant from most outside enviromental hazards.  If I open a bag by mistake, closing the bag with no \
	occupant will not use up the bag, and I can pick it back up.<br>\
	<br>\
	I can use a health analyzer to scan the occupant's vitals without opening the bag by clicking the occupied bag with the analyzer."
