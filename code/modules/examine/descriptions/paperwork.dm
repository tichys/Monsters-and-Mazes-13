/obj/item/weapon/pen
	description_info = {"This is an item for writing down my thoughts, on paper or elsewhere. The following special commands are available:
...
\[sign\] : Inserts a signature of my name in a foolproof way.
\[field\] : Inserts an invisible field which lets I start type from there. Useful for forms.
