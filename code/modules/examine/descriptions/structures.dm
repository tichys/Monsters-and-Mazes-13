/obj/structure/girder
	...
	I can dismantle the grider with a wrench."
...
/obj/structure/bed
	description_info = "Click and drag myself (or anyone) to this to buckle in. Click on this with an empty hand to undo the buckles.<br>\
	<br>\
