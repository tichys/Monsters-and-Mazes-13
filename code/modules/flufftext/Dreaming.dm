...
var/list/dreams = list(
	...
	"a tajaran","the ai core","a beaker of strange liquid","the supermatter", "a creature built completely of stolen flesh",
	"a GAS", "a IPC", "a Dionaea", "a being made of light", "the Commander-In-Chief", "the Chancellor", "the chief of security", "the corporate liason",
