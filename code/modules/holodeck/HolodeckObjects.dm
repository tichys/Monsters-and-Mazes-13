...
/obj/item/clothing/gloves/boxing/hologlove
	name = "boxing gloves"
	desc = "Because I really needed another excuse to punch my crewmates."
	icon_state = "boxing"
	item_state = "boxing"
...
/obj/structure/window/reinforced/holowindow/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W, /obj/item/weapon/screwdriver))
		to_chat(user, ("<span class='notice'>It's a holowindow, I can't unfasten it!</span>"))
	else if(istype(W, /obj/item/weapon/crowbar) && reinf && state <= 1)
		to_chat(user, ("<span class='notice'>It's a holowindow, I can't pry it!</span>"))
	else if(istype(W, /obj/item/weapon/wrench) && !anchored && (!state || !reinf))
		to_chat(user, ("<span class='notice'>It's a holowindow, I can't dismantle it!</span>"))
	else
...
/obj/structure/bed/chair/holochair/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/wrench))
		to_chat(user, ("<span class='notice'>It's a holochair, I can't dismantle it!</span>"))
	return
...
/obj/item/weapon/beach_ball/holovolleyball
	...
	desc = "I can be my wingman anytime."
	w_class = ITEM_SIZE_LARGE //Stops people from hiding it in their pockets

/obj/structure/holonet
	name = "net"
	desc = "Bullshit, I can be mine!"
	icon = 'icons/obj/basketball.dmi'
...
/obj/machinery/readybutton/attackby(obj/item/weapon/W as obj, mob/user as mob)
	to_chat(user, "The device is a solid button, there's nothing I can do with it!")
...
/mob/living/simple_animal/hostile/carp/holodeck/death()
	..(null, "fades away!", "I have been destroyed.")
	qdel(src)