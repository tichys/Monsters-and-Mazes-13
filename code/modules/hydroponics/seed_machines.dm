...
/obj/item/weapon/disk/botany/attack_self(var/mob/user as mob)
	if(genes.len)
		var/choice = alert(user, "Are I sure I want to wipe the disk?", "Xenobotany Data", "No", "Yes")
...
/obj/machinery/botany/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if(isScrewdriver(W))
		open = !open
		to_chat(user, "<span class='notice'>I [open ? "open" : "close"] the maintenance panel.</span>")
		return
