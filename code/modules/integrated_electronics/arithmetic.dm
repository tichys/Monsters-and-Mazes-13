...
/obj/item/integrated_circuit/arithmetic/absolute
	...
	desc = "This outputs a non-negative version of the number I put in.  This may also be thought of as its distance from zero."
	icon_state = "absolute"
	inputs = list("A")
...
/obj/item/integrated_circuit/arithmetic/average
	...
	desc = "This circuit is of average quality, however it will compute the average for numbers I give it."
	icon_state = "average"
