...
/obj/item/integrated_circuit/filter/ref/custom
	...
	description_info = "Application is done by click-drag-dropping the circuit unto an adjacent object that I wish to scan."
	complexity = 25
	size = 3
...
/obj/item/integrated_circuit/filter/ref/custom/MouseDrop(var/atom/over_object)
	...
	to_chat(usr, "<span class='notice'>I change the filtering parameter of \the [src] to objects similar to \the [over_object].</span>")
	return 1
