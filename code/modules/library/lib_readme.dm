...
/*
   ...
   Feel free to use this as I like. Some credit would be cool.
...
//  - Allow books to be "hollowed out" like the Chaplain's Bible, allowing I to store one pocket-sized item inside.
