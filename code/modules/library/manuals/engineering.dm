...
/obj/item/weapon/book/manual/robotics_cyborgs
	...
	dat = {"<html>
				...
				The service cyborg module comes ready to serve my human needs. It includes various entertainment and refreshment devices. Occasionally some service cyborgs may have been referred to as "Bros."<br>A Service Cyborg comes with:
				<ul>
				...
				Once I have acquired the materials, I can start on construction of my cyborg.<br>To construct a cyborg, follow the steps below:
				<ol>
				  <li>Start the Exosuit Fabricators constructing all of the cyborg parts</li>
				  <li>While the parts are being constructed, take my human brain, and place it inside the Man-Machine Interface</li>
				  <li>Once I have a Robot Head, place my two flashes inside the eye sockets</li>
				  <li>Once I have my Robot Chest, wire the Robot chest, then insert the power cell</li>
				  ...
				  <li>Congratulations! I have a new cyborg!</li>
				</ol>
				...
				<ol>
				  <li>Unlock the Cyborg's Interface by swiping my ID on it</li>
				  ...
				  <li>Lock the Cyborg's Interface by swiping my ID on it, this will prevent non-qualified personnel from attempting to remove the power cell</li>
				</ol>

				<h3>Exposing the Internal Wiring</h3>
				Exposing the internal wiring of a cyborg is fairly easy to do, and is mainly used for cyborg repairs.<br>I can easily expose the internal wiring by following the steps below:
				<ol>
				...
				Dents in a cyborg's frame are rather easy to repair, all I need is to apply a welding tool to the dented area, and the high-tech cyborg frame will repair the dent under the heat of the welder.

				<h3>Excessive Heat Damage</h3>
				If a cyborg becomes damaged due to excessive heat, it is likely that the internal wires will have been damaged. I must replace those wires to ensure that the cyborg remains functioning properly.<br>To replace the internal wiring follow the steps below:
				<ol>
					<li>Unlock the Cyborg's Interface by swiping my ID</li>
					...
					<li>Lock the Cyborg's Interface by swiping my ID</li>
				</ol>
				These repair tasks may seem difficult, but are essential to keep my cyborgs running at peak efficiency.

				<h2><a name="Emergency">In Case of Emergency</h2>
				In case of emergency, there are a few steps I can take.
				...
				If all else fails in a case of cyborg-related emergency, there may be only one option. Using a Robotics Control console, I may have to remotely detonate the cyborg.
				<h3>WARNING:</h3> Do not detonate a borg without an explicit reason for doing so. Cyborgs are expensive pieces of company equipment, and I may be punished for detonating them without reason.
...
/obj/item/weapon/book/manual/engineering_particle_accelerator/New()
	...
	dat = {"<html>
				...
				<ol>
					...
					<li>Close all the panels with my <b>screwdriver</b></li>
				</ol>
				...
				<ol>
					...
					<li>Remember to wear a radiation suit when working with this machine... we did tell I that at the start, right?</li>
				</ol>
...
/obj/item/weapon/book/manual/rust_engine/New()
	...
	dat = {"<html>
				...
				<body>
				So you're the poor fucker who has to try and set this piece of shit up this shift. Congratulations! Here's what I need to know: this is a tokamak fusion reactor that uses a high energy plasma stream in a magnetic field enclosure to achieve fusion. It gets extremely hot extremely quickly, and the field is tempramental. The main principle of operation: maximize plasma temperature while minimizing field instability.
				<br><br>
				Deuterium and tritium are generally the most available fuel for the beast. If you're cautious, deut-deut reactions are capable of producing power without being unstable. Deut-trit is the bread and butter of the R-UST. I can keep field instability down by using the gyrotron near the core and not sticking my dick into the fusion torus.
				<br><br>
				...
				<br><br>
				The more fuel in the field, the more fuel will react. Obvious, right? Don't load the field up with the ingredients for an unstable reaction (tritium and deuterium) before it has reached the point of fusion, or I will be trying to deal with a massive instability burst all at once.
				<br><br>
				...
				<li>Open the main core chamber to vaccuum if I can.</li>
...
/obj/item/weapon/book/manual/engineering_singularity_safety
	...
	dat = {"<html>
				...
				A power problem has made I lose power? Could be wiring problems or syndicate power sinks. In any case follow these steps:

				<ol>
					<li><b><font color='red'>PANIC!</font></b></li>
					<li>Get my ass over to engineering! <b>QUICKLY!!!</b></li>
					<li>Get to the <b>Area Power Controller</b> which controls the power to the emitters.</li>
					<li>Swipe it with my <b>ID card</b> - if it doesn't unlock, continue with step 15.</li>
					...
					<li>Put in the new, <b>full power cell</b> - if I don't have one, continue with step 15.</li>
					...
					<li>Since disaster was averted I now have to ensure it doesn't repeat. If it was a powersink which caused it and if the engineering APC is wired to the same powernet, which the powersink is on, I have to remove the piece of wire which links the APC to the powernet. If it wasn't a powersink which caused it, then skip to step 14.</li>
					<li>Grab my crowbar and pry away the tile closest to the APC.</li>
					<li>Use the wirecutters to cut the wire which is connecting the grid to the terminal. </li>
					<li>Go to the bar and tell the guys how I saved them all. Stop reading this guide here.</li>
...
/obj/item/weapon/book/manual/atmospipes
	name = "Pipes and You: Getting To Know My Scary Tools"
	icon_state = "pipingbook"
	author = "Maria Crash, Senior Atmospherics Technician"
	title = "Pipes and You: Getting To Know My Scary Tools"
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
				...
				this will tell I what every device constructable by an ordinary pipe dispenser within atmospherics actually does.
				I am not going to learn what to do with them to be the super best person ever, or how to play guitar with passive gates,
				...
				That's about it. Even so, here's all of my wonderful pipe options.<BR>
				...
				<li><b>Pipe manifolds:</b> Pipes that are essentially a "T" shape, allowing I to connect three things at one point.</li>
				<li><b>4-way manifold:</b> A four-way junction.</li>
				<li><b>Pipe cap:</b> Caps off the end of a pipe. Open ends don't actually vent air, because of the way the pipes are assembled, so, uh, use them to decorate my house or something.</li>
				...
				An important note here is that pipes are now done in three distinct lines - general, supply, and scrubber. I can move gases between these with a universal adapter. Use the correct position for the correct location.
				Connecting scrubbers to a supply position pipe makes I an idiot who gives everyone a difficult job. Insulated and HE pipes don't go through these positions.
				...
				<li><I>Pipe manifolds:</I> Pipes that are essentially a "T" shape, allowing I to connect three things at one point.</li>
				<li><I>4-way manifold:</I> A four-way junction.</li>
				<li><I>Pipe cap:</I> Caps off the end of a pipe. Open ends don't actually vent air, because of the way the pipes are assembled, so, uh. Use them to decorate my house or something.</li>
				...
				This is usually where people get frightened, afraid, and start calling on their gods and/or cowering in fear. Yes, I can see I doing that right now.
				...
				I will make engiborgs cry and the Chief Engineer will beat you.</li>
				<li><b>Pressure regulator:</b> These replaced the old passive gates. I can choose to regulate pressure by input or output, and regulate flow rate. Regulating by input means that when input pressure is above the limit, gas will flow.
				...
				<li><b>Meter:</b> A little box with some gauges and numbers. Fasten it to any pipe or manifold and it'll read I the pressure in it. Very useful.</li>
				...
				Output is controlled by flow rate. There is also an "omni" variant that allows me to set input and output sections freely..</li>
				...
				the rest will continue out the other side. Can also output from 0-4500 kPa. The "omni" vairant allows me to set input and output sections freely.</li>
				</ul>

				<h1><a name="HES"><B>Heat Exchange Systems</B></a></h1>
				<I>Will not set I on fire.</I><BR>
				...
				<li><I>Junction:</I> The point where I connect my normal pipes to heat exchange pipes. Not necessary for heat exchangers, but necessary for H/E pipes/bent pipes.</li>
				<li><I>Heat exchanger:</I> These funky-looking bits attach to an open pipe end. Put another heat exchanger directly across from it, and I can transfer heat across two pipes without having to have the gases touch.
...
/obj/item/weapon/book/manual/evaguide
	...
	dat = {"<html>
				...
				<I>Or: How not to suffocate because there's a hole in my shoes</I><BR>
				...
				but apparently there are some people out in space who don't. This guide should give me a basic idea of how to use this gear, safely. It's split into two sections:
				...
				First, take the suit. It should be in three pieces: A top, a bottom, and a helmet. Put the bottom on first, shoes and the like will fit in it. If I have magnetic boots, however,
				put them on on top of the suit's feet. Next, get the top on, as I would a shirt. It can be somewhat awkward putting these pieces on, due to the makeup of the suit,
				but to an extent they will adjust to me. I can then find the snaps and seals around the waist, where the two pieces meet. Fasten these, and double-check their tightness.
				...
				but it is recommended to have a full-sized tank on my back for EVA.<BR><BR>
				...
				The tanks that fasten onto the side slot are emergency tanks, as well as full-sized oxygen tanks, leaving my back free for a backpack or satchel.<BR><BR>
				...
				The largest uses of them are for their cleaning functions and their ability to tailor suits for a species. Do not enter them physically. I will die from any of the functions being activated, and it will be painful.
				These machines can both tailor a suit between species, and between types. This means I can convert engineering hardsuits to atmospherics, or the other way. This is useful. Use it if I can.<BR><BR>

				There's also modification kits that let I modify suits myself. These are extremely difficult to use unless I understand the actual construction of the suit. I do not reccomend using them unless no other option is available.

				<h2><a name="Final">Final Checks</a></h2>
				<ul>
					<li>Are all seals fastened correctly?</li>
					<li>If I have modified it manually, is absolutely everything sealed perfectly?</li>
					<li>Do I either have shoes on under the suit, or magnetic boots on over it?</li>
					<li>Do I have a mask on and internals on the suit or my back?</li>
					<li>Do I have a way to communicate with my fellow crew in case something goes wrong?</li>
					<li>Do I have a second person watching if this is a training session?</li><BR>
				</ul>

				If I don't have any further issues, go out and do whatever is necessary.
