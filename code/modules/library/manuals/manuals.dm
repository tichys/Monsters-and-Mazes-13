/obj/item/weapon/book/manual/chef_recipes
	...
	dat = {"<html>
				...
				Here is a guide on basic food recipes and also how to not poison my customers accidentally.
...
/obj/item/weapon/book/manual/detective
	...
	dat = {"<html>
				...
				Between my bouts of self-narration and drinking whiskey on the rocks, I might get a case or two to solve.<br>
				To have the best chance to solve my case, follow these directions:
				<p>
				<ol>
					<li>Go to the crime scene. </li>
					<li>Take my scanner and scan EVERYTHING (Yes, the doors, the tables, even the dog). </li>
					<li>Once I am reasonably certain I have every scrap of evidence I can use, find all possible entry points and scan them, too. </li>
					<li>Return to my office. </li>
					<li>Using my forensic scanning computer, scan my scanner to upload all of my evidence into the database.</li>
					...
					<li>If I have 80% or more of the print (The print is displayed), go to step 10, otherwise continue to step 8.</li>
					<li>Look for clues from the suit fibres I found on my perpetrator, and go about looking for more evidence with this new information, scanning as I go. </li>
					<li>Try to get a fingerprint card of my perpetrator, as if used in the computer, the prints will be completed on their dossier.</li>
					<li>Assuming I have enough of a print to see it, grab the biggest complete piece of the print and search the security records for it. </li>
					<li>Since I now have both my dossier and the name of the person, print both out as evidence and get security to nab my baddie.</li>
					<li>Give myself a pat on the back and a bottle of the ship's finest vodka, I did it!</li>
				</ol>
				<p>
...
/obj/item/weapon/book/manual/nuclear
	...
	dat = {"<html>
				...
				Hello and thank I for choosing the Syndicate for my nuclear information needs. Today's crash course will deal with the operation of a Nuclear Fission Device.<br><br>
				...
				<ul>
					...
					<b>Note</b>: If I make a mistake, press R to reset the device.
					<li>Press the E button to log on to the device.</li>
				</ul><br>

				I now have activated the device. To deactivate the buttons at anytime, for example when you've already prepped the bomb for detonation, remove the authentication disk OR press R on the keypad.<br><br>
				Now the bomb CAN ONLY be detonated using the timer. Manual detonation is not an option. Toggle off the SAFETY.<br>
				<b>Note</b>: I wouldn't believe how many Syndicate Operatives with doctorates have forgotten this step.<br><br>
				...
				Now before I remove the disk, if I need to move the bomb, I can toggle off the anchor, move it, and re-anchor.<br><br>
