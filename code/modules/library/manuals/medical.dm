/obj/item/weapon/book/manual/medical_cloning
	...
	dat = {"<html>
				...
				So there are 50 dead people lying on the floor, chairs are spinning like no tomorrow and I haven't the foggiest idea of what to do? Not to worry!
				This guide is intended to teach I how to clone people and how to do it right, in a simple, step-by-step process! If at any point of the guide I have a mental meltdown,
				genetics probably isn't for I and I should get a job-change as soon as possible before you're sued for malpractice.
				...
				This is pretty much vital for the process because without a body, I cannot clone it. Usually, bodies will be brought to me, so I do not need to worry so much about this step. If I already have a body, great! Move on to the next step.

				<a name='2'><H3>Step 2: Strip body</H3>
				The cloning machine does not like abiotic items. What this means is I can't clone anyone if they're wearing clothes or holding things, so take all of it off. If it's just one person, it's courteous to put their possessions in the closet.
				If I have about seven people awaiting cloning, just leave the piles where they are, but don't mix them around and for God's sake don't let people in to steal them.

				<a name='3'><h3>Step 3: Put body in cloning machine</h3>
				Grab the body and then put it inside the DNA modifier. If I cannot do this, then I messed up at Step 2. Go back and check I took EVERYTHING off - a commonly missed item is their headset.
				...
				Still no success? Skip over to Step 7 and don't continue after it, as I have an unresponsive body and it cannot be cloned.
				If I got "Error: Unable to locate valid genetic data.", I am trying to clone a monkey - start over.

				<a name='5'><h3>Step 5: Clone body</h3>
				Now that the body has a record, click 'View Records,' click the subject's name, and then click 'Clone' to start the cloning process. Congratulations! I'm halfway there.
				...
				For this reason, I need to prepare a clean, defect-free Structural Enzyme (SE) injection for when they're done. If you're a competent Geneticist, I will already have one ready on my working computer.
				If, for any reason, I do not, then eject the body from the DNA modifier (NOT THE CLONING POD) and take it next door to the Genetics research room. Put the body in one of those DNA modifiers and then go onto the console.
				Go into View/Edit/Transfer Buffer, find an open slot and click "SE" to save it. Then click 'Injector' to get the SEs in syringe form. Put this in my pocket or something for when the body is done.

				<a name='7'><h3>Step 7: Put body in morgue</h3>
				Now that the cloning process has been initiated and I have some clean Structural Enzymes, I no longer need the body! Drag it to the morgue and tell the Chef over the radio that they have some fresh meat waiting for them in there.
				...
				Now go back to the lab and wait for my patient to be cloned. It won't be long now, I promise.

				<a name='9'><h3>Step 9: Cryo and clean SE injector on person</h3>
				Has my body been cloned yet? Great! As soon as the guy pops out, grab them and stick them in cryo. Clonexadone and Cryoxadone help rebuild their genetic material. Then grab my clean SE injector and jab it in them. Once you've injected them,
				...
				Obviously the person will be naked after they have been cloned. Provided I weren't an irresponsible little shit, I should have protected their possessions from thieves and should be able to give them back to the patient.
				No matter how cruel I am, it's simply against protocol to force my patients to walk outside naked.

				<a name='11'><h3>Step 11: Send person on their way</h3>
				Give the patient one last check-over - make sure they don't still have any defects and that they have all their possessions. Ask them how they died, if they know, so that I can report any foul play over the radio.
				Once you're done, my patient is ready to go back to work! Chances are they do not have Medbay access, so I should let them out of Genetics and the Medbay main entrance.

				<p>If you've gotten this far, congratulations! I have mastered the art of cloning. Now, the real problem is how to resurrect myself after that traitor had his way with I for cloning his target.
