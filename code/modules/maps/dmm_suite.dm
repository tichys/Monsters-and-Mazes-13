...
dmm_suite{
	/*
		...
		that if I wish to load a map onto a z-level that already has objects on it,
		I will have to handle the removal of those objects. Otherwise the new map will
