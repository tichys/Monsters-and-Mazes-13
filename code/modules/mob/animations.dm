...
// Typo from the original coder here, below lies the jitteriness process. So make of his code what I will, the previous comment here was just a copypaste of the above.
