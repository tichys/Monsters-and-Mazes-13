...
/mob/living/carbon/alien/larva/verb/evolve()
	...
	set name = "Moult"
	set desc = "Moult my skin and become an adult."
	...
	if(handcuffed)
		to_chat(src, "<span class='warning'>I cannot evolve when I am cuffed.</span>")
		return

	if(amount_grown < max_grown)
		to_chat(src, "<span class='warning'>I am not fully grown.</span>")
		return
	...
	if(mind)
		...
		if (can_namepick_as_adult)
			var/newname = sanitize(input(adult, "I have become an adult. Choose a name for myself.", "Adult Name") as null|text, MAX_NAME_LEN)
...
/mob/living/carbon/alien/larva/proc/confirm_evolution()
	...
	to_chat(src, "<span class='notice'><b>I am growing into a beautiful alien! It is time to choose a caste.</b></span>")
	...
	var/alien_caste = alert(src, "Please choose which alien caste I shall belong to.",,"Hunter","Sentinel","Drone")
