...
/mob/living/carbon/proc/punish_host()
	...
	if(B.host_brain.ckey)
		...
		if (!can_feel_pain())
			to_chat(B.host_brain, "<span class='warning'>I feel a strange sensation as a foreign influence prods my mind.</span>")
			to_chat(src, "<span class='danger'>It doesn't seem to be as effective as I hoped.</span>")
		else
...
/mob/living/carbon/proc/spawn_larvae()
	...
	if(B.chemicals >= 100)
		to_chat(src, "<span class='danger'>My host twitches and quivers as I rapidly excrete a larva from my sluglike body.</span>")
		...
		to_chat(src, "<span class='warning'>I do not have enough chemicals stored to reproduce.</span>")
		return
