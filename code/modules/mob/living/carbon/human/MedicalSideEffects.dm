...
/datum/medical_effect/headache
	...
	cure_message = "My head stops throbbing..."
...
/datum/medical_effect/headache/on_life(mob/living/carbon/human/H, strength)
	...
	if(istype(head))
		switch(strength)
			if(1 to 10)
				H.custom_pain("I feel a light pain in my head.",0, affecting = head)
			if(11 to 30)
				H.custom_pain("I feel a throbbing pain in my head!",1, affecting = head)
			if(31 to INFINITY)
				H.custom_pain("I feel an excrutiating pain in my head!",1, affecting = head)
...
/datum/medical_effect/bad_stomach
	...
	cure_message = "My stomach feels a little better now..."

/datum/medical_effect/bad_stomach/on_life(mob/living/carbon/human/H, strength)
	switch(strength)
		if(1 to 10)
			H.custom_pain("I feel a bit light around the stomach.",0)
		if(11 to 30)
			H.custom_pain("My stomach hurts.",0)
		if(31 to INFINITY)
			H.custom_pain("I feel sick.",1)
