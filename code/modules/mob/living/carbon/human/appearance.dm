/mob/living/carbon/human/proc/change_appearance(var/flags = APPEARANCE_ALL_HAIR, var/location = src, var/mob/user = src, var/list/species_blacklist = list(), var/datum/topic_state/state = GLOB.default_state)
...
/mob/living/carbon/human/proc/generate_valid_species(var/list/blacklist = list())
