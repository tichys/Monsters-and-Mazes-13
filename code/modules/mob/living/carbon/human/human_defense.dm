...
/mob/living/carbon/human/getarmor(var/def_zone, var/type)
	...
	//If I don't specify a bodypart, it checks ALL my bodyparts for protection, and averages out the values
...
/mob/living/carbon/human/resolve_item_attack(obj/item/I, mob/living/user, var/target_zone)
	...
	if(user == src) // Attacking myself can't miss
		return target_zone
...
/mob/living/carbon/human/hit_with_weapon(obj/item/I, mob/living/user, var/effective_force, var/hit_zone)
	...
	var/blocked = run_armor_check(hit_zone, "melee", I.armor_penetration, "My armor has protected my [affecting.name].", "My armor has softened the blow to my [affecting.name].")
	...
	if((I.damtype == BRUTE || I.damtype == PAIN) && prob(25 + (effective_force * 2)))
		if(!stat)
			if(headcheck(hit_zone))
				//Harder to score a stun but if I do it lasts a bit longer
...
/mob/living/carbon/human/emag_act(var/remaining_charges, mob/user, var/emag_source)
	...
	if(affecting.status & ORGAN_SABOTAGED)
		...
		return -1
	to_chat(user, "<span class='notice'>I sneakily slide [emag_source] into the dataport on [src]'s [affecting.name] and short out the safeties.</span>")
...
/mob/living/carbon/human/hitby(atom/movable/AM as mob|obj,var/speed = THROWFORCE_SPEED_DIVISOR)
	if(istype(AM,/obj/))
		...
		var/armor = run_armor_check(affecting, "melee", O.armor_penetration, "My armor has protected my [hit_area].", "My armor has softened hit to my [hit_area].") //I guess "melee" is the best fit here
		if(armor < 100)
