/mob/living/carbon/human
	...
	var/gunshot_residue
	var/pulling_punches    // Are I trying not to hurt my opponent?
	...
	var/flies = 0 	// do we have flies on us?

	var/loneliness = 300

	var/buried = 0 // are we buried or is the body disposed of? (a value of 2 means that it's permanently laid to rest)