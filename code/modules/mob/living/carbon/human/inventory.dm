...
//set redraw_mob to 0 if I don't wish the hud to be updated - if you're doing it manually in my own proc.
/mob/living/carbon/human/equip_to_slot(obj/item/W as obj, slot, redraw_mob = 1)
	...
	switch(slot)
		...
		if(slot_tie)
			...
			to_chat(src, "<span class='danger'>I am trying to eqip this item to an unsupported inventory slot. If possible, please write a ticket with steps to reproduce. Slot was: [slot]</span>")
			return
