...
/datum/species/starlight/starborn
	...
	cold_discomfort_strings = list("I feel my fire dying out...",
								"My fire begins to shrink away from the cold.",
								"I feel slow and sluggish from the cold."
								)
	cold_level_1 = 260
	cold_level_2 = 250
	cold_level_3 = 235
	...
	heat_discomfort_strings = list("Surprisingly, I start burning!",
									"You're... burning!?!")
	heat_level_1 = 20000
	heat_level_2 = 30000
	heat_level_3 = 40000
