...
/datum/species/shapeshifter/promethean
	...
	heat_discomfort_strings = list("I feel too warm.")
	cold_discomfort_strings = list("I feel too cool.")
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_DIONA, "Monkey")
	monochromatic = 1
...
/datum/species/shapeshifter/promethean/hug(var/mob/living/carbon/human/H,var/mob/living/target)
	...
	H.visible_message("<span class='notice'>\The [H] glomps [target] to make [G.him] feel better!</span>", \
					"<span class='notice'>I glomps [target] to make [G.him] feel better!</span>")
...
/datum/species/shapeshifter/promethean/handle_environment_special(var/mob/living/carbon/human/H)
	...
	for(var/obj/item/organ/I in H.internal_organs)
		if(I.damage > 0)
			...
			if (prob(5))
				H << "<span class='notice'>I feel a soothing sensation within my [I.name]...</span>"
			return 1
	...
	for(var/limb_type in has_limbs)
		...
		if(!E)
			...
			H << "<span class='notice'>I feel a slithering sensation as my [O.name] reforms.</span>"
			H.update_body()
			return 1
