...
/datum/species/human/get_ssd(var/mob/living/carbon/human/H)
	if(H.stat == CONSCIOUS)
		return "staring blankly, not reacting to my presence"
	return ..()
...
/datum/species/diona
	...
	all known species. Their communal mind makes them slow to react, and they have difficulty understanding \
