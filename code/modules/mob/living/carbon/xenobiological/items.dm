...
/obj/item/weapon/slimepotion
	...
	attack(mob/living/carbon/slime/M as mob, mob/user as mob)
		...
		pet.colour = "[M.colour]"
		to_chat(user, "I feed the slime the potion, removing it's powers and calming it.")
		qdel(M)
		var/newname = sanitize(input(user, "Would I like to give the slime a name?", "Name my new pet", "pet slime") as null|text, MAX_NAME_LEN)
...
/obj/effect/golemrune/attack_hand(mob/living/user as mob)
	...
	G.set_species("Golem")
	G.key = ghost.key
	to_chat(G, "I am a golem. I move slowly, but are highly resistant to heat and cold. I am however vulnerable to blunt trauma. Serve [user], and assist them in completing their goals at any cost.")
	qdel(src)
