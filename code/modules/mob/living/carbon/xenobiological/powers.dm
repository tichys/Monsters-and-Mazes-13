	...
	while(Victim && stat != 2)
		if(Adjacent(M))
			...
			if(prob(15) && M.client && istype(M, /mob/living/carbon))
				var/painMes = pick("I can feel my body becoming weak!", "I feel like you're about to die!", "I feel every part of my body screaming in agony!", "A low, rolling pain passes through my body!", "My body feels as if it's falling apart!", "I feel extremely weak!", "A sharp, deep pain bathes every inch of my body!")
				if (ishuman(M))
					var/mob/living/carbon/human/H = M
			...
			adjustOxyLoss(-heal_amt) //Heal myself
...
/mob/living/carbon/slime/verb/Evolve()
	set category = "Slime"
	set desc = "This will let I evolve from baby to adult slime."
...
/mob/living/carbon/slime/verb/Reproduce()
	set category = "Slime"
	set desc = "This will make I split into four slimes."
