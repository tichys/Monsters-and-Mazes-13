...
/datum/god_form/narsie
	name = "Nar-Sie"
	info = {"The Geometer of Blood, I crave blood and destruction.<br>
	<b>Benefits:</b><br>
...
/datum/god_form/narsie/take_charge(var/mob/living/user, var/charge)
	...
	if(prob(charge))
		to_chat(user, "<span class='warning'>I feel drained...</span>")
