/datum/deity_item/minions
	...
	desc = "Unlock abilities that allow my followers to craft and summon useful creatures."
	category = DEITY_TREE_DARK_MINION
	base_cost = 75

/datum/deity_item/boon/soul_shard
	name = "Soul Stone Shard"
	desc = "Give my follower a sliver of soulstone to capture a life in."
	category = DEITY_TREE_DARK_MINION
...
/datum/deity_item/boon/tear_veil
	name = "Tear Veil"
	desc = "Grant my follower the ability to literally rip a hole in this reality, allowing things to pass through."
	category = DEITY_TREE_DARK_MINION
	requirements = list(DEITY_TREE_DARK_MINION = 1)
	base_cost = 100
...
/datum/deity_item/phenomena/hellscape
	...
	desc = "I show a non-believer what their future will be like."
	category = DEITY_TREE_DARK_MINION
	requirements = list(DEITY_TREE_DARK_MINION = 1)
	base_cost = 110
