/datum/deity_item/sacrifice
	...
	desc = "Unlocks the tools necessary to allow my followers to sacrifice in my name."
...
/datum/deity_item/boon/sac_dagger
	...
	desc = "A small dagger embued with my powers. Lets my followers give me power through sacrifices on an altar."
	category = DEITY_TREE_SACRIFICE
...
/datum/deity_item/boon/execution_axe
	name = "Greedy Axe"
	desc = "This axe can store the very souls of those it kills to be later transfered to I through an altar."
	category = DEITY_TREE_SACRIFICE
	requirements = list(DEITY_TREE_SACRIFICE = 1)
	base_cost = 50
...
/datum/deity_item/blood_stone
	name = "Bloodied Stone"
	desc = "Unlocks the blood stone building, which allows followers to increase my power through ritual and prayer."
	category = DEITY_TREE_SACRIFICE
	requirements = list(DEITY_TREE_SACRIFICE = 1)
	base_cost = 50
	max_level = 1
