...
/datum/deity_item/blood_crafting/armored
	...
	desc = "Unlock the secrets to tempered blood smithing, allowing my followers to smith more powerful and expensive armaments."
	category = DEITY_BLOOD_CRAFT
	base_cost = 75
...
/datum/deity_item/blood_crafting/space
	...
	desc = "Allows my followers to craft space suits, allowing I to finally spread across the cosmos."
	category = DEITY_BLOOD_CRAFT
	base_cost = 100
