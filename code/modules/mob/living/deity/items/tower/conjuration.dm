...
/datum/deity_item/boon/single_charge/create_air
	name = "Create Air"
	desc = "Allows my follower to generate a livable atmosphere in the area they are in."
	base_cost = 25
	category = DEITY_TREE_CONJURATION
...
/datum/deity_item/phenomena/dimensional_locker
	...
	desc = "Gain the ability to move a magical locker around. While it cannot move living things, I can move it around as I please, even disappearing it into the nether."
	base_cost = 50
	category = DEITY_TREE_CONJURATION
...
/datum/deity_item/boon/single_charge/sword
	name = "Summon Sword"
	desc = "This spell allows my followers to summon a golden firey sword for a short duration."
	base_cost = 50
...
/datum/deity_item/boon/single_charge/shield
	name = "Summon Shield"
	desc = "This spell allows my followers to summon a magical shield for a short duration."
	base_cost = 20
...
/datum/deity_item/phenomena/portals
	...
	desc = "Gain the ability to create portals for my followers to enter through. I will need to create two for it work. Any created past that will delete the oldest portal."
	base_cost = 75
	requirements = list(DEITY_TREE_CONJURATION = 2)
	category = DEITY_TREE_CONJURATION
...
/datum/deity_item/boon/single_charge/fireball
	name = "Fireball"
	desc = "Embue my follower with the power of exploding fire."
	base_cost = 85
