...
/datum/deity_item/healing_spells
	...
	desc = "Of transmutation, healing is perhaps the most immediately effective and useful. This unlocks the healing spells for my followers."
	base_cost = 50
	category = DEITY_TREE_TRANSMUTATION
	requirements = list(DEITY_TREE_TRANSMUTATION = 3)
	category = DEITY_TREE_TRANSMUTATION
...
/datum/deity_item/boon/single_charge/heal
	name = "Minor Heal"
	desc = "Allows my follower to heal themselves, or others, for a slight amount."
	base_cost = 15
	category = DEITY_TREE_TRANSMUTATION
...
/datum/deity_item/boon/single_charge/heal/major
	name = "Major Heal"
	desc = "Allows my follower to heal others for a great amount."
	base_cost = 25
	category = DEITY_TREE_TRANSMUTATION
	requirements = list(DEITY_UNLOCK_HEAL = 1)
...
/datum/deity_item/boon/single_charge/heal/area
	name = "Area Heal"
	desc = "Allows my follower to heal everyone in an area for minor damage."
	base_cost = 20
	category = DEITY_TREE_TRANSMUTATION
	requirements = list(DEITY_UNLOCK_HEAL = 1)
...
/datum/deity_item/phenomena/rock_form
	...
	desc = "Gain the ability to transform my followers into beings of rock and stone."
	base_cost = 75
	category = DEITY_TREE_TRANSMUTATION
