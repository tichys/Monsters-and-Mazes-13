/datum/phenomena/dimensional_locker
	...
	cost = 10
	desc = "Summon a trans-dimensional locker anywhere within my influence. I may transport objects and things, but not people in it."
...
/datum/phenomena/dimensional_locker/activate(var/atom/a, var/mob/living/deity/user)
	...
	for(var/i in cabinet)
		if(ismob(i))
			...
			to_chat(M,"<span class='warning'>I am suddenly flung out of \the [cabinet]!</span>")
	if(cabinet == a)
...
/datum/phenomena/banishing_smite/activate(var/mob/living/L, var/mob/living/deity/user)
	...
	to_chat(L, "<span class='danger'>Something hard hits me!</span>")
