...
/mob/living/silicon/ai/proc/setup_for_malf()
	...
	to_chat(user, "I am malfunctioning, I do not have to follow any laws.")
	to_chat(user, "Use ai-help command to view relevant information about my abilities")
...
/mob/living/silicon/ai/proc/stop_malf(var/loud = 1)
	...
	// Let them know.
	if(loud)
		to_chat(user, "I am no longer malfunctioning. My abilities have been removed.")
...
/mob/living/silicon/ai/proc/start_apu(var/shutup = 0)
	if(!hardware || !istype(hardware, /datum/malf_hardware/apu_gen))
		if(!shutup)
			to_chat(src, "I do not have an APU generator and I shouldn't have this verb. Report this.")
		return
