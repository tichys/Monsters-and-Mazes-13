/mob/living/silicon/pai
	...
	var/chassis = "repairbot"   // A record of my chosen chassis.
...
/mob/living/silicon/pai/emp_act(severity)
	...
	if(prob(20))
		...
		for (var/mob/M in viewers(T))
			M.show_message("<span class='warning'>A shower of sparks spray from [src]'s inner workings.</span>", 3, "<span class='warning'>I hear and smell the ozone hiss of electrical sparks being expelled violently.</span>", 2)
		return src.death(0)
	...
	switch(pick(1,2,3))
		...
		if(3)
			to_chat(src, "<font color=green>I feel an electric surge run through my circuitry and become acutely aware at how lucky I am that I can still feel at all.</font>")
...
/mob/living/silicon/pai/verb/fold_out()
	...
	if(istype(card.loc,/obj/item/rig_module) || istype(card.loc,/obj/item/integrated_circuit/manipulation/ai/))
		to_chat(src, "There is no room to unfold inside \the [card.loc]. I'm good and stuck.")
		return 0
...
/mob/living/silicon/pai/proc/choose_chassis()
	...
	while(finalized == "No" && src.client)
		...
		choice = input(usr,"What would I like to use for my mobile chassis icon? This decision can only be made once.") as null|anything in possible_chassis
		if(!choice) return

		icon_state = possible_chassis[choice]
		finalized = alert("Look at my sprite. Is this what I wish to use?",,"No","Yes")
...
/mob/living/silicon/pai/proc/choose_verbs()
	...
	var/choice = input(usr,"What theme would I like to use for my speech verbs? This decision can only be made once.") as null|anything in possible_say_verbs
	if(!choice) return
...
/mob/living/silicon/pai/verb/wipe_software()
	...
	set category = "OOC"
	set desc = "Wipe my software. This is functionally equivalent to cryo or robotic storage, freeing up my job slot."

	// Make sure people don't kill themselves accidentally
	if(alert("WARNING: This will immediately wipe my software and ghost you, removing my character from the round permanently (similar to cryo and robotic storage). Are I entirely sure I want to do this?",
