...
/mob/living/simple_animal/hostile/giant_spider
	name = "giant spider"
	desc = "Furry and brown, it makes I shudder to look at it. This one has deep red eyes."
	icon_state = "guard"
	icon_living = "guard"
...
/mob/living/simple_animal/hostile/giant_spider/nurse
	desc = "Furry and beige, it makes I shudder to look at it. This one has brilliant green eyes."
	icon_state = "nurse"
	icon_living = "nurse"
...
/mob/living/simple_animal/hostile/giant_spider/hunter
	desc = "Furry and black, it makes I shudder to look at it. This one has sparkling purple eyes."
	icon_state = "hunter"
	icon_living = "hunter"
	...
	if(isliving(.))
		...
		if(L.reagents)
			...
			if(prob(poison_per_bite))
				to_chat(L, "<span class='warning'>I feel a tiny prick.</span>")
