...
/mob/living/simple_animal/parrot
	...
	var/obj/desired_perches = list(/obj/structure/computerframe, 			/obj/structure/displaycase, \
									...
									/obj/structure/showcase, 				/obj/item/modular_computer/console)
		...
		if(in_range(src, parrot_interest))
			...
			if(isliving(parrot_interest))
				...
				if(!parrot_perch || parrot_interest.loc != parrot_perch.loc)
					...
					visible_message("[src] grabs the [held_item]!", "<span class='notice'>I grab the [held_item]!</span>", "I hear the sounds of wings flapping furiously.")
...
/mob/living/simple_animal/parrot/proc/steal_from_ground()
	...
	if(held_item)
		to_chat(src, "<span class='warning'>I am already holding the [held_item]</span>")
		return 1
...
/mob/living/simple_animal/parrot/proc/steal_from_mob()
	...
	for(var/mob/living/carbon/C in view(1,src))
		...
		if(stolen_item && C.unEquip(stolen_item, src))
			...
			visible_message("[src] grabs the [held_item] out of [C]'s hand!", "<span class='warning'>I snag the [held_item] out of [C]'s hand!</span>", "I hear the sounds of wings flapping furiously.")
			return held_item
...
/mob/living/simple_animal/parrot/proc/drop_held_item(var/drop_gently = 1)
	...
	if(!drop_gently)
		if(istype(held_item, /obj/item/weapon/grenade))
			...
			G.loc = src.loc
			G.detonate()
			to_chat(src, "I let go of the [held_item]!")
			held_item = null
			return 1

	to_chat(src, "I drop the [held_item].")
...
/mob/living/simple_animal/parrot/Poly
	...
	speak = list("Poly wanna cracker!", ":e Check the singlo, I chucklefucks!",":e Wire the solars, I lazy bums!",":e WHO TOOK THE DAMN HARDSUITS?",":e OH GOD ITS FREE CALL THE SHUTTLE")
