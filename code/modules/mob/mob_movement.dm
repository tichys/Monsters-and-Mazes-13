...
//This gets called when I press the delete button.
...
//If there's no gravity then there's no up or down so naturally I can't stand on anything.
//For the same reason lattices in space don't count - those are things I grip, presumably.
...
/mob/proc/handle_spaceslipping()
	if(prob(skill_fail_chance(SKILL_EVA, slip_chance(10), SKILL_EXPERT)))
		to_chat(src, "<span class='warning'>I slipped!</span>")
