// This is the base type that handles everything. Subtypes can be easily created by tweaking variables in this file to my liking.

/obj/item/modular_computer
	name = "Modular Computer"
	desc = "A modular computer. I shouldn't see this."
	...
	// If I create a program which is limited to Laptops and Consoles I don't have to add it's icon_state overlay for Tablets too, for example.
	...
	var/obj/item/weapon/computer_hardware/nano_printer/nano_printer					// Nano Printer component of this computer, for my everyday paperwork needs.
