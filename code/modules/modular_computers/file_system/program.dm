...
/datum/computer_file/program
	filetype = "PRG"
	filename = "UnknownProgram"						// File name. FILE NAME MUST BE UNIQUE IF I WANT THE PROGRAM TO BE DOWNLOADABLE FROM NTNET!
...
/datum/computer_file/program/proc/can_run(var/mob/living/user, var/loud = 0, var/access_to_check)
	...
	// Admin override - allows operation of any computer as aghosted admin, as if I had any required access.
...
// This is called every tick when the program is enabled. Ensure I do parent call if I override it. If parent returns 1 continue with UI initialisation.
