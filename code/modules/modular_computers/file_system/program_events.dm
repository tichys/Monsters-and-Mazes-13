...
/datum/computer_file/program/proc/event_networkfailure(var/background)
	...
	if(background)
		...
		computer.visible_message("<span class='warning'>\The [computer]'s screen briefly freezes and then shows: \"FATAL NETWORK ERROR - NTNet connection lost. Please try again later. If problem persists, please contact my system administrator.\"</span>", range = 1)
