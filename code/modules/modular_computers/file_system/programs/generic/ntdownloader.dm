...
/datum/computer_file/program/ntnetdownload/proc/complete_file_download()
	...
	if(!computer || !computer.hard_drive || !computer.hard_drive.store_file(downloaded_file))
		// The download failed
		downloaderror = "I/O ERROR - Unable to save file. Check whether I have enough free space on my hard drive and whether my hard drive is properly connected. If the issue persists contact my system administrator for assistance."
	downloaded_file = null
	download_completion = 0
	ui_header = "downloader_finished.gif"
