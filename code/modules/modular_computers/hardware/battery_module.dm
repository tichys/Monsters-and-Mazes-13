...
// have tremendeous capacity in comparsion. Higher tier cells would provide my device with nearly infinite battery life, which is something i want to avoid.
