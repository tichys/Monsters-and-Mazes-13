...
/obj/machinery/lapvend
	...
	// Utility vars
	var/state = 0 							// 0: Select device type, 1: Select loadout, 2: Payment, 3: ThankI screen
...
// Removes all traces of old order and allows me to begin configuration from scratch.
