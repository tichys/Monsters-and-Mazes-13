...
/datum/nanoui
	...
	var/templates[0]
	// the layout key for this ui (this is used on the frontend, leave it as "default" unless I know what you're doing)
	...
	// the default state to use for this ui (this is used on the frontend, leave it as "default" unless I know what you're doing)
