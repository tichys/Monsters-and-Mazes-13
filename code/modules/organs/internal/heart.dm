...
/obj/item/organ/internal/heart/proc/handle_pulse()
	if(BP_IS_ROBOTIC(src))
		pulse = PULSE_NONE	//that's it, you're dead (or my metal heart is), nothing can influence my pulse
		return
				...
				for(var/datum/wound/W in temp.wounds)
					...
					if(W.bleeding())
						if(temp.applied_pressure)
							...
							//somehow I can apply pressure to every wound on the organ at the same time
