...
/obj/item/organ/attack(var/mob/target, var/mob/user)
	...
	if(alert("Do I really want to use this organ as food? It will be useless for anything else afterwards.",,"Ew, no.","Bon appetit!") == "Ew, no.")
		to_chat(user, "<span class='notice'>I successfully repress my cannibalistic tendencies.</span>")
		return
	if(!user.unEquip(src))
		return
