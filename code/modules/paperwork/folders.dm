...
/obj/item/weapon/folder/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/paper) || istype(W, /obj/item/weapon/photo) || istype(W, /obj/item/weapon/paper_bundle))
		...
		var/n_name = sanitizeSafe(input(usr, "What would I like to label the folder?", "Folder Labelling", null)  as text, MAX_NAME_LEN)
...
/obj/item/weapon/folder/envelope
	name = "envelope"
	desc = "A thick envelope. I can't see what's inside."
...
/obj/item/weapon/folder/envelope/proc/sealcheck(user)
	var/ripperoni = alert("Are I sure I want to break the seal on \the [src]?", "Confirmation","Yes", "No")
	if(ripperoni == "Yes")
