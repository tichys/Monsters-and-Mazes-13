...
/obj/item/weapon/pen/reagent/sleepy/New()
	..()
	reagents.add_reagent(/datum/reagent/chloralhydrate, 15)	//Used to be 100 sleep toxin//30 Chloral seems to be fatal, reducing it to 22, reducing it further to 15 because fuck I OD code./N
...
/obj/item/weapon/pen/chameleon/verb/set_colour()
	...
	if(selected_type)
		...
		to_chat(usr, "<span class='info'>I select the [lowertext(selected_type)] ink container.</span>")
...
/obj/item/weapon/pen/crayon
	name = "crayon"
	desc = "A colourful crayon. Please refrain from eating it or putting it in my nose."
