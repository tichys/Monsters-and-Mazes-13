...
/obj/machinery/computer/gyrotron_control/interact(var/mob/user)
	...
	if(!id_tag)
		to_chat(user, "<span class='warning'>This console has not been assigned an ident tag. Please contact my system administrator or conduct a manual update with a standard multitool.</span>")
		return
