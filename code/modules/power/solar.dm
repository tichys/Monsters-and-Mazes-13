...
/obj/item/solar_assembly/attack_hand(var/mob/user)
	if(!anchored && isturf(loc)) // I can't pick it up
		..()
...
/obj/item/weapon/paper/solar
	name = "paper- 'Going green! Setup my own solar array instructions.'"
	info = "<h1>Welcome</h1><p>At greencorps we love the environment, and space. With this package I am able to help mother nature and produce energy without any usage of fossil fuel or phoron! Singularity energy is dangerous while solar energy is safe, which is why it's better. Now here is how I setup my own solar array.</p><p>I can make a solar panel by wrenching the solar assembly onto a cable node. Adding a glass panel, reinforced or regular glass will do, will finish the construction of my solar panel. It is that easy!</p><p>Now after setting up 19 more of these solar panels I will want to create a solar tracker to keep track of our mother nature's gift, the GLOB.sun. These are the same steps as before except I insert the tracker equipment circuit into the assembly before performing the final step of adding the glass. I now have a tracker! Now the last step is to add a computer to calculate the sun's movements and to send commands to the solar panels to change direction with the GLOB.sun. Setting up the solar computer is the same as setting up any computer, so I should have no trouble in doing that. I do need to put a wire node under the computer, and the wire needs to be connected to the tracker.</p><p>Congratulations, I should have a working solar array. If I am having trouble, here are some tips. Make sure all solar equipment are on a cable node, even the computer. I can always deconstruct my creations if I make a mistake.</p><p>That's all to it, be safe, be green!</p>"
