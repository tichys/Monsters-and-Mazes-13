...
/obj/item/weapon/gun/energy/floragun/verb/select_gene()
	...
	to_chat(usr, "<span class='info'>I set the [src]'s targeted genetic area to [genemask].</span>")
...
/obj/item/weapon/gun/energy/staff/special_check(var/mob/user)
	if(required_antag_type)
		...
		if(user.mind && !antag.is_antagonist(user.mind))
			to_chat(usr, "<span class='warning'>I focus my mind on \the [src], but nothing happens!</span>")
			return 0
...
/obj/item/weapon/gun/energy/staff/focus
	name = "mental focus"
	desc = "An artefact that channels the will of the user into destructive bolts of force. If I amn't careful with it, I might poke someone's brain out."
...
/obj/item/weapon/gun/energy/plasmacutter
	name = "plasma cutter"
	desc = "A mining tool capable of expelling concentrated plasma bursts. I could use it to cut limbs off of xenos! Or, I know, mine stuff."
	charge_meter = 0
