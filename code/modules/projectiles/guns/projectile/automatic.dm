...
/obj/item/weapon/gun/projectile/automatic/c20r
	...
	desc = "The C-20r is a lightweight and rapid firing SMG, for when I REALLY need someone dead. Uses 10mm rounds. Has a 'Scarborough Arms - Per falcis, per pravitas' buttstamp."
	icon_state = "c20r"
	item_state = "c20r"
...
/obj/item/weapon/gun/projectile/automatic/z8
	...
	desc = "The Z8 Bulldog is an older model bullpup carbine, made by the now defunct Zendai Foundries. Uses armor piercing 7.62mm rounds. Makes I feel like a space marine when I hold it."
	icon_state = "carbine"
...
/obj/item/weapon/gun/projectile/automatic/l6_saw/load_ammo(var/obj/item/A, mob/user)
	if(!cover_open)
		to_chat(user, "<span class='warning'>I need to open the cover to load that into [src].</span>")
		return
	..()

/obj/item/weapon/gun/projectile/automatic/l6_saw/unload_ammo(mob/user, var/allow_dump=1)
	if(!cover_open)
		to_chat(user, "<span class='warning'>I need to open the cover to unload [src].</span>")
		return
	..()
