...
/obj/item/weapon/gun/projectile/pistol/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I, /obj/item/weapon/silencer))
		...
		to_chat(user, "<span class='notice'>I screw [I] onto [src].</span>")
		silenced = I	//dodgy?
		w_class = ITEM_SIZE_NORMAL
		update_icon()
		return
...
/obj/item/weapon/zipgunframe/barrel
	buildstate = 1

/obj/item/weapon/zipgunframe/barrel_taped
	buildstate = 2

/obj/item/weapon/zipgunframe/barrel_and_trigger
	buildstate = 3