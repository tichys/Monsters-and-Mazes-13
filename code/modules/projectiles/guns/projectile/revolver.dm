/obj/item/weapon/gun/projectile/revolver
	name = "revolver"
	desc = "The Lumoco Arms HE Colt is a choice revolver for when I absolutely, positively need to put a hole in the other guy. Uses .357 ammo."
	icon_state = "revolver"
	item_state = "revolver"
	caliber = "357"
	...
	var/chamber_offset = 0 //how many empty chambers in the cylinder until I hit a round
...
/obj/item/weapon/gun/projectile/revolver/verb/spin_cylinder()
	...
	set desc = "Fun when you're bored out of my skull."
	set category = "Object"

	chamber_offset = 0
	visible_message("<span class='warning'>\The [usr] spins the cylinder of \the [src]!</span>", \
	"<span class='notice'>I hear something metallic spin and click.</span>")
...
/obj/item/weapon/gun/projectile/revolver/detective/verb/rename_gun()
	...
	var/input = sanitizeSafe(input("What do I want to name the gun?", ,""), MAX_NAME_LEN)
...
/obj/item/weapon/gun/projectile/revolver/capgun/attackby(obj/item/weapon/wirecutters/W, mob/user)
	if(!istype(W) || icon_state == "revolver")
		return ..()
	to_chat(user, "<span class='notice'>I snip off the toy markings off the [src].</span>")
	name = "revolver"
	icon_state = "revolver"
