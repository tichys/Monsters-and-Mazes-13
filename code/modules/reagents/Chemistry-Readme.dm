/*
NOTE: IF I UPDATE THE REAGENT-SYSTEM, ALSO UPDATE THIS README.
...
Random important notes:
	...
	Useful if I want to update the objects icon etc.
...
About the Holder:
	...
	Procs:
		...
		trans_to(var/atom/target, var/amount = 1, var/multiplier = 1, var/copy = 0)
			...
			If for some reason I want touch effects to be bypassed (e.g. injecting stuff directly into a reagent container or person), call the appropriate trans_to_*() proc.
...
About Reagents:
	...
	Reagents are all the things I can mix and fille in bottles etc. This can be anything from
...
About the Tools:
	...
	By default, all atom have a reagents var - but its empty. if I want to use an object for the chem.
	...
	Other important stuff:
		...
		atom/proc/is_open_container()
			...
			If this returns 1 , I can use syringes, beakers etc
			to manipulate the contents of this object.
			If it's 0, you'll need to write my own custom reagent
			transfer code since I will not be able to use the standard
