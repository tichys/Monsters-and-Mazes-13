...
/datum/reagent/proc/mix_data(var/newdata, var/newamount) // I have a reagent with data, and new reagent with its own data get added, how do I deal with that?
	return

/datum/reagent/proc/get_data() // Just in case I have a reagent that handles data differently.
