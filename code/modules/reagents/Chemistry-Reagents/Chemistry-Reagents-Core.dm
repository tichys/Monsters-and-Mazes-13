...
/datum/reagent/blood/get_data() // Just in case I have a reagent that handles data differently.
	var/t = data.Copy()
	if(t["virus2"])
		var/list/v = t["virus2"]
		t["virus2"] = v.Copy()
...
/datum/reagent/water/affect_touch(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(M.chem_doses[type] == removed)
		M.visible_message("<span class='warning'>[S]'s flesh sizzles where the water touches it!</span>", "<span class='danger'>My flesh burns in the water!</span>")
...
/datum/reagent/fuel
	...
	glass_desc = "Unless I am an industrial tool, this is probably not safe for consumption."
