...
/datum/reagent/nutriment/flour
	name = "flour"
	description = "This is what I rub all over myself to pretend to be a ghost."
...
/datum/reagent/capsaicin
	...
	var/agony_dose = 5
	var/agony_amount = 2
	var/discomfort_message = "<span class='danger'>My insides feel uncomfortably hot!</span>"
...
/datum/reagent/capsaicin/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(M.chem_doses[type] < agony_dose)
		...
		if(prob(5))
			...
			to_chat(M, "<span class='danger'>I feel like my insides are burning!</span>")
	if(istype(M, /mob/living/carbon/slime))
...
/datum/reagent/capsaicin/condensed
	...
	agony_dose = 0.5
	agony_amount = 4
	discomfort_message = "<span class='danger'>I feel like my insides are burning!</span>"
	slime_temp_adj = 15
...
/datum/reagent/capsaicin/condensed/affect_touch(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(eyes_covered)
		if(!mouth_covered)
			message = "<span class='warning'>my [eye_protection] protects my eyes from the pepperspray!</span>"
	else
		message = "<span class='warning'>The pepperspray gets in my eyes!</span>"
		if(mouth_covered)
	...
	if(mouth_covered)
		if(!message)
			message = "<span class='warning'>my [face_protection] protects I from the pepperspray!</span>"
	else if(!no_pain)
		message = "<span class='danger'>My face and throat burn!</span>"
		if(prob(25))
...
/datum/reagent/capsaicin/condensed/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(M.chem_doses[type] == metabolism)
		...
		if(prob(5))
			M.visible_message("<span class='warning'>[M] [pick("dry heaves!","coughs!","splutters!")]</span>", "<span class='danger'>I feel like my insides are burning!</span>")
	if(istype(M, /mob/living/carbon/slime))
...
/datum/reagent/drink/juice/orange
	name = "Orange juice"
	description = "Both delicious AND rich in Vitamin C, what more do I need?"
...
/datum/reagent/drink/juice/onion
	name = "Onion Juice"
	description = "Juice from an onion, for when I need to cry."
	taste_description = "stinging tears"
	nutrition = 1
	color = "#ffeedd"

	glass_name = "onion juice"
	glass_desc = "Juice from an onion, for when I need to cry."
...
/datum/reagent/drink/juice/tomato
	...
	glass_desc = "Are I sure this is tomato juice?"
...
/datum/reagent/drink/milk/cream
	name = "Cream"
	description = "The fatty, still liquid part of milk. Why don't I mix this with sum scotch, eh?"
...
/datum/reagent/drink/tea
	name = "Tea"
	description = "Tasty black tea, it has antioxidants, it's good for me!"
	...
	glass_name = "tea"
	glass_desc = "Tasty black tea, it has antioxidants, it's good for me!"
...
/datum/reagent/drink/coffee/icecoffee
	...
	glass_desc = "A drink to perk I up and refresh me!"
	glass_special = list(DRINK_ICE)

/datum/reagent/drink/coffee/soy_latte
	name = "Soy Latte"
	description = "A nice and tasty beverage while I am reading my hippie books."
	taste_description = "creamy coffee"
	color = "#c65905"
	adj_temp = 5

	glass_name = "soy latte"
	glass_desc = "A nice and refrshing beverage while I am reading."
...
/datum/reagent/drink/coffee/cafe_latte
	name = "Cafe Latte"
	description = "A nice, strong and tasty beverage while I am reading."
	taste_description = "bitter cream"
	color = "#c65905"
	adj_temp = 5

	glass_name = "cafe latte"
	glass_desc = "A nice, strong and refreshing beverage while I am reading."
...
/datum/reagent/drink/nuka_cola
	...
	glass_desc = "Don't cry, Don't raise my eye, It's only nuclear wasteland"
	glass_special = list(DRINK_FIZZ)
...
/datum/reagent/drink/spacemountainwind
	name = "Mountain Wind"
	description = "Blows right through I like a space wind."
	...
	glass_desc = "Space Mountain Wind. As I know, there are no mountains in space, only wind."
	glass_special = list(DRINK_FIZZ)
...
/datum/reagent/drink/space_up
	...
	glass_name = "Space-up"
	glass_desc = "Space-up. It helps keep my cool."
	glass_special = list(DRINK_FIZZ)
...
/datum/reagent/drink/doctor_delight
	...
	glass_desc = "A healthy mixture of juices, guaranteed to keep I healthy until the next toolboxing takes place."
...
/datum/reagent/drink/ice
	name = "Ice"
	description = "Frozen water, my dentist wouldn't like I chewing this."
...
/datum/reagent/ethanol/absinthe
	name = "Absinthe"
	description = "Watch out that the Green Fairy doesn't come for me!"
...
/datum/reagent/ethanol/cognac
	...
	glass_name = "cognac"
	glass_desc = "Damn, I feel like some kind of French aristocrat just by holding this."
...
/datum/reagent/ethanol/deadrum
	...
	glass_name = "rum"
	glass_desc = "Now I want to Pray for a pirate suit, don't you?"
...
/datum/reagent/ethanol/alliescocktail
	...
	description = "A drink made from my allies, not as sweet as when made from my enemies."
	taste_description = "bitter yet free"
	color = "#d8ac45"
	strength = 25

	glass_name = "Allies cocktail"
	glass_desc = "A drink made from my allies."
...
/datum/reagent/ethanol/atomicbomb
	...
	glass_desc = "We cannot take legal responsibility for my actions after imbibing."

/datum/reagent/ethanol/coffee/b52
	name = "B-52"
	description = "Coffee, Irish Cream, and cognac. I will get bombed."
	...
	glass_name = "B-52"
	glass_desc = "Kahlua, Irish cream, and congac. I will get bombed."
...
/datum/reagent/ethanol/bloody_mary
	name = "Bloody Mary"
	description = "A strange yet pleasurable mixture made of vodka, tomato and lime juice. Or at least I THINK the red stuff is tomato juice."
...
/datum/reagent/ethanol/changelingsting
	...
	taste_description = "my brain coming out my nose"
	color = "#2e6671"
	strength = 10
...
/datum/reagent/ethanol/demonsblood
	...
	glass_desc = "Just looking at this thing makes the hair at the back of my neck stand up."
...
/datum/reagent/ethanol/driestmartini
	name = "Driest Martini"
	description = "Only for the experienced. I think I see sand floating in the glass."
	...
	glass_desc = "Only for the experienced. I think I see sand floating in the glass."
...
/datum/reagent/ethanol/gargle_blaster
	...
	taste_description = "my brains smashed out by a lemon wrapped around a gold brick"
	taste_mult = 5
	reagent_state = LIQUID
	color = "#7f00ff"
	strength = 10
...
/datum/reagent/ethanol/hooch
	name = "Hooch"
	description = "Either someone's failure at cocktail making or attempt in alchohol production. In any case, do I really want to drink that?"
	...
	glass_name = "Hooch"
	glass_desc = "I have really hit rock bottom now... my liver packed its bags and left last night."
...
/datum/reagent/ethanol/irish_cream
	name = "Irish Cream"
	description = "Whiskey-imbued cream, what else would I expect from the Irish."
	taste_description = "creamy alcohol"
	color = "#dddd9a3"
	strength = 25

	glass_name = "Irish cream"
	glass_desc = "It's cream, mixed with whiskey. What else would I expect from the Irish?"
...
/datum/reagent/ethanol/moonshine
	name = "Moonshine"
	description = "I have really hit rock bottom now... my liver packed its bags and left last night."
	taste_description = "bitterness"
	taste_mult = 2.5
	color = "#0064c8"
	strength = 12
...
/datum/reagent/ethanol/neurotoxin
	...
	glass_desc = "A drink that is guaranteed to knock I silly."
	glass_icon = DRINK_ICON_NOISY
...
/datum/reagent/ethanol/pwine
	...
	glass_name = "???"
	glass_desc = "A black ichor with an oily purple sheer on top. Are I sure I should drink this?"
...
/datum/reagent/ethanol/tequilla_sunrise
	...
	glass_desc = "Oh great, now I feel nostalgic about sunrises back on Terra..."
...
/datum/reagent/ethanol/white_russian
	...
	glass_desc = "A very nice looking drink. But that's just, like, my opinion, man."
...
/datum/reagent/ethanol/specialwhiskey // I have no idea what this is and where it comes from
	...
	description = "Just when I thought regular whiskey was good... This silky, amber goodness has to come along and ruin everything."
	taste_description = "liquid fire"
	color = "#523600"
	strength = 25

	glass_name = "special blend whiskey"
	glass_desc = "Just when I thought regular whiskey was good... This silky, amber goodness has to come along and ruin everything."