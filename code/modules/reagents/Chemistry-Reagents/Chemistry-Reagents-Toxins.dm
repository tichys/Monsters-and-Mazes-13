...
/datum/reagent/slimetoxin/affect_blood(var/mob/living/carbon/human/H, var/alien, var/removed)
	...
	if(!meatchunks.len)
		if(prob(10))
			to_chat(H, "<span class='danger'>My flesh rapidly mutates!</span>")
	...
	to_chat(H, "<span class='danger'>my [O.name]'s flesh mutates rapidly!</span>")
	...
	O.max_damage = 15
	if(prob(10))
		to_chat(H, "<span class='danger'>My slimy [O.name] plops off!</span>")
		O.droplimb()
	H.update_body()
...
/datum/reagent/aslimetoxin/affect_blood(var/mob/living/carbon/M, var/alien, var/removed) // TODO: check if there's similar code anywhere else
	if(HAS_TRANSFORMATION_MOVEMENT_HANDLER(M))
		return
	to_chat(M, "<span class='danger'>My flesh rapidly mutates!</span>")
...
/datum/reagent/toxin/hair_remover/affect_touch(var/mob/living/carbon/human/M, var/alien, var/removed)
	...
	to_chat(M, "<span class='warning'>My feel a chill, my skin feels lighter..</span>")
	remove_self(volume)
...
/datum/reagent/toxin/zombie/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if (istype(M, /mob/living/carbon/human))
		...
		if (true_dose >= 5)
			...
			to_chat(H, "<span class='warning'>I feel terribly ill!</span>")
