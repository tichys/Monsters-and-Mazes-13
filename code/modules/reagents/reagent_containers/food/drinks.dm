...
/obj/item/weapon/reagent_containers/food/drinks/proc/open(mob/user)
	...
	to_chat(user, "<span class='notice'>I open \the [src] with an audible pop!</span>")
	atom_flags |= ATOM_FLAG_OPEN_CONTAINER
...
/obj/item/weapon/reagent_containers/food/drinks/standard_feed_mob(var/mob/user, var/mob/target)
	if(!is_open_container())
		to_chat(user, "<span class='notice'>I need to open \the [src]!</span>")
		return 1
	return ..()
...
/obj/item/weapon/reagent_containers/food/drinks/self_feed_message(var/mob/user)
	to_chat(user, "<span class='notice'>I swallow a gulp from \the [src].</span>")
...
/obj/item/weapon/reagent_containers/food/drinks/tea
	...
	desc = "An insult to Duke Purple is an insult to the Space Queen! Any proper gentleman will fight you, if I sully this tea."
	icon_state = "teacup"
	item_state = "coffee"
...
/obj/item/weapon/reagent_containers/food/drinks/dry_ramen
	name = "cup ramen"
	gender = PLURAL
	desc = "Just add 10ml water, self heats! A taste that reminds I of my school years."
	icon_state = "ramen"
...
/obj/item/weapon/reagent_containers/food/drinks/flask/vacuumflask
	name = "vacuum flask"
	desc = "Keeping my drinks at the perfect temperature since 1892."
...
/obj/item/weapon/reagent_containers/food/drinks/coffeecup/metal
	...
	desc = "A metal coffee cup. I'm not sure which metal."
...
/obj/item/weapon/reagent_containers/food/drinks/coffeecup/STC
	name = "TCC coffee cup"
	desc = "A coffee cup adorned with the flag of the Terran Colonial Confederation, for when I need some espionage charges to go with my morning coffee."
...
/obj/item/weapon/reagent_containers/food/drinks/coffeecup/tall
	...
	desc = "An unreasonably tall coffee cup, for when I really need to wake up in the morning."
