...
/obj/item/weapon/reagent_containers/food/drinks/bottle/proc/insert_rag(obj/item/weapon/reagent_containers/glass/rag/R, mob/user)
	...
	if(user.unEquip(R))
		to_chat(user, "<span class='notice'>I stuff [R] into [src].</span>")
		rag = R
		rag.forceMove(src)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone)
	...
	// I am going to knock someone out for longer if they are not wearing a helmet.
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/specialwhiskey
	...
	desc = "Just when I thought regular whiskey was good... This silky, amber goodness has to come along and ruin everything."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/cognac
	...
	desc = "A sweet and strongly alchoholic drink, made after numerous distillations and years of maturing. I might as well not scream 'SHITCURITY' this time."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/absinthe
	...
	desc = "One sip of this and I just know you're gonna have a good time."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/space_mountain_wind
	...
	desc = "Blows right through I like a space wind."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/premiumwine
	name = "Uve De Blanc"
	desc = "I feel pretentious just looking at it."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/cream
	name = "Milk Cream"
	desc = "It's cream. Made from milk. What else did I think you'd find in there?"
	icon_state = "cream"
	item_state = "carton"
	center_of_mass = "x=16;y=8"
	isGlass = 0
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/tomatojuice
	name = "Tomato Juice"
	desc = "Well, at least it LOOKS like tomato juice. I can't tell with all that redness."
