...
/obj/item/weapon/reagent_containers/food/snacks/proc/On_Consume(var/mob/M)
	if(!reagents.total_volume)
		M.visible_message("<span class='notice'>[M] finishes eating \the [src].</span>","<span class='notice'>I finish eating \the [src].</span>")
...
/obj/item/weapon/reagent_containers/food/snacks/attack(mob/M as mob, mob/user as mob, def_zone)
	...
	if(istype(M, /mob/living/carbon))
		...
		if(C == user)								//If you're eating it myself
			if(istype(C,/mob/living/carbon/human))
				var/mob/living/carbon/human/H = M
				if(!H.check_has_mouth())
					to_chat(user, "Where do I intend to put \the [src]? I don't have a mouth!")
					return
			...
			if (fullness > 550)
				to_chat(C, "<span class='danger'>I cannot force any more of [src] to go down my throat.</span>")
				return 0
		else
...
/obj/item/weapon/reagent_containers/food/snacks/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if(istype(W,/obj/item/weapon/material/kitchen/utensil))
		...
		if(U.scoop_food)
			...
			if (U.reagents.total_volume > 0)
				to_chat(user, "<span class='warning'>I already have something on my [U].</span>")
				return

			user.visible_message( \
				"\The [user] scoops up some [src] with \the [U]!", \
				"<span class='notice'>I scoop up some [src] with \the [U]!</span>" \
			)
	...
	if (is_sliceable())
		...
		if (has_edge(W))
			if (!can_slice_here)
				to_chat(user, "<span class='warning'>I cannot slice \the [src] here! I need a table or at least a tray to do it.</span>")
				return
...
//Notes by Darem: Food in the "snacks" subtype can hold a maximum of 50 units Generally speaking, I don't want to go over 40
//	total for the item because I want to leave space for extra condiments. If I want effect besides healing, add a reagent for
//	it. Try to stick to existing reagents when possible (so if I want a stronger healing effect, just use Tricordrazine). On use
//	effect (such as the old officer eating a donut code) requires a unique reagent (unless I can figure out a better way).

//The nutriment reagent and bitesize variable replace the old heal_amt and amount variables. Each unit of nutriment is equal to
//	2 of the old heal_amt variable. bitesize is the rate at which the reagents are consumed. So if I have 6 nutriment and a
...
//		..()															//Same here.
//		reagents.add_reagent(/datum/reagent/xenomicrobes, 10)						//This is what is in the food item. I may copy/paste
...
/obj/item/weapon/reagent_containers/food/snacks/egg/afterattack(obj/O as obj, mob/user as mob, proximity)
	...
	if(!(proximity && O.is_open_container()))
		return
	to_chat(user, "I crack \the [src] into \the [O].")
...
/obj/item/weapon/reagent_containers/food/snacks/egg/throw_impact(atom/hit_atom)
	...
	src.visible_message("<span class='warning'>\The [src] has been squashed!</span>","<span class='warning'>I hear a smack.</span>")
	qdel(src)
...
/obj/item/weapon/reagent_containers/food/snacks/egg/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype( W, /obj/item/weapon/pen/crayon ))
		...
		to_chat(usr, "<span class='notice'>I color \the [src] [clr]</span>")
		icon_state = "egg-[clr]"
	else
		..()
...
/obj/item/weapon/reagent_containers/food/snacks/donkpocket/sinpocket/attack_self(mob/user)
	if(has_been_heated)
		...
		return
	has_been_heated = 1
	user.visible_message("<span class='notice'>[user] crushes \the [src] package.</span>", "I crush \the [src] package and feel a comfortable heat build up.")
	spawn(200)
		to_chat(user, "I think \the [src] is ready to eat about now.")
		heat()
...
/obj/item/weapon/reagent_containers/food/snacks/pie/throw_impact(atom/hit_atom)
	...
	src.visible_message("<span class='danger'>\The [src.name] splats.</span>","<span class='danger'>I hear a splat.</span>")
	qdel(src)
...
/obj/item/weapon/reagent_containers/food/snacks/plump_pie
	name = "plump pie"
	desc = "I bet I love stuff made out of plump helmets!"
...
/obj/item/weapon/reagent_containers/food/snacks/cubancarp
	...
	desc = "A sandwich that burns my tongue and then leaves it numb!"
...
/obj/item/weapon/reagent_containers/food/snacks/meatballsoup
	name = "meatball soup"
	desc = "I have got balls kid, BALLS!"
...
/obj/item/weapon/reagent_containers/food/snacks/slimesoup
	name = "slime soup"
	desc = "If no water is available, I may substitute tears."
...
/obj/item/weapon/reagent_containers/food/snacks/vegetablesoup
	name = "vegetable soup"
	desc = "A highly nutritious blend of vegetative goodness. Guaranteed to leave I with a, er, \"souped-up\" sense of wellbeing."
...
/obj/item/weapon/reagent_containers/food/snacks/mysterysoup
	name = "mystery soup"
	desc = "The mystery is, why aren't I eating it?"
...
/obj/item/weapon/reagent_containers/food/snacks/monkeycube/proc/Unwrap(var/mob/user)
	icon_state = "monkeycube"
	desc = "Just add water!"
	to_chat(user, "I unwrap the cube.")
	wrapped = 0
	atom_flags |= ATOM_FLAG_OPEN_CONTAINER
...
/obj/item/weapon/reagent_containers/food/snacks/toastedsandwich
	...
	desc = "Now if I only had a pepper bar."
...
/obj/item/weapon/reagent_containers/food/snacks/pastatomato
	...
	desc = "Spaghetti and crushed tomatoes. Just like my abusive father used to make!"
...
/obj/item/weapon/reagent_containers/food/snacks/jellysandwich
	name = "jelly sandwich"
	desc = "I wish I had some peanut butter to go with this..."
...
/obj/item/weapon/reagent_containers/food/snacks/beetsoup
	name = "beet soup"
	desc = "Wait, how do I spell it again..?"
	icon_state = "beetsoup"
	trash = /obj/item/trash/snack_bowl
...
/obj/item/weapon/reagent_containers/food/snacks/sliceable
	w_class = ITEM_SIZE_NORMAL //whole pizzas and cakes shouldn't fit in a pocket, I can slice them if I want to do that.
...
/obj/item/weapon/reagent_containers/food/snacks/slice/carrotcake
	...
	desc = "Carrotty slice of carrot cake, carrots are good for my eyes! Also not a lie."
...
/obj/item/weapon/reagent_containers/food/snacks/slice/braincake
	...
	desc = "Lemme tell I something about prions. THEY'RE DELICIOUS."
...
/obj/item/weapon/reagent_containers/food/snacks/slice/mushroompizza
	...
	desc = "Maybe it is the last slice of pizza in my life."
...
/obj/item/pizzabox/attack_hand( mob/user as mob )
	...
	if( open && pizza )
		...
		to_chat(user, "<span class='warning'>I take \the [src.pizza] out of \the [src].</span>")
		src.pizza = null
		update_icon()
		return
	...
	if( boxes.len > 0 )
		...
		to_chat(user, "<span class='warning'>I remove the topmost [src] from my hand.</span>")
		box.update_icon()
		update_icon()
		return
	..()
...
/obj/item/pizzabox/attackby( obj/item/I as obj, mob/user as mob )
	if( istype(I, /obj/item/pizzabox/) )
		...
		if( !box.open && !src.open )
			...
			if( (boxes.len+1) + boxestoadd.len <= 5 )
				...
				to_chat(user, "<span class='warning'>I put \the [box] ontop of \the [src]!</span>")
			else
	...
	if( istype(I, /obj/item/weapon/reagent_containers/food/snacks/sliceable/pizza/) )
		...
		if( src.open )
			...
			to_chat(user, "<span class='warning'>I put \the [I] in \the [src]!</span>")
		else
			to_chat(user, "<span class='warning'>I try to push \the [I] through the lid but it doesn't work!</span>")
		return
	...
	if( istype(I, /obj/item/weapon/pen/) )
		...
		var/t = sanitize(input("Enter what I want to add to the tag:", "Write", null, null) as text, 30)
...
/obj/item/weapon/reagent_containers/food/snacks/dough/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W,/obj/item/weapon/material/kitchen/rollingpin))
		...
		to_chat(user, "I flatten the dough.")
		qdel(src)
...
//Items I can craft together. Like bomb making, but with food and less screwdrivers.
...
/obj/item/weapon/reagent_containers/food/snacks/bun/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	// bun + cutlet = hamburger
		...
		to_chat(user, "I make a hamburger.")
		qdel(W)
		qdel(src)
...
/obj/item/weapon/reagent_containers/food/snacks/plainburger/attackby(obj/item/weapon/reagent_containers/food/snacks/cheesewedge/W as obj, mob/user as mob)
	if(istype(W))// && !istype(src,/obj/item/weapon/reagent_containers/food/snacks/cheesewedge))
		...
		to_chat(user, "I make a cheeseburger.")
		qdel(W)
		qdel(src)
		return
	else
...
/obj/item/weapon/reagent_containers/food/snacks/boiledspagetti/attackby(obj/item/weapon/reagent_containers/food/snacks/meatball/W as obj, mob/user as mob)
	if(istype(W))
		...
		to_chat(user, "I add some meatballs to the spaghetti.")
		qdel(W)
		qdel(src)
		return
	else
...
/obj/item/weapon/reagent_containers/food/snacks/meatballspagetti/attackby(obj/item/weapon/reagent_containers/food/snacks/meatball/W as obj, mob/user as mob)
	if(istype(W))
		...
		to_chat(user, "I add some more meatballs to the spaghetti.")
		qdel(W)
		qdel(src)
		return
	else
...
/obj/item/weapon/reagent_containers/food/snacks/spacetwinkie
	...
	desc = "Guaranteed to survive longer then I will."
...
/obj/item/weapon/reagent_containers/food/snacks/cheesiehonkers
	...
	desc = "Bite sized cheesie snacks that will honk all over my mouth."
...
/obj/item/weapon/reagent_containers/food/snacks/candy/proteinbar
	name = "protein bar"
	desc = "SwoleMAX brand protein bars, guaranteed to get I feeling perfectly overconfident."
...
/obj/item/weapon/reagent_containers/food/snacks/old/pizza
	name = "\improper Pizza!"
	desc = "It's so stale I could probably cut something with the cheese."
...
/obj/item/weapon/reagent_containers/food/snacks/old/hamburger
	...
	desc = "Even if I were hungry enough to eat a horse, it'd be a bad idea to eat this."
