...
/obj/item/weapon/reagent_containers/pill/attack(mob/M as mob, mob/user as mob, def_zone)
	...
	if(M == user)
		...
		to_chat(M, "<span class='notice'>I swallow \the [src].</span>")
...
/obj/item/weapon/reagent_containers/pill/afterattack(obj/target, mob/user, proximity)
	...
	if(target.is_open_container() && target.reagents)
		if(!target.reagents.total_volume)
			...
			return
		to_chat(user, "<span class='notice'>I dissolve \the [src] in [target].</span>")
...
/obj/item/weapon/reagent_containers/pill/noexcutite
	name = "Noexcutite (15u)"
	desc = "Feeling jittery? This should calm I down."
	icon_state = "pill4"
...
/obj/item/weapon/reagent_containers/pill/paroxetine
	name = "Paroxetine (10u)"
	desc = "Before I swallow a bullet: try swallowing this!"
	icon_state = "pill4"
