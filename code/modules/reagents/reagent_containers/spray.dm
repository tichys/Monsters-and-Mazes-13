...
/obj/item/weapon/reagent_containers/spray/attack_self(var/mob/user)
	...
	to_chat(user, "<span class='notice'>I adjusted the pressure nozzle. I'll now use [amount_per_transfer_from_this] units per spray.</span>")
...
/obj/item/weapon/reagent_containers/spray/verb/empty()
	...
	if (alert(usr, "Are I sure I want to empty that?", "Empty Bottle:", "Yes", "No") != "Yes")
		return
	if(isturf(usr.loc))
...
/obj/item/weapon/reagent_containers/spray/pepper/attack_self(var/mob/user)
	safety = !safety
	to_chat(usr, "<span class = 'notice'>I switch the safety [safety ? "on" : "off"].</span>")
