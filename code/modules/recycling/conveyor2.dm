...
/obj/machinery/conveyor_switch/attackby(obj/item/I, mob/user, params)
	if(isCrowbar(I))
		...
		C.id = id
		transfer_fingerprints_to(C)
		to_chat(user, "<span class='notice'>I deattach the conveyor switch.</span>")
		qdel(src)

/obj/machinery/conveyor_switch/oneway
	var/convdir = 1 //Set to 1 or -1 depending on which way I want the convayor to go. (In other words keep at 1 and set the proper dir on the belts.)
