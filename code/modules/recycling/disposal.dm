...
/obj/machinery/disposal/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I, /obj/item/weapon/melee/energy/blade))
		to_chat(user, "I can't place that item inside the disposal unit.")
		return

	if(istype(I, /obj/item/weapon/storage/bag/trash))
		var/obj/item/weapon/storage/bag/trash/T = I
		to_chat(user, "<span class='notice'>I empty the bag.</span>")
	...
	to_chat(user, "I place \the [I] into the [src].")
...
/obj/machinery/disposal/MouseDrop_T(atom/movable/AM, mob/user)
	...
	if(AM == user)
		user.visible_message("<span class='warning'>[user] starts climbing into [src].</span>", \
							 "<span class='notice'>I start climbing into [src].</span>")
	else
		user.visible_message("<span class='[is_dangerous ? "warning" : "notice"]'>[user] starts stuffing [AM] into [src].</span>", \
							 "<span class='notice'>I start stuffing [AM] into [src].</span>")
		...
		if(istype(I, /obj/item/weapon/weldingtool))
			...
			if(W.remove_fuel(0,user))
				...
				if(user.loc == uloc && wloc == W.loc)
					...
					to_chat(user, "I must stay still while welding the pipe.")
			else
