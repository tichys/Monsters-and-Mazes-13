...
***************************************************************/
/*
For the materials datum, it assumes I need reagents unless specified otherwise. To designate a material that isn't a reagent,
I use one of the material IDs below. These are NOT ids in the usual sense (they aren't defined in the object or part of a datum),
...
/datum/design/item/optical/mesons
	name = "mesons"
	desc = "Using the meson-scanning technology those glasses allow I to see through walls, floor or anything else."
	id = "mesons"
