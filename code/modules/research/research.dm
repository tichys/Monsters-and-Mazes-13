...
(explained later) only goes through those when refreshing what I know. Generally, possible_tech contains ALL of the existing tech
but it is possible to add tech to the game that DON'T start in it (example: Xeno tech). Generally speaking, I don't want to mess
...
- know_tech is the companion list to possible_tech. It's the tech I can actually research and improve. Until it's added to this
...
it doesn't have it, it adds it. Note: It does NOT check possible_tech at all. So if I want to add something strange to it (like
a player made tech?) I can.
...
and designs I have reached the requirements for. It only checks through possible_tech and possible_designs, however, so it won't
...
The tech datums are the actual "tech trees" that I improve through researching. Each one has five variables:
...
level in specific techs before I can produce them.
