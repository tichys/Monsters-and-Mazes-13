	...
	if(mob.machine || issilicon(mob))
		if((istype(mob.machine, /obj/machinery/computer/telecomms/traffic) && mob.machine in view(1, mob)) || issilicon(mob))
			...
			if(Machine.SelectedServer)
				...
				src << output("<font color = red>Failed to save: Unable to locate server machine. (Back up my code before exiting the window!)</font>", "tcserror")
		else
			src << output(null, "tcserror")
			src << output("<font color = red>Failed to save: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
	else
		src << output(null, "tcserror")
		src << output("<font color = red>Failed to save: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
	...
	if(mob.machine || issilicon(mob))
		if((istype(mob.machine, /obj/machinery/computer/telecomms/traffic) && mob.machine in view(1, mob)) || (issilicon(mob) && istype(mob.machine, /obj/machinery/computer/telecomms/traffic) ))
			...
			if(Machine.SelectedServer)
				...
				src << output(null, "tcserror")
				src << output("<font color = red>Failed to compile: Unable to locate server machine. (Back up my code before exiting the window!)</font>", "tcserror")
		else
			src << output(null, "tcserror")
			src << output("<font color = red>Failed to compile: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
	else
		src << output(null, "tcserror")
		src << output("<font color = red>Failed to compile: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
	...
	if(mob.machine || issilicon(mob))
		if((istype(mob.machine, /obj/machinery/computer/telecomms/traffic) && mob.machine in view(1, mob)) || (issilicon(mob) && istype(mob.machine, /obj/machinery/computer/telecomms/traffic) ))
			...
			if(Machine.SelectedServer)
				...
				src << output(null, "tcserror")
				src << output("<font color = red>Failed to run: Unable to locate server machine. (Back up my code before exiting the window!)</font>", "tcserror")
		else
			src << output(null, "tcserror")
			src << output("<font color = red>Failed to run: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
	else
		src << output(null, "tcserror")
		src << output("<font color = red>Failed to run: Unable to locate machine. (Back up my code before exiting the window!)</font>", "tcserror")
