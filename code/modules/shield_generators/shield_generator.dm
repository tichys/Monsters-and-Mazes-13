...
/obj/machinery/power/shield_generator/OnTopic(user, href_list)
	...
	if(href_list["emergency_shutdown"])
		...
		var/choice = input(user, "Are I sure that I want to initiate an emergency shield shutdown? This will instantly drop the shield, and may result in unstable release of stored electromagnetic energy. Proceed at my own risk.") in list("Yes", "No")
