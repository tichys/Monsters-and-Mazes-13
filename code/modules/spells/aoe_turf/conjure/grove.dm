...
/spell/aoe_turf/conjure/grove/sanctuary
	...
	newVars = list("name" = "sanctuary", "desc" = "This grass makes I feel comfortable. Peaceful.","blessed" = 1)
...
/spell/aoe_turf/conjure/grove/sanctuary/empower_spell()
	...
	spread = 40
	return "My sanctuary will now grow beyond that of the grassy perimeter."
