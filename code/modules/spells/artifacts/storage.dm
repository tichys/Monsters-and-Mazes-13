...
/obj/structure/closet/wizard/armor
	...
	desc = "An artefact suit of armor that allows me to cast spells while providing more protection against attacks and the void of space."
...
/obj/structure/closet/wizard/scrying
	name = "Scrying Orb"
	desc = "An incandescent orb of crackling energy, using it will allow I to ghost while alive, allowing I to reconnoiter with ease. In addition, buying it will permanently grant I x-ray vision."
...
/obj/structure/closet/wizard/souls
	...
	desc = "Soul Stone Shards are ancient tools capable of capturing and harnessing the spirits of the dead and dying. The spell Artificer allows me to create arcane machines for the captured souls to pilot. This also includes the spell Artificer, used to create the shells used in construct creation."
