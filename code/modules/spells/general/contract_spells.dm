...
/spell/contract/reward
	...
	desc = "A spell that makes my contracted victim feel better."
...
/spell/contract/reward/cast(mob/living/target,mob/user)
	...
	to_chat(target, "<font color='blue'>I feel great!</font>")
	target.ExtinguishMob()

/spell/contract/punish
	name = "Punish Contractee"
	desc = "A spell that sets my contracted victim ablaze."
...
/spell/contract/punish/cast(mob/living/target,mob/user)
	...
	to_chat(target, "<span class='danger'>I feel punished!</span>")
