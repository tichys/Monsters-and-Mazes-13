...
/datum/spellbook/spatial
	...
	feedback = "SP"
	desc = "I feel like this might disappear from out of under you."
	book_desc = "Movement and teleportation. Run from my problems!"
	title = "Manual of Spatial Transportation"
	title_desc = "Buy spells using my available spell slots. Artefacts may also be bought however their cost is permanent."
