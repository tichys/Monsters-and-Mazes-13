/spell/targeted/equip_item/burning_hand
	name = "Burning Hand"
	desc = "Bathes my hand in fire, giving I all the perks and disadvantages that brings."
	feedback = "BH"
	school = "conjuration"
...
/obj/item/weapon/flame/hands/Process()
	...
	if(burn_power > 5)
		...
		if(burn_power == 5)
			to_chat(user, "<span class='danger'>I begin to lose control of \the [src]'s flames as they rapidly move up my arm...</span>")
		else
			to_chat(user, "<span class='warning'>I feel \the [src] grow hotter and hotter!</span>")
