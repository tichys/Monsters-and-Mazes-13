/spell/targeted/exhude_pleasantness
	...
	max_targets = 0
	charge_max = 100
	var/list/possible_messages = list("seems pretty trustworthy!", "makes I feel appreciated.", "looks pretty cool.", "feels like the only decent person here!", "makes I feel safe.")
	hud_state = "friendly"
