...
/spell/targeted/genetic/blind
	...
	message = "<span class='danger'>My eyes cry out in pain!</span>"
...
/spell/targeted/genetic/mutate
	name = "Mutate"
	desc = "This spell causes I to turn into a hulk and gain laser vision for a short while."
	feedback = "MU"
	...
	message = "<span class='notice'>I feel strong! I feel a pressure building behind my eyes!</span>"
	range = 0
	max_targets = 1
