...
/datum/admins/proc/setup_supermatter()
	...
	set desc = "Allows I to start the Supermatter engine."
	...
	var/response = input(usr, "Are I sure? This will start up the engine with selected gas as coolant.", "Engine setup") as null|anything in list("N2", "CO2", "PH", "H2", "Abort")
