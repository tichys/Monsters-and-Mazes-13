...
/*
	...
	POWER_FACTOR		directly controls how much power the SM puts out at a given level of excitation (power var). Making this lower means I have to work the SM harder to get the same amount of power.
...
/obj/machinery/power/supermatter
	name = "Supermatter"
	desc = "A strangely translucent and iridescent crystal. <span class='danger'>I get headaches just from looking at it.</span>"
...
/obj/machinery/power/supermatter/proc/explode()
	...
	for(var/mob/living/mob in GLOB.living_mob_list_)
		...
		to_chat(mob, "<span class='danger'>An invisible force slams I against the ground!</span>")
...
/obj/machinery/power/supermatter/proc/announce_warning()
	...
	if(alert_msg)
		...
		if((damage > emergency_point) && !public_alert)
			...
			public_alert = 1
			GLOB.using_map.unbolt_saferooms() // genesis
...
/obj/machinery/power/supermatter/attack_hand(mob/user as mob)
	user.visible_message("<span class=\"warning\">\The [user] reaches out and touches \the [src], inducing a resonance... \his body starts to glow and bursts into flames before flashing into ash.</span>",\
		"<span class=\"danger\">I reach out and touch \the [src]. Everything starts burning and all I can hear is ringing. My last thought is \"That was not a wise decision.\"</span>",\
		"<span class=\"warning\">I hear an uneartly ringing, then what sounds like a shrilling kettle as I am washed with a wave of heat.</span>")
...
/obj/machinery/power/supermatter/attackby(obj/item/weapon/W as obj, mob/living/user as mob)
	if(istype(W, /obj/item/weapon/tape_roll))
		to_chat(user, "I repair some of the damage to \the [src] with \the [W].")
		damage = max(damage -10, 0)

	user.visible_message("<span class=\"warning\">\The [user] touches \a [W] to \the [src] as a silence fills the room...</span>",\
		"<span class=\"danger\">I touch \the [W] to \the [src] when everything suddenly goes silent.\"</span>\n<span class=\"notice\">\The [W] flashes into dust as I flinch away from \the [src].</span>",\
...
/obj/machinery/power/supermatter/Bumped(atom/AM as mob|obj)
	...
	if(istype(AM, /mob/living))
		...
		"<span class=\"danger\">I slam into \the [src] as my ears are filled with unearthly ringing. My last thought is \"Oh, fuck.\"</span>",\
		"<span class=\"warning\">I hear an uneartly ringing, then what sounds like a shrilling kettle as I am washed with a wave of heat.</span>")
	else if(!grav_pulling) //To prevent spam, detonating supermatter does not indicate non-mobs being destroyed
		AM.visible_message("<span class=\"warning\">\The [AM] smacks into \the [src] and rapidly flashes to ash.</span>",\
		"<span class=\"warning\">I hear a loud crack as I am washed with a wave of heat.</span>")
...
/obj/machinery/power/supermatter/proc/Consume(var/mob/living/user)
	...
	for(var/mob/living/l in range(10))
		if(l in view())
			l.show_message("<span class=\"warning\">As \the [src] slowly stops resonating, I find my skin covered in new radiation burns.</span>", 1,\
				"<span class=\"warning\">The unearthly ringing subsides and I notice I have new radiation burns.</span>", 2)
		else
			l.show_message("<span class=\"warning\">I hear an uneartly ringing and notice my skin is covered in fresh radiation burns.</span>", 2)
	var/rads = 500
...
/obj/machinery/power/supermatter/shard //Small subtype, less efficient and more sensitive, but less boom.
	...
	desc = "A strangely translucent and iridescent crystal that looks like it used to be part of a larger structure. <span class='danger'>I get headaches just from looking at it.</span>"
