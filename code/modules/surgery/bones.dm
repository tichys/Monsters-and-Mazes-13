...
/datum/surgery_step/glue_bone/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	if (affected.stage == 0)
		...
		"I start applying \the [tool] to the [bone].")
	target.custom_pain("Something in my [affected.name] is causing I a lot of pain!",50, affecting = affected)
	..()
...
/datum/surgery_step/glue_bone/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	user.visible_message("<span class='notice'>[user] applies some [tool.name] to [bone]</span>", \
		"<span class='notice'>I apply some [tool.name] to [bone].</span>")
	if(affected.stage == 0)
		affected.stage = 1
...
/datum/surgery_step/set_bone/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	user.visible_message("[user] is beginning to set the [bone] in place with \the [tool]." , \
		"I am beginning to set the [bone] in place with \the [tool].")
	target.custom_pain("The pain in my [affected.name] is going to make I pass out!",50, affecting = affected)
	..()
...
/datum/surgery_step/set_bone/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	if (affected.status & ORGAN_BROKEN)
		user.visible_message("<span class='notice'>[user] sets the [bone] n place with \the [tool].</span>", \
			"<span class='notice'>I set the [bone] in place with \the [tool].</span>")
		affected.stage = 2
	else
		user.visible_message("<span class='notice'>[user] sets the [bone]</span> <span class='warning'>in the WRONG place with \the [tool].</span>", \
			"<span class='notice'>I set the [bone]</span> <span class='warning'>in the WRONG place with \the [tool].</span>")
		affected.fracture()
...
/datum/surgery_step/set_bone/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	user.visible_message("<span class='warning'>[user]'s hand slips, damaging the [affected.encased ? affected.encased : "bones"] in [target]'s [affected.name] with \the [tool]!</span>" , \
		"<span class='warning'>My hand slips, damaging the [affected.encased ? affected.encased : "bones"] in [target]'s [affected.name] with \the [tool]!</span>")
	affected.fracture()
...
/datum/surgery_step/mend_skull/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] is beginning to piece together [target]'s skull with \the [tool]."  , \
		"I am beginning to piece together [target]'s skull with \the [tool].")
	..()
...
/datum/surgery_step/finish_bone/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start to finish mending the damaged [bone] with \the [tool].")
	..()
...
/datum/surgery_step/finish_bone/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	user.visible_message("<span class='notice'>[user] has mended the damaged [bone] with \the [tool].</span>"  , \
		"<span class='notice'>I have mended the damaged [bone] with \the [tool].</span>" )
