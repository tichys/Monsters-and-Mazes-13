...
/datum/surgery_step/limb/attach/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	if(target.isSynthetic())
		...
		if(!BP_IS_ROBOTIC(using))
			to_chat(user, "<span class='danger'>I cannot attach a flesh part to a robotic body.</span>")
...
/datum/surgery_step/limb/attach/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start attaching [E.name] to [target]'s [E.amputation_point].")
...
/datum/surgery_step/limb/attach/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have attached [target]'s [E.name] to the [E.amputation_point].</span>")
	E.replaced(target)
	target.update_body()
	target.updatehealth()
...
/datum/surgery_step/limb/attach/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='warning'> My hand slips, damaging [target]'s [E.amputation_point]!</span>")
...
/datum/surgery_step/limb/connect/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start connecting tendons and muscle in [target]'s [E.amputation_point].")
...
/datum/surgery_step/limb/connect/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have connected tendons and muscles in [target]'s [E.amputation_point] with [tool].</span>")
...
/datum/surgery_step/limb/mechanize/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"I start attaching \the [tool] to [target].")
...
/datum/surgery_step/limb/mechanize/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>I have attached \the [tool] to [target].</span>")
...
/datum/surgery_step/limb/mechanize/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		"<span class='warning'> My hand slips, damaging [target]'s flesh!</span>")
		target.apply_damage(10, BRUTE, null, damage_flags=DAM_SHARP)
