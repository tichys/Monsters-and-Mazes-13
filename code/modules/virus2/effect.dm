...
/datum/disease2/effect/gibbingtons
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		...
		if(prob(25))
			to_chat(mob, "<span class='warning'>my [O.name] feels as if it might burst!</span>")
		if(prob(10))
			spawn(50)
				if(O)
...
/datum/disease2/effect/organs
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		...
		if (!(E.status & ORGAN_DEAD))
			E.status |= ORGAN_DEAD
			to_chat(mob, "<span class='notice'>I can't feel my [E.name] anymore...</span>")
...
/datum/disease2/effect/immortal
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		for (var/external in mob.organs)
			...
			if (E.status & ORGAN_BROKEN && prob(30))
				to_chat(mob, "<span class='notice'>my [E.name] suddenly feels much better!</span>")
				E.status ^= ORGAN_BROKEN
				break
		for (var/internal in mob.internal_organs)
			var/obj/item/organ/internal/I = internal
			if (I.damage && prob(30))
				to_chat(mob, "<span class='notice'>my [mob.get_organ(I.parent_organ)] feels a bit warm...</span>")
	...
	deactivate(var/mob/living/carbon/human/mob,var/multiplier)
		to_chat(mob, "<span class='notice'>I suddenly feel hurt and old...</span>")
		mob.age += 8
...
/datum/disease2/effect/hair
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		if(mob.species.name == SPECIES_HUMAN && !(mob.h_style == "Bald") && !(mob.h_style == "Balding Hair"))
			to_chat(mob, "<span class='danger'>My hair starts to fall out in clumps...</span>")
			spawn(50)
...
/datum/disease2/effect/stimulant
	...
	badness = VIRUS_COMMON
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		to_chat(mob, "<span class='notice'>I feel a rush of energy inside me!</span>")
...
/datum/disease2/effect/sneeze
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		if (prob(30))
			to_chat(mob, "<span class='warning'>I feel like I am about to sneeze!</span>")
		sleep(5)
		mob.emote("sneeze")
...
/datum/disease2/effect/headache
	...
	delay = 25 SECONDS
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		mob.custom_pain("My head hurts a bit.", 20)
...
/datum/disease2/effect/itch
	...
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		...
		to_chat(mob, "<span class='warning'>my [O.name] itches like hell.</span>")
...
/datum/disease2/effect/stomach
	...
	delay = 25 SECONDS
	activate(var/mob/living/carbon/human/mob,var/multiplier)
		to_chat(mob, "<span class='warning'>My stomach feels heavy.</span>")
