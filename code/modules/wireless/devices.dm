...
//			receivers.
//	Receiver: does whatever the subtype does. deactivate() by default calls activate(), so I will have to override in 
//			  it in a subtype if I want it to do something.
//-------------------------------
...
/datum/wifi/receiver/button/proc/deactivate(mob/living/user)
	activate(user)		//override this if I want deactivate to actually do something
