...
/*
	...
	These are the datums that an object needs to connect via the wireless controller. I will need a /wifi/receiver to
	allow other devices to connect to my device and send it instructions. I will need a /wifi/sender to send signals
	to other devices with wifi receivers. I can have multiple devices (senders and receivers) if I program my
	...
	I will however need to call the /wifi/senders code to pass commands onto any connected receivers.
	Example:
