...
/*
	...
	For the purposes of SS13, the specific entropy is just a number that tells I how hard it is to move gas. I can replace this with whatever I want.
...
//Two lists can be passed by reference if I need know specifically which graphics were added and removed.
...
/datum/gas_mixture/proc/share_ratio(datum/gas_mixture/other, connecting_tiles, share_size = null, one_way = 0)
	...
	//WOOT WOOT TOUCH THIS AND I ARE A RETARD.
