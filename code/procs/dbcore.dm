...
/*
var/DB_SERVER = "" // This is the location of my MySQL server (localhost is USUALLY fine)
var/DB_PORT = 3306 // This is the port my MySQL server is running on (3306 is the default)
*/
