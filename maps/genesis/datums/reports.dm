...
/datum/computer_file/report/recipient/crew_transfer/generate_fields()
	...
	add_field(/datum/report_field/instruction, "SEV Mayflower - Office of the Chancellor")
	...
	xo_fields += add_field(/datum/report_field/signature, "Chancellor's signature")
...
/datum/computer_file/report/recipient/sec/investigation/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "SEV Mayflower Security Department")
...
/datum/computer_file/report/recipient/docked/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "SEV Mayflower Supply and Hangar Management Department")
...
/datum/computer_file/report/recipient/fauna/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "SEV Mayflower Expeditions")
	...
	add_field(/datum/report_field/instruction, "On completion of this form and form approval, the Research Director should fax the form to both the NanoTrasen Liaison and the Commander-In-Chief, as well as keep a copy on file in their Office alongside other mission reports.")
...
/datum/computer_file/report/recipient/nt/proc/add_header()
	add_field(/datum/report_field/simple_text, "Vessel", "SEV Mayflower")
	add_field(/datum/report_field/date, "Date")
	add_field(/datum/report_field/time, "Time")
...
/datum/computer_file/report/recipient/nt/deny/generate_fields()
	..()
	add_header()
	add_field(/datum/report_field/instruction, "Dear Sir/Madam, we regret to inform I that my volunteer application for service as a test subject with the NanoTrasen Corporation has been rejected. We thank I for my interest in our company and the progression of research. Attached, I will find a copy of my original volunteer form for my records. Regards,")
...
/datum/computer_file/report/recipient/sol/audit
	...
	title = "SEV Mayflower Department Audit"
	available_on_ntnet = 1
