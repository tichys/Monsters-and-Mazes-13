//Makes sure we don't get any merchant antags as a balance concern. Can also be used for future genesis specific antag restrictions.
/datum/antagonist/changeling
	blacklisted_jobs = list(/datum/job/captain, /datum/job/hop)

/datum/antagonist/godcultist
	blacklisted_jobs = list(/datum/job/chaplain,  /datum/job/captain, /datum/job/hop, /datum/job/hos)
...
/datum/antagonist/ert
	...
	leader_welcome_text = "As leader of the Emergency Response Team, I am part of the Sol Central Government Fleet, and are there with the intention of restoring normal operation to the vessel or the safe evacuation of crew and passengers. I should, to this effect, aid the Commander-In-Chief or ranking officer aboard in their endeavours to achieve this."
...
/datum/antagonist/ert/equip(var/mob/living/carbon/human/player)
	...
	var/decl/hierarchy/outfit/ert_outfit = outfit_by_type((player.mind == leader) ? /decl/hierarchy/outfit/job/genesis/ert/leader : /decl/hierarchy/outfit/job/genesis/ert)
