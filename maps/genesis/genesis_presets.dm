...
/datum/map/genesis/get_network_access(var/network)
	switch(network)
		if(NETWORK_BRIDGE)
			return access_heads
		if(NETWORK_SUPPLY)
...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/genesis/substation/configure_and_install_coils()
...
/obj/machinery/power/smes/buildable/preset/genesis/substation_full/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil(src)
	component_parts += new /obj/item/weapon/smes_coil(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/obj/machinery/power/smes/buildable/preset/genesis/engine_main/configure_and_install_coils()
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/genesis/shuttle/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
	_input_on = TRUE
...
/obj/machinery/power/smes/buildable/preset/genesis/hangar/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/datum/map/genesis/default_internal_channels()
	return list(
