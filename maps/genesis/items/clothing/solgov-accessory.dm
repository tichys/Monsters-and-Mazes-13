/obj/item/clothing/accessory/solgov
	...
	icon = 'maps/genesis/icons/obj/solgov-accessory.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/genesis/icons/mob/solgov-accessory.dmi', slot_wear_suit_str = 'maps/genesis/icons/mob/solgov-accessory.dmi')
...
/obj/item/clothing/accessory/solgov/genesis_patch
	name = "\improper genesis mission patch"
	desc = "A fire resistant shoulder patch, worn by the personnel involved in the Mayflower Project."
	icon_state = "genesispatch"
...
/obj/item/clothing/accessory/armor/tag/solgov
	...
	icon_override = 'maps/genesis/icons/obj/solgov-accessory.dmi'
	icon = 'maps/genesis/icons/obj/solgov-accessory.dmi'
	accessory_icons = list(slot_tie_str = 'maps/genesis/icons/mob/solgov-accessory.dmi', slot_w_uniform_str = 'maps/genesis/icons/mob/solgov-accessory.dmi', slot_wear_suit_str = 'maps/genesis/icons/mob/solgov-accessory.dmi')
	icon_state = "solflag"
