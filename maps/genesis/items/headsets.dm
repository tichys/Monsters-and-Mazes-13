/obj/item/device/radio/headset/genesisnanotrasen
	name = "nanotrasen headset"
	desc = "A headset for corporate drones."
	icon_state = "nt_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/headset_genesisnt

/obj/item/device/radio/headset/heads/genesiscaptain
	name = "Commander-In-Chief's headset"
	desc = "The skipper's headset."
	icon_state = "com_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/heads/genesiscaptain

/obj/item/device/radio/headset/heads/genesiscaptain/alt
	name = "Commander-In-Chief's bowman headset"
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"

/obj/item/device/radio/headset/heads/genesisxo
	name = "Chancellor's headset"
	desc = "The headset of the guy who will one day be CO."
	icon_state = "com_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/heads/genesisxo

/obj/item/device/radio/headset/heads/genesisxo/alt
	name = "Chancellor's bowman headset"
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"

/obj/item/device/radio/headset/heads/genesisntcommand
	name = "nanotrasen command headset"
	desc = "Headset of the corporate overlords."
	icon_state = "nt_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/headset_genesisrd

/obj/item/device/radio/headset/heads/genesisntcommand/alt
...
/obj/item/device/radio/headset/heads/cos
	...
	desc = "The headset of the man who protects my worthless lives."
	icon_state = "com_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/genesisroboticist
	name = "roboticist's headset"
	desc = "A headset with access to the engineering and medical channels."
	icon_state = "eng_headset"
	item_state = "headset"
	ks1type = /obj/item/device/encryptionkey/headset_genesisroboticist
