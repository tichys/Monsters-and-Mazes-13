...
/obj/item/weapon/pen/multi/cmd/xo
	name = "Chancellor's pen"
	icon = 'maps/genesis/icons/obj/uniques.dmi'
	icon_state = "pen_xo"
	desc = "A slightly bulky pen with a silvery case. Twisting the top allows me to switch the nib for different colors."

/obj/item/weapon/pen/multi/cmd/co
	name = "Commander-In-Chief's pen"
	icon = 'maps/genesis/icons/obj/uniques.dmi'
	icon_state = "pen_co"
	desc = "A slightly bulky pen with a golden case. Twisting the top allows me to switch the nib for different colors."
...
/obj/item/weapon/gun/projectile/revolver/webley/captain
	...
	icon = 'maps/genesis/icons/obj/uniques.dmi'
	icon_state = "mosley"
	desc = "A shiny al-Maliki & Mosley Autococker automatic revolver, with black accents. Marketed as the 'Revolver for the Modern Era'. Uses .44 magnum rounds. This one has 'To the Captain of SEV Mayflower' engraved."
