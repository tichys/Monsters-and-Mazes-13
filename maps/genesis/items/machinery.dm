//Shouldn't be a lot in here, only genesis versions of existing machines that need a different access req or something along those lines.

/obj/machinery/vending/medical/genesis
	req_access = list(access_medical)

/obj/machinery/drone_fabricator/genesis
	fabricator_tag = "SEV Mayflower Maintenance"

/obj/machinery/drone_fabricator/genesis/adv
	name = "advanced drone fabricator"
	fabricator_tag = "SFV Arrow Maintenance"
	drone_type = /mob/living/silicon/robot/drone/construction

//telecommunications gubbins for genesis-specific networks
