...
/obj/item/weapon/book/manual/sol_sop
	...
	desc = "SOP aboard the SEV Mayflower."
...
/obj/item/weapon/paper/blanks
	...
	<b>FROM:</b> Hieronimus Blackstone, Overseer of genesis Cooperation Project<br>
	<b>TO:</b> Research Director of SEV Mayflower branch<br>
	<b>CC:</b> Liason with SCG services aboard SEV Mayflower<br>
	<b>SUBJECT:</b> RE: Testing Materials<br>
	<hr>
	We have reviewed my request, and would like to make an addition to the list of needed materials.<br>
	...
	In the Research Wing I should find a small section labeled 'Aux Custodial Supplies'. Inside we have provided several mind-blank vatgrown clones. Our Law Special Response Team so far had not found SCG legislation that explicitly forbids their use in research.<br>
...
/obj/item/weapon/paper/liason_note
	name = "note"
	info = {"
	<i>Pick my way out.<br>
	H.B.</i>
	"}

/obj/item/weapon/folder/envelope/captain
	desc = "A thick envelope. The SCG crest is stamped in the corner, along with 'TOP SECRET - genesis UMBRA'."

/obj/item/weapon/folder/envelope/captain/Initialize()
	. = ..()
	var/obj/effect/overmap/genesis = map_sectors["[z]"]
	var/memo = {"
	<tt><center><b><font color='red'>SECRET - CODE WORDS: genesis</font></b>
	<h3>SOL CENTRAL GOVERNMENT EXPEDITIONARY COMMAND</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> ADM William Lau<br>
	<b>TO:</b> Commander-In-Chief of SEV Mayflower<br>
	<b>SUBJECT:</b> Standing Orders<br>
	<hr>
	Captain.<br>
	My orders are to visit the following star systems. Keep in mind that my supplies are limited; ration exploration time accordingly.
	...
	None of these systems are claimed by any entity recognized by the SCG, so I have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no SCG presence in that area. In case of distress calls, I will be the only vessel available; do not ignore them. We cannot afford any more PR backlash.<br>
	The current docking code is: [genesis.docking_codes]<br>
...
/obj/item/weapon/paper/umbra
	name = "UMBRA Protocol"
	info = {"
	<tt><center><b><font color='red'>TOP SECRET - CODE WORDS: genesis UMBRA</font></b>
	...
	<b>TO:</b> Commander-In-Chief of the SEV Mayflower<br>
	<b>CC:</b> Special Representative aboard the SEV Mayflower<br>
	<b>SUBJECT:</b> UMBRA protocol<br>
	<hr>
	This is a small addendum to the usual operating procedures. Unlike the rest of SOP, this is not left to the Commander-In-Chief's discretion and is mandatory. As unconventional as this is, we felt it is essential for smooth operation of this mission.<br>
	Procedure can be initiated only by transmission from SCG Expeditionary Command via secure channel. The sender may not introduce themselves, but I shouldn't have trouble confirming the transmission source, I believe.<br>
	The signal to initiate the procedure are codewords 'GOOD NIGHT WORLD' used in this order as one phrase. I do not need to send acknowledgement.
	<li>Information about this expedition's findings is to be treated as secret and vital to SCG's national security, and is protected under codeword UMBRA. Only SCG government employees and NT personnel aboard the SEV Mayflower are allowed access to this information on a need-to-know basis.</li>
	...
	<li>Disregard any systems remaining in my flight plan and set course for Sol, Neptune orbit. I will be contacted upon my arrival. Do not make stops in ports on the way unless absolutely necessary.</li>
	<br>
	While drastic, I assure I this is a simple precaution, lest any issues. Just keep the option open, and carry on with my normal duties.
	<i>Regards, John.</i></tt>
