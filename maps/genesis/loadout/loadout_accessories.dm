...
/datum/gear/accessory/genesis_patch
	display_name = "genesis mission patch"
	path = /obj/item/clothing/accessory/solgov/genesis_patch

/datum/gear/accessory/pilot_pin
	display_name = "pilot's qualification pin"
	path = /obj/item/clothing/accessory/solgov/speciality/pilot
	allowed_roles = list(/datum/job/captain, /datum/job/hop, /datum/job/praetorian)
...
/datum/gear/accessory/armband_emt
	allowed_roles = list(/datum/job/coroner, /datum/job/paramedic)

/datum/gear/accessory/armband_corpsman
	display_name = "medical corps armband"
	path = /obj/item/clothing/accessory/armband/medblue
	allowed_roles = list(/datum/job/cmo, /datum/job/senior_doctor, /datum/job/coroner)
/*
...
/datum/gear/storage/white_vest
	allowed_roles = list(/datum/job/cmo, /datum/job/senior_doctor, /datum/job/coroner, /datum/job/paramedic, )
