...
/obj/structure/closet/chefcloset_genesis
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	icon_state = "black"
	icon_closed = "black"

/obj/structure/closet/chefcloset_genesis/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_genesis //done so that it has no access reqs
...
/obj/structure/closet/secure_closet/hydroponics_genesis/WillContain()
	return list(
...
/obj/structure/closet/jcloset_genesis/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_genesis
	name = "bar locker"
	desc = "It's a storage unit for bar equipment."
	req_access = list(access_bar)

/obj/structure/closet/secure_closet/bar_genesis/WillContain()
	return list(
