/obj/structure/sign/dedicationplaque
	name = "\improper SEV Mayflower dedication plaque"
	desc = "S.E.V. genesis - Mako Class - Sol Expeditionary Corps Registry 95519 - Shiva Fleet Yards, Mars - First Vessel To Bear The Name - Launched 2560 - Sol Central Government - 'Never was anything great achieved without danger.'"
	icon = 'maps/genesis/icons/obj/solgov-decals.dmi'
...
/obj/structure/sign/ecplaque
	...
	var/directives = {"<hr><center>
		1. <b>Exploring the unknown is my Primary Mission</b><br>

		I am to look for land and resources that can be used by Humanity to advance and prosper. Explore. Document. Explain. Knowledge is the most valuable resource.<br>

		2. <b>Every member of the Expeditionary Corps is an explorer</b><br>

		Some are Explorers by rank or position, but everyone has to be one when duty calls. I should always expect being assigned to an expedition if needed. I have already volunteered when I signed up.<br>

		3. <b>Danger is a part of the mission - avoid, not run away</b> <br>

		Keep my crew alive and hull intact, but remember - I am not here to sightsee. Dangers are obstacles to be cleared, not the roadblocks. Weigh risks carefully and keep my Primary Mission in mind.
		</center><hr>"}
...
/obj/effect/floor_decal/scglogo
	alpha = 230
	icon = 'maps/genesis/icons/obj/solgov_floor.dmi'
	icon_state = "1,1"
